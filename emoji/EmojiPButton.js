...
/** Mithril component for the OpenMoji "P button" (color) [1F17F]. */
const EmojiPButton = {
  view: (vnode) => m(
    'svg',
  ...
  <g id="color" transform="translate(-.0006922 -.01378)" stroke="#d22f27">
    ...
    <path transform="matrix(3.365 0 0 3.365 29.24 24.38)" fill="none" stroke="#d22f27" stroke-linecap="round" stroke-linejoin="round" stroke-miterlimit="10" stroke-width="2" d="m0 7v-7h2.669c0.963 0 1.744 0.781 1.744 1.744s-0.781 1.743-1.744 1.743h-2.669" clip-rule="evenodd"/>
