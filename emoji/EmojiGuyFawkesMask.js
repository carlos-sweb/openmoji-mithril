...
/** Mithril component for the OpenMoji "guy fawkes mask" (color) [E145]. */
const EmojiGuyFawkesMask = {
  ...
  <g id="color" transform="matrix(1.579 .4213 -.4231 1.572 4.013 -9.525)">
    ...
    <path transform="matrix(.5908 -.1583 .159 .5934 -.8562 6.288)" fill="none" stroke="#3f3f3f" stroke-linecap="round" d="m39.85 36.1-1.01-10.98"/>
    <path transform="matrix(.5908 -.1583 .159 .5934 -.8562 6.288)" fill="none" stroke="#9b9b9a" d="m16 36.25c4.697 2.945 9.711 4.327 15.89 0"/>
    <path transform="matrix(.5908 -.1583 .159 .5934 -.8562 6.288)" fill="none" stroke="#9b9b9a" d="m55.88 36.22c-4.697 2.945-9.711 4.327-15.89 0"/>
  </g>
