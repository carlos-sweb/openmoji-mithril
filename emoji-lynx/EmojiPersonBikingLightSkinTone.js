...
/** Mithril-lynx component for the OpenMoji "person biking: light skin tone" (color) [1F6B4-1F3FB]. */
const EmojiPersonBikingLightSkinTone = lynxIcon(`
  <g id="color"/>
  <g id="hair"/>
  <g id="skin">
...
`, _attrs, 72)
export default EmojiPersonBikingLightSkinTone
