...
/** Mithril-lynx component for the OpenMoji "overlapping black squares" (color) [2BBC]. */
const EmojiOverlappingBlackSquares = lynxIcon(`
...
`, _attrs, 72)
export default EmojiOverlappingBlackSquares
