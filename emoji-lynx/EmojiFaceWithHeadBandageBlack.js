...
/** Mithril-lynx component for the OpenMoji "face with head-bandage" (black) [1F915]. */
const EmojiFaceWithHeadBandageBlack = lynxIcon(`
  <g id="line">
...
`, _attrs, 72)
export default EmojiFaceWithHeadBandageBlack
