...
/** Mithril-lynx component for the OpenMoji "person with skullcap: light skin tone" (color) [1F472-1F3FB]. */
const EmojiPersonWithSkullcapLightSkinTone = lynxIcon(`
  <g id="color">
...
`, _attrs, 72)
export default EmojiPersonWithSkullcapLightSkinTone
