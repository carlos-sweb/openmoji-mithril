...
/** Mithril-lynx component for the OpenMoji "person pouting: dark skin tone" (black) [1F64E-1F3FF]. */
const EmojiPersonPoutingDarkSkinToneBlack = lynxIcon(`
  <g id="line">
...
`, _attrs, 72)
export default EmojiPersonPoutingDarkSkinToneBlack
