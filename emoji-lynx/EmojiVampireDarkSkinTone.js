...
/** Mithril-lynx component for the OpenMoji "vampire: dark skin tone" (color) [1F9DB-1F3FF]. */
const EmojiVampireDarkSkinTone = lynxIcon(`
  <g id="hair">
...
`, _attrs, 72)
export default EmojiVampireDarkSkinTone
