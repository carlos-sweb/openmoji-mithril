...
/** Mithril-lynx component for the OpenMoji "person getting massage: light skin tone" (color) [1F486-1F3FB]. */
const EmojiPersonGettingMassageLightSkinTone = {
  view: (vnode) => m(
    'svg',
...
export default EmojiPersonGettingMassageLightSkinTone
