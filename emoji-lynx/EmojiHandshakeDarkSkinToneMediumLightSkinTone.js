...
/** Mithril-lynx component for the OpenMoji "handshake: dark skin tone, medium-light skin tone" (color) [1FAF1-1F3FF-200D-1FAF2-1F3FC]. */
const EmojiHandshakeDarkSkinToneMediumLightSkinTone = lynxIcon(`
  <g id="color"/>
  <g id="skin">
    <g id="skin-a">
...
`, _attrs, 72)
export default EmojiHandshakeDarkSkinToneMediumLightSkinTone
