...
/** Mithril-lynx component for the OpenMoji "detective: medium skin tone" (black) [1F575-1F3FD]. */
const EmojiDetectiveMediumSkinToneBlack = {
  view: (vnode) => m(
    'svg',
...
export default EmojiDetectiveMediumSkinToneBlack
