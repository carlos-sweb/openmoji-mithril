...
/** Mithril-lynx component for the OpenMoji "person shrugging: medium skin tone" (color) [1F937-1F3FD]. */
const EmojiPersonShruggingMediumSkinTone = lynxIcon(`
  <g id="color">
...
`, _attrs, 72)
export default EmojiPersonShruggingMediumSkinTone
