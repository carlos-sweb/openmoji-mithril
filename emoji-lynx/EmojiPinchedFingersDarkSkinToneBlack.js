...
/** Mithril-lynx component for the OpenMoji "pinched fingers: dark skin tone" (black) [1F90C-1F3FF]. */
const EmojiPinchedFingersDarkSkinToneBlack = lynxIcon(`
  <g id="line">
...
`, _attrs, 72)
export default EmojiPinchedFingersDarkSkinToneBlack
