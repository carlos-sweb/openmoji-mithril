...
/** Mithril-lynx component for the OpenMoji "woman: medium-light skin tone" (color) [1F469-1F3FC]. */
const EmojiWomanMediumLightSkinTone = lynxIcon(`
  <g id="color">
...
`, _attrs, 72)
export default EmojiWomanMediumLightSkinTone
