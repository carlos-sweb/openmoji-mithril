...
/** Mithril-lynx component for the OpenMoji "woman singer: dark skin tone" (color) [1F469-1F3FF-200D-1F3A4]. */
const EmojiWomanSingerDarkSkinTone = {
  view: (vnode) => m(
    'svg',
...
export default EmojiWomanSingerDarkSkinTone
