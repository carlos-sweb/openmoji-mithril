...
/** Mithril-lynx component for the OpenMoji "men wrestling: light skin tone, medium-light skin tone" (color) [1F468-1F3FB-200D-1FAEF-200D-1F468-1F3FC]. */
const EmojiMenWrestlingLightSkinToneMediumLightSkinTone = lynxIcon(`
  <g id="color"/>
  <g id="skin">
    <g id="skin-a">
      <circle cx="29.9688" cy="16.0156" r="3.9843" fill="#fadcbc" stroke="#fadcbc"/>
      <path fill="#fadcbc" stroke="#fadcbc" d="M26.334,28.1523L21.1357,34l4,12l-0.75,14h-3.4238l-0.8262-13l-3.0673-6L11,36v-4l9.0684-10 c0,0,1.8613-3.0283,2.6474-3.1455c1.5625-0.2334,3.2774-0.4585,4.6944,0.1455c0.8212,0.3496,2.2334,2.5366,2.164,4.8545 c-0.0185,0.6309-0.1816,1.2593-0.4521,1.8779c-0.0381,0.0869,2.998,2.2158,4.2978,1.2197 c1.8203-1.3955,3.5791-5.6308,4.8086-5.6308c1.3682,0-0.959,6.0366-2.999,7.6372c-3.1875,2.5005-7.6309-0.8008-8.1045-0.25"/>
      <polyline fill="#fadcbc" stroke="#fadcbc" points="12,37 12,47 9.9688,58 12.9688,58 16,48 17,42"/>
    </g>
    <g id="skin-b">
...
`, _attrs, 72)
export default EmojiMenWrestlingLightSkinToneMediumLightSkinTone
