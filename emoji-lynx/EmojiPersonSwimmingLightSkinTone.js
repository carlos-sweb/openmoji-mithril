...
/** Mithril-lynx component for the OpenMoji "person swimming: light skin tone" (color) [1F3CA-1F3FB]. */
const EmojiPersonSwimmingLightSkinTone = lynxIcon(`
  <g id="color">
...
`, _attrs, 72)
export default EmojiPersonSwimmingLightSkinTone
