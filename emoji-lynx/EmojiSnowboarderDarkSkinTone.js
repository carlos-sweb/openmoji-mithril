...
/** Mithril-lynx component for the OpenMoji "snowboarder: dark skin tone" (color) [1F3C2-1F3FF]. */
const EmojiSnowboarderDarkSkinTone = lynxIcon(`
  <g id="color"/>
  <g id="hair"/>
  <g id="skin">
...
`, _attrs, 72)
export default EmojiSnowboarderDarkSkinTone
