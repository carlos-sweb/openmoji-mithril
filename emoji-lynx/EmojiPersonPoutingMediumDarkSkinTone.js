...
/** Mithril-lynx component for the OpenMoji "person pouting: medium-dark skin tone" (color) [1F64E-1F3FE]. */
const EmojiPersonPoutingMediumDarkSkinTone = lynxIcon(`
  <g id="color">
...
`, _attrs, 72)
export default EmojiPersonPoutingMediumDarkSkinTone
