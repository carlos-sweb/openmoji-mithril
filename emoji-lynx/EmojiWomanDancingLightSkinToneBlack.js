...
/** Mithril-lynx component for the OpenMoji "woman dancing: light skin tone" (black) [1F483-1F3FB]. */
const EmojiWomanDancingLightSkinToneBlack = lynxIcon(`
  <g id="line">
...
`, _attrs, 72)
export default EmojiWomanDancingLightSkinToneBlack
