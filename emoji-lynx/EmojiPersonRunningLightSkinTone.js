...
/** Mithril-lynx component for the OpenMoji "person running: light skin tone" (color) [1F3C3-1F3FB]. */
const EmojiPersonRunningLightSkinTone = lynxIcon(`
  <g id="color"/>
  <g id="skin">
...
`, _attrs, 72)
export default EmojiPersonRunningLightSkinTone
