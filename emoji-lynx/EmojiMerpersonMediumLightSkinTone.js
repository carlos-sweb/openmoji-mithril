...
/** Mithril-lynx component for the OpenMoji "merperson: medium-light skin tone" (color) [1F9DC-1F3FC]. */
const EmojiMerpersonMediumLightSkinTone = lynxIcon(`
  <g id="color">
...
`, _attrs, 72)
export default EmojiMerpersonMediumLightSkinTone
