...
/** Mithril-lynx component for the OpenMoji "person lifting weights" (color) [1F3CB]. */
const EmojiPersonLiftingWeights = lynxIcon(`
  <g id="color">
...
`, _attrs, 72)
export default EmojiPersonLiftingWeights
