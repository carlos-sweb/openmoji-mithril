...
/** Mithril-lynx component for the OpenMoji "woman dancing: dark skin tone" (black) [1F483-1F3FF]. */
const EmojiWomanDancingDarkSkinToneBlack = lynxIcon(`
  <g id="line">
...
`, _attrs, 72)
export default EmojiWomanDancingDarkSkinToneBlack
