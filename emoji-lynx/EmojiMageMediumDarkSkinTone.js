...
/** Mithril-lynx component for the OpenMoji "mage: medium-dark skin tone" (color) [1F9D9-1F3FE]. */
const EmojiMageMediumDarkSkinTone = {
  view: (vnode) => m(
    'svg',
...
export default EmojiMageMediumDarkSkinTone
