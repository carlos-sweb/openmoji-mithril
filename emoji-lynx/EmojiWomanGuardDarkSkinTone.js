...
/** Mithril-lynx component for the OpenMoji "woman guard: dark skin tone" (color) [1F482-1F3FF-200D-2640-FE0F]. */
const EmojiWomanGuardDarkSkinTone = {
  view: (vnode) => m(
    'svg',
...
export default EmojiWomanGuardDarkSkinTone
