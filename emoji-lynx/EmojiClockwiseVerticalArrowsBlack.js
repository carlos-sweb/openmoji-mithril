...
/** Mithril-lynx component for the OpenMoji "clockwise vertical arrows" (black) [1F503]. */
const EmojiClockwiseVerticalArrowsBlack = lynxIcon(`
  <g id="line">
...
`, _attrs, 72)
export default EmojiClockwiseVerticalArrowsBlack
