...
/** Mithril-lynx component for the OpenMoji "child: medium-dark skin tone" (black) [1F9D2-1F3FE]. */
const EmojiChildMediumDarkSkinToneBlack = lynxIcon(`
  <g id="line">
...
`, _attrs, 72)
export default EmojiChildMediumDarkSkinToneBlack
