...
/** Mithril-lynx component for the OpenMoji "person in steamy room: medium skin tone" (color) [1F9D6-1F3FD]. */
const EmojiPersonInSteamyRoomMediumSkinTone = lynxIcon(`
  <g id="color">
...
`, _attrs, 72)
export default EmojiPersonInSteamyRoomMediumSkinTone
