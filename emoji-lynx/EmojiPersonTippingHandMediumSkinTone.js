...
/** Mithril-lynx component for the OpenMoji "person tipping hand: medium skin tone" (color) [1F481-1F3FD]. */
const EmojiPersonTippingHandMediumSkinTone = lynxIcon(`
  <g id="color">
...
`, _attrs, 72)
export default EmojiPersonTippingHandMediumSkinTone
