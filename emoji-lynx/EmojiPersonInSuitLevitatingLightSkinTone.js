...
/** Mithril-lynx component for the OpenMoji "person in suit levitating: light skin tone" (color) [1F574-1F3FB]. */
const EmojiPersonInSuitLevitatingLightSkinTone = lynxIcon(`
  <g id="color"/>
  <g id="skin">
...
`, _attrs, 72)
export default EmojiPersonInSuitLevitatingLightSkinTone
