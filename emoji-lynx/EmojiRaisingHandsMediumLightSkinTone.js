...
/** Mithril-lynx component for the OpenMoji "raising hands: medium-light skin tone" (color) [1F64C-1F3FC]. */
const EmojiRaisingHandsMediumLightSkinTone = {
  view: (vnode) => m(
    'svg',
...
export default EmojiRaisingHandsMediumLightSkinTone
