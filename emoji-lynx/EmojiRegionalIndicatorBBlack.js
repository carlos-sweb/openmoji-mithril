...
/** Mithril-lynx component for the OpenMoji "regional indicator B" (black) [1F1E7]. */
const EmojiRegionalIndicatorBBlack = lynxIcon(`
  <g id="line">
    <g id="line-2">
...
`, _attrs, 72)
export default EmojiRegionalIndicatorBBlack
