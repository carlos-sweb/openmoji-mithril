...
/** Mithril-lynx component for the OpenMoji "mage: medium-dark skin tone" (black) [1F9D9-1F3FE]. */
const EmojiMageMediumDarkSkinToneBlack = lynxIcon(`
  <g id="line">
...
`, _attrs, 72)
export default EmojiMageMediumDarkSkinToneBlack
