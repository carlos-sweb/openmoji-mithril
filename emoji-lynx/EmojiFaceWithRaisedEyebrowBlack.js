...
/** Mithril-lynx component for the OpenMoji "face with raised eyebrow" (black) [1F928]. */
const EmojiFaceWithRaisedEyebrowBlack = lynxIcon(`
  <g id="line">
...
`, _attrs, 72)
export default EmojiFaceWithRaisedEyebrowBlack
