...
/** Mithril-lynx component for the OpenMoji "regional indicator M" (black) [1F1F2]. */
const EmojiRegionalIndicatorMBlack = lynxIcon(`
  <g id="line">
    <g id="line-2">
...
`, _attrs, 72)
export default EmojiRegionalIndicatorMBlack
