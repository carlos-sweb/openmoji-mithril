...
/** Mithril-lynx component for the OpenMoji "smiling face with smiling eyes" (color) [1F60A]. */
const EmojiSmilingFaceWithSmilingEyes = lynxIcon(`
  <g id="color">
...
`, _attrs, 72)
export default EmojiSmilingFaceWithSmilingEyes
