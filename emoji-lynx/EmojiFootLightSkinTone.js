...
/** Mithril-lynx component for the OpenMoji "foot: light skin tone" (color) [1F9B6-1F3FB]. */
const EmojiFootLightSkinTone = lynxIcon(`
  <g id="color"/>
  <g id="skin">
...
`, _attrs, 72)
export default EmojiFootLightSkinTone
