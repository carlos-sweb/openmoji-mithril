...
/** Mithril-lynx component for the OpenMoji "right anger bubble" (black) [1F5EF]. */
const EmojiRightAngerBubbleBlack = lynxIcon(`
  <g id="line">
...
`, _attrs, 72)
export default EmojiRightAngerBubbleBlack
