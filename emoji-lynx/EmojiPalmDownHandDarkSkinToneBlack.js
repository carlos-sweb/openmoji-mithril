...
/** Mithril-lynx component for the OpenMoji "palm down hand: dark skin tone" (black) [1FAF3-1F3FF]. */
const EmojiPalmDownHandDarkSkinToneBlack = lynxIcon(`
  <g id="line">
...
`, _attrs, 72)
export default EmojiPalmDownHandDarkSkinToneBlack
