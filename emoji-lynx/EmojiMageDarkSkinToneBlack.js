...
/** Mithril-lynx component for the OpenMoji "mage: dark skin tone" (black) [1F9D9-1F3FF]. */
const EmojiMageDarkSkinToneBlack = lynxIcon(`
  <g id="line">
...
`, _attrs, 72)
export default EmojiMageDarkSkinToneBlack
