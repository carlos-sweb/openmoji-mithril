...
/** Mithril-lynx component for the OpenMoji "pregnant man: medium-light skin tone" (color) [1FAC3-1F3FC]. */
const EmojiPregnantManMediumLightSkinTone = {
  view: (vnode) => m(
    'svg',
...
export default EmojiPregnantManMediumLightSkinTone
