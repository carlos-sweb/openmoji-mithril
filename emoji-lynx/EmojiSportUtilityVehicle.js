...
/** Mithril-lynx component for the OpenMoji "sport utility vehicle" (color) [1F699]. */
const EmojiSportUtilityVehicle = lynxIcon(`
  <g id="color">
...
`, _attrs, 72)
export default EmojiSportUtilityVehicle
