...
/** Mithril-lynx component for the OpenMoji "backhand index pointing left: light skin tone" (color) [1F448-1F3FB]. */
const EmojiBackhandIndexPointingLeftLightSkinTone = lynxIcon(`
  <g id="color"/>
  <g id="hair"/>
  <g id="skin">
...
`, _attrs, 72)
export default EmojiBackhandIndexPointingLeftLightSkinTone
