...
/** Mithril-lynx component for the OpenMoji "flag: Western Sahara" (color) [1F1EA-1F1ED]. */
const EmojiFlagWesternSahara = lynxIcon(`
  <g id="color">
...
`, _attrs, 72)
export default EmojiFlagWesternSahara
