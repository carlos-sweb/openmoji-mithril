...
/** Mithril-lynx component for the OpenMoji "person gesturing NO: medium-light skin tone" (color) [1F645-1F3FC]. */
const EmojiPersonGesturingNOMediumLightSkinTone = lynxIcon(`
  <g id="color">
...
`, _attrs, 72)
export default EmojiPersonGesturingNOMediumLightSkinTone
