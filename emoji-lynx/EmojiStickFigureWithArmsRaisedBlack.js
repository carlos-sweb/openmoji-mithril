...
/** Mithril-lynx component for the OpenMoji "stick figure with arms raised" (black) [1FBC6]. */
const EmojiStickFigureWithArmsRaisedBlack = {
  view: (vnode) => m(
    'svg',
...
export default EmojiStickFigureWithArmsRaisedBlack
