...
/** Mithril-lynx component for the OpenMoji "handshake: medium skin tone" (color) [1F91D-1F3FD]. */
const EmojiHandshakeMediumSkinTone = lynxIcon(`
  <g id="color"/>
  <g id="skin">
    <g id="skin-a">
...
`, _attrs, 72)
export default EmojiHandshakeMediumSkinTone
