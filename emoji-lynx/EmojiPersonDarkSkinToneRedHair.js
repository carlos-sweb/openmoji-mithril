...
/** Mithril-lynx component for the OpenMoji "person: dark skin tone, red hair" (color) [1F9D1-1F3FF-200D-1F9B0]. */
const EmojiPersonDarkSkinToneRedHair = lynxIcon(`
  <g id="color">
...
`, _attrs, 72)
export default EmojiPersonDarkSkinToneRedHair
