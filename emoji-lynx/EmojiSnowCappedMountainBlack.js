...
/** Mithril-lynx component for the OpenMoji "snow-capped mountain" (black) [1F3D4]. */
const EmojiSnowCappedMountainBlack = lynxIcon(`
  <g id="line">
...
`, _attrs, 72)
export default EmojiSnowCappedMountainBlack
