...
/** Mithril-lynx component for the OpenMoji "backhand index pointing right: medium-light skin tone" (color) [1F449-1F3FC]. */
const EmojiBackhandIndexPointingRightMediumLightSkinTone = lynxIcon(`
  <g id="color"/>
  <g id="hair"/>
  <g id="skin">
...
`, _attrs, 72)
export default EmojiBackhandIndexPointingRightMediumLightSkinTone
