...
/** Mithril-lynx component for the OpenMoji "polar research station" (color) [E2C3]. */
const EmojiPolarResearchStation = lynxIcon(`
  <g id="color">
...
`, _attrs, 72)
export default EmojiPolarResearchStation
