...
/** Mithril-lynx component for the OpenMoji "stick figure with arms raised" (color) [1FBC6]. */
const EmojiStickFigureWithArmsRaised = lynxIcon(`
  <g id="color"/>
  <g id="line">
...
`, _attrs, 72)
export default EmojiStickFigureWithArmsRaised
