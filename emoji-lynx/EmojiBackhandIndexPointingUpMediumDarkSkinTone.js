...
/** Mithril-lynx component for the OpenMoji "backhand index pointing up: medium-dark skin tone" (color) [1F446-1F3FE]. */
const EmojiBackhandIndexPointingUpMediumDarkSkinTone = lynxIcon(`
  <g id="color"/>
  <g id="hair"/>
  <g id="skin">
...
`, _attrs, 72)
export default EmojiBackhandIndexPointingUpMediumDarkSkinTone
