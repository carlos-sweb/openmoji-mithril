...
/** Mithril-lynx component for the OpenMoji "winking face with tongue" (color) [1F61C]. */
const EmojiWinkingFaceWithTongue = lynxIcon(`
  <g id="color">
...
`, _attrs, 72)
export default EmojiWinkingFaceWithTongue
