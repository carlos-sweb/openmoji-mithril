...
/** Mithril-lynx component for the OpenMoji "index pointing at the viewer: light skin tone" (color) [1FAF5-1F3FB]. */
const EmojiIndexPointingAtTheViewerLightSkinTone = lynxIcon(`
  <g id="color"/>
  <g id="skin">
...
`, _attrs, 72)
export default EmojiIndexPointingAtTheViewerLightSkinTone
