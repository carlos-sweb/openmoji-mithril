...
/** Mithril-lynx component for the OpenMoji "palm down hand: light skin tone" (black) [1FAF3-1F3FB]. */
const EmojiPalmDownHandLightSkinToneBlack = lynxIcon(`
  <g id="line">
...
`, _attrs, 72)
export default EmojiPalmDownHandLightSkinToneBlack
