...
/** Mithril-lynx component for the OpenMoji "detective: medium-dark skin tone" (black) [1F575-1F3FE]. */
const EmojiDetectiveMediumDarkSkinToneBlack = {
  view: (vnode) => m(
    'svg',
...
export default EmojiDetectiveMediumDarkSkinToneBlack
