...
/** Mithril-lynx component for the OpenMoji "square with lower right diagonal black" (black) [25EA]. */
const EmojiSquareWithLowerRightDiagonalBlackBlack = lynxIcon(`
...
`, _attrs, 72)
export default EmojiSquareWithLowerRightDiagonalBlackBlack
