...
/** Mithril-lynx component for the OpenMoji "palm up hand: dark skin tone" (black) [1FAF4-1F3FF]. */
const EmojiPalmUpHandDarkSkinToneBlack = lynxIcon(`
  <g id="line">
...
`, _attrs, 72)
export default EmojiPalmUpHandDarkSkinToneBlack
