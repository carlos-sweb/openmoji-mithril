...
/** Mithril-lynx component for the OpenMoji "location indicator red" (black) [E0A9]. */
const EmojiLocationIndicatorRedBlack = lynxIcon(`
  <g id="line">
...
`, _attrs, 72)
export default EmojiLocationIndicatorRedBlack
