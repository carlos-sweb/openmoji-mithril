...
/** Mithril-lynx component for the OpenMoji "fairy: medium-light skin tone" (black) [1F9DA-1F3FC]. */
const EmojiFairyMediumLightSkinToneBlack = lynxIcon(`
  <g id="line">
...
`, _attrs, 72)
export default EmojiFairyMediumLightSkinToneBlack
