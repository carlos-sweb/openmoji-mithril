...
/** Mithril-lynx component for the OpenMoji "person facepalming: dark skin tone" (color) [1F926-1F3FF]. */
const EmojiPersonFacepalmingDarkSkinTone = lynxIcon(`
  <g id="color">
...
`, _attrs, 72)
export default EmojiPersonFacepalmingDarkSkinTone
