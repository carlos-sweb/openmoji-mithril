...
/** Mithril-lynx component for the OpenMoji "deaf person: dark skin tone" (color) [1F9CF-1F3FF]. */
const EmojiDeafPersonDarkSkinTone = lynxIcon(`
  <g id="color">
...
`, _attrs, 72)
export default EmojiDeafPersonDarkSkinTone
