...
/** Mithril-lynx component for the OpenMoji "pregnant person: light skin tone" (black) [1FAC4-1F3FB]. */
const EmojiPregnantPersonLightSkinToneBlack = {
  view: (vnode) => m(
    'svg',
...
export default EmojiPregnantPersonLightSkinToneBlack
