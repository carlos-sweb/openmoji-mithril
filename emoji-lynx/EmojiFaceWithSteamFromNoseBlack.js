...
/** Mithril-lynx component for the OpenMoji "face with steam from nose" (black) [1F624]. */
const EmojiFaceWithSteamFromNoseBlack = lynxIcon(`
  <g id="line">
...
`, _attrs, 72)
export default EmojiFaceWithSteamFromNoseBlack
