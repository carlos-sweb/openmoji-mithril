...
/** Mithril-lynx component for the OpenMoji "snowboarder: medium-light skin tone" (color) [1F3C2-1F3FC]. */
const EmojiSnowboarderMediumLightSkinTone = {
  view: (vnode) => m(
    'svg',
...
export default EmojiSnowboarderMediumLightSkinTone
