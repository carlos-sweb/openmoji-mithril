...
/** Mithril-lynx component for the OpenMoji "health worker: light skin tone" (color) [1F9D1-1F3FB-200D-2695-FE0F]. */
const EmojiHealthWorkerLightSkinTone = lynxIcon(`
  <g id="color">
...
`, _attrs, 72)
export default EmojiHealthWorkerLightSkinTone
