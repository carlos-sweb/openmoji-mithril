...
/** Mithril-lynx component for the OpenMoji "raised hand: dark skin tone" (black) [270B-1F3FF]. */
const EmojiRaisedHandDarkSkinToneBlack = {
  view: (vnode) => m(
    'svg',
...
export default EmojiRaisedHandDarkSkinToneBlack
