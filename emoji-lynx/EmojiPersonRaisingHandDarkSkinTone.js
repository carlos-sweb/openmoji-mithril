...
/** Mithril-lynx component for the OpenMoji "person raising hand: dark skin tone" (color) [1F64B-1F3FF]. */
const EmojiPersonRaisingHandDarkSkinTone = lynxIcon(`
  <g id="color">
...
`, _attrs, 72)
export default EmojiPersonRaisingHandDarkSkinTone
