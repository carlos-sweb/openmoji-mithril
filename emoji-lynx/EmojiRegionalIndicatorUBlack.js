...
/** Mithril-lynx component for the OpenMoji "regional indicator U" (black) [1F1FA]. */
const EmojiRegionalIndicatorUBlack = lynxIcon(`
  <g id="line">
    <g id="line-2">
...
`, _attrs, 72)
export default EmojiRegionalIndicatorUBlack
