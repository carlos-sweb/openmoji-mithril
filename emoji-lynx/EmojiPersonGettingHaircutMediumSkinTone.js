...
/** Mithril-lynx component for the OpenMoji "person getting haircut: medium skin tone" (color) [1F487-1F3FD]. */
const EmojiPersonGettingHaircutMediumSkinTone = lynxIcon(`
  <g id="color">
...
`, _attrs, 72)
export default EmojiPersonGettingHaircutMediumSkinTone
