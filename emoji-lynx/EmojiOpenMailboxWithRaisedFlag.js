...
/** Mithril-lynx component for the OpenMoji "open mailbox with raised flag" (color) [1F4EC]. */
const EmojiOpenMailboxWithRaisedFlag = lynxIcon(`
  <g id="color">
...
`, _attrs, 72)
export default EmojiOpenMailboxWithRaisedFlag
