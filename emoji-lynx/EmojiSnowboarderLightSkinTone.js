...
/** Mithril-lynx component for the OpenMoji "snowboarder: light skin tone" (color) [1F3C2-1F3FB]. */
const EmojiSnowboarderLightSkinTone = {
  view: (vnode) => m(
    'svg',
...
export default EmojiSnowboarderLightSkinTone
