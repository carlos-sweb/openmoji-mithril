...
/** Mithril-lynx component for the OpenMoji "child: medium-light skin tone" (color) [1F9D2-1F3FC]. */
const EmojiChildMediumLightSkinTone = lynxIcon(`
  <g id="color">
...
`, _attrs, 72)
export default EmojiChildMediumLightSkinTone
