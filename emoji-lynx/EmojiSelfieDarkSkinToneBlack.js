...
/** Mithril-lynx component for the OpenMoji "selfie: dark skin tone" (black) [1F933-1F3FF]. */
const EmojiSelfieDarkSkinToneBlack = lynxIcon(`
  <g id="line">
...
`, _attrs, 72)
export default EmojiSelfieDarkSkinToneBlack
