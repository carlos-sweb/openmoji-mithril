...
/** Mithril-lynx component for the OpenMoji "smiling face with tear" (black) [1F972]. */
const EmojiSmilingFaceWithTearBlack = lynxIcon(`
  <g id="line">
...
`, _attrs, 72)
export default EmojiSmilingFaceWithTearBlack
