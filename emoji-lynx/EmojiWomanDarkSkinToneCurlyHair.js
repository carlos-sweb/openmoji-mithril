...
/** Mithril-lynx component for the OpenMoji "woman: dark skin tone, curly hair" (color) [1F469-1F3FF-200D-1F9B1]. */
const EmojiWomanDarkSkinToneCurlyHair = lynxIcon(`
  <g id="hair">
...
`, _attrs, 72)
export default EmojiWomanDarkSkinToneCurlyHair
