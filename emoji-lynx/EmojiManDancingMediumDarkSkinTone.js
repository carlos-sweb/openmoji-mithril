...
/** Mithril-lynx component for the OpenMoji "man dancing: medium-dark skin tone" (color) [1F57A-1F3FE]. */
const EmojiManDancingMediumDarkSkinTone = {
  view: (vnode) => m(
    'svg',
...
export default EmojiManDancingMediumDarkSkinTone
