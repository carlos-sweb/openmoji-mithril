...
/** Mithril-lynx component for the OpenMoji "person kneeling: light skin tone" (color) [1F9CE-1F3FB]. */
const EmojiPersonKneelingLightSkinTone = lynxIcon(`
  <g id="color"/>
  <g id="skin">
...
`, _attrs, 72)
export default EmojiPersonKneelingLightSkinTone
