...
/** Mithril-lynx component for the OpenMoji "oncoming fist: medium-light skin tone" (color) [1F44A-1F3FC]. */
const EmojiOncomingFistMediumLightSkinTone = {
  view: (vnode) => m(
    'svg',
...
export default EmojiOncomingFistMediumLightSkinTone
