...
/** Mithril-lynx component for the OpenMoji "love-you gesture: medium skin tone" (color) [1F91F-1F3FD]. */
const EmojiLoveYouGestureMediumSkinTone = {
  view: (vnode) => m(
    'svg',
...
export default EmojiLoveYouGestureMediumSkinTone
