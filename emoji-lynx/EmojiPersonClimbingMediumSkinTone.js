...
/** Mithril-lynx component for the OpenMoji "person climbing: medium skin tone" (color) [1F9D7-1F3FD]. */
const EmojiPersonClimbingMediumSkinTone = lynxIcon(`
  <g id="color">
...
`, _attrs, 72)
export default EmojiPersonClimbingMediumSkinTone
