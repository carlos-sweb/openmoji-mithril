...
/** Mithril-lynx component for the OpenMoji "selfie: light skin tone" (color) [1F933-1F3FB]. */
const EmojiSelfieLightSkinTone = lynxIcon(`
  <g id="color">
...
`, _attrs, 72)
export default EmojiSelfieLightSkinTone
