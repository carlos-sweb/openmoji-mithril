...
/** Mithril-lynx component for the OpenMoji "face with crossed-out eyes" (color) [1F635]. */
const EmojiFaceWithCrossedOutEyes = lynxIcon(`
  <g id="color">
...
`, _attrs, 72)
export default EmojiFaceWithCrossedOutEyes
