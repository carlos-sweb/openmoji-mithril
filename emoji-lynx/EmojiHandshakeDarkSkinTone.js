...
/** Mithril-lynx component for the OpenMoji "handshake: dark skin tone" (color) [1F91D-1F3FF]. */
const EmojiHandshakeDarkSkinTone = lynxIcon(`
  <g id="color"/>
  <g id="skin">
    <g id="skin-a">
...
`, _attrs, 72)
export default EmojiHandshakeDarkSkinTone
