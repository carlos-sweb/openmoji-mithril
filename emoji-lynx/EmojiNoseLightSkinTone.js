...
/** Mithril-lynx component for the OpenMoji "nose: light skin tone" (color) [1F443-1F3FB]. */
const EmojiNoseLightSkinTone = lynxIcon(`
  <g id="color"/>
  <g id="hair"/>
  <g id="skin">
...
`, _attrs, 72)
export default EmojiNoseLightSkinTone
