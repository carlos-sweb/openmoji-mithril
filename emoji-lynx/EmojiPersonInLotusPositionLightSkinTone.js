...
/** Mithril-lynx component for the OpenMoji "person in lotus position: light skin tone" (color) [1F9D8-1F3FB]. */
const EmojiPersonInLotusPositionLightSkinTone = lynxIcon(`
  <g id="color"/>
  <g id="hair"/>
  <g id="skin-shadow"/>
  <g id="skin">
...
`, _attrs, 72)
export default EmojiPersonInLotusPositionLightSkinTone
