...
/** Mithril-lynx component for the OpenMoji "person with skullcap: dark skin tone" (color) [1F472-1F3FF]. */
const EmojiPersonWithSkullcapDarkSkinTone = lynxIcon(`
  <g id="color">
...
`, _attrs, 72)
export default EmojiPersonWithSkullcapDarkSkinTone
