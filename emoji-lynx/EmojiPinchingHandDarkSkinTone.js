...
/** Mithril-lynx component for the OpenMoji "pinching hand: dark skin tone" (color) [1F90F-1F3FF]. */
const EmojiPinchingHandDarkSkinTone = lynxIcon(`
  <g id="color"/>
  <g id="skin">
    <g id="Pinching_Hand">
...
`, _attrs, 72)
export default EmojiPinchingHandDarkSkinTone
