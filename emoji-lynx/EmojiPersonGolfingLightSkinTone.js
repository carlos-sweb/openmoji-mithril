...
/** Mithril-lynx component for the OpenMoji "person golfing: light skin tone" (color) [1F3CC-1F3FB]. */
const EmojiPersonGolfingLightSkinTone = lynxIcon(`
  <g id="color">
...
`, _attrs, 72)
export default EmojiPersonGolfingLightSkinTone
