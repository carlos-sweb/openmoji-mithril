...
/** Mithril-lynx component for the OpenMoji "breast-feeding: medium-dark skin tone" (color) [1F931-1F3FE]. */
const EmojiBreastFeedingMediumDarkSkinTone = {
  view: (vnode) => m(
    'svg',
...
export default EmojiBreastFeedingMediumDarkSkinTone
