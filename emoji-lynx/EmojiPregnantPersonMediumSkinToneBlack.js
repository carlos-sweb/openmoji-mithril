...
/** Mithril-lynx component for the OpenMoji "pregnant person: medium skin tone" (black) [1FAC4-1F3FD]. */
const EmojiPregnantPersonMediumSkinToneBlack = {
  view: (vnode) => m(
    'svg',
...
export default EmojiPregnantPersonMediumSkinToneBlack
