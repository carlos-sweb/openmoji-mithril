...
/** Mithril-lynx component for the OpenMoji "no bicycles" (black) [1F6B3]. */
const EmojiNoBicyclesBlack = lynxIcon(`
  <g id="line">
    ...
    <g transform="matrix(.7371 0 0 .7297 8.857 6.124)" stroke-width="2.727">
      <path fill="none" stroke="#000" stroke-linecap="round" stroke-linejoin="round" stroke-width="2.727" d="m42 25.7 5.189 0.0037"/>
    </g>
    <path fill="none" stroke="#000" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="m24.41 39.69 4.018-8.451"/>
    ...
    <ellipse cx="24.49" cy="39.69" rx="7.473" ry="7.433" fill="none" stroke="#000" stroke-linecap="round" stroke-width="2"/>
    <path fill="none" stroke="#000" stroke-linecap="round" stroke-width="2" d="m40.75 35.85c1.303-2.177 3.693-3.635 6.425-3.635 4.127 0 7.473 3.328 7.473 7.433 0 2.862-1.627 5.347-4.011 6.589"/>
    <circle cx="39.77" cy="31.07" r="0.0519" stroke="#000"/>
    <path fill="none" stroke="#000" stroke-width="2" d="m39.65 30.96h-4.284"/>
  </g>
`, _attrs, 72)
export default EmojiNoBicyclesBlack
