...
/** Mithril-lynx component for the OpenMoji "no mobile phones" (color) [1F4F5]. */
const EmojiNoMobilePhones = lynxIcon(`
  <g id="color">
  ...
  <g id="line" fill="none" stroke="#000" stroke-linejoin="round" stroke-width="2">
    ...
    <path stroke-linecap="round" stroke-miterlimit="10" d="m39.87 52h-10.87c-1.104 0-2-0.8955-2-2h15.02z"/>
    <path stroke-miterlimit="10" d="m45 40.7v-18.7h-12.52"/>
    <path stroke-linecap="round" stroke-miterlimit="10" d="m29.48 20h13.52c1.104 0 2 0.8955 2 2h-14.02z"/>
    <circle cx="36" cy="36" r="30" stroke-linecap="round"/>
    <path stroke-linecap="round" d="m55.66 51.44a24.99 24.99 0 0 0-35.06-35.13z"/>
    <path stroke-linecap="round" d="m16.99 19.77a24.99 24.99 0 0 0 35.2 35.27z"/>
