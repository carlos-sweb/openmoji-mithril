...
/** Mithril-lynx component for the OpenMoji "oncoming fist: medium-dark skin tone" (color) [1F44A-1F3FE]. */
const EmojiOncomingFistMediumDarkSkinTone = {
  view: (vnode) => m(
    'svg',
...
export default EmojiOncomingFistMediumDarkSkinTone
