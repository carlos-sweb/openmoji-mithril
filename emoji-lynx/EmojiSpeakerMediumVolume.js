...
/** Mithril-lynx component for the OpenMoji "speaker medium volume" (color) [1F509]. */
const EmojiSpeakerMediumVolume = lynxIcon(`
  <g id="color">
...
`, _attrs, 72)
export default EmojiSpeakerMediumVolume
