...
/** Mithril-lynx component for the OpenMoji "palm up hand: medium skin tone" (black) [1FAF4-1F3FD]. */
const EmojiPalmUpHandMediumSkinToneBlack = lynxIcon(`
  <g id="line">
...
`, _attrs, 72)
export default EmojiPalmUpHandMediumSkinToneBlack
