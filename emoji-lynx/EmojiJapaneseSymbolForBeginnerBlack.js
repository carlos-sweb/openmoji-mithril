...
/** Mithril-lynx component for the OpenMoji "Japanese symbol for beginner" (black) [1F530]. */
const EmojiJapaneseSymbolForBeginnerBlack = lynxIcon(`
  <g id="line">
...
`, _attrs, 72)
export default EmojiJapaneseSymbolForBeginnerBlack
