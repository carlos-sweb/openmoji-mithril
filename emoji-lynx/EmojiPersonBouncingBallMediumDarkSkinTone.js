...
/** Mithril-lynx component for the OpenMoji "person bouncing ball: medium-dark skin tone" (color) [26F9-1F3FE]. */
const EmojiPersonBouncingBallMediumDarkSkinTone = lynxIcon(`
  <g id="color">
...
`, _attrs, 72)
export default EmojiPersonBouncingBallMediumDarkSkinTone
