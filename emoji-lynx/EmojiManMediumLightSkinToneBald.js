...
/** Mithril-lynx component for the OpenMoji "man: medium-light skin tone, bald" (color) [1F468-1F3FC-200D-1F9B2]. */
const EmojiManMediumLightSkinToneBald = lynxIcon(`
  <g id="skin">
...
`, _attrs, 72)
export default EmojiManMediumLightSkinToneBald
