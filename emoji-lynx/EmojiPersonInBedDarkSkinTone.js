...
/** Mithril-lynx component for the OpenMoji "person in bed: dark skin tone" (color) [1F6CC-1F3FF]. */
const EmojiPersonInBedDarkSkinTone = lynxIcon(`
  <g id="color">
...
`, _attrs, 72)
export default EmojiPersonInBedDarkSkinTone
