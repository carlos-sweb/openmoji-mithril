...
/** Mithril-lynx component for the OpenMoji "people wrestling: medium-light skin tone" (color) [1F93C-1F3FC]. */
const EmojiPeopleWrestlingMediumLightSkinTone = lynxIcon(`
  <g id="skin">
...
`, _attrs, 72)
export default EmojiPeopleWrestlingMediumLightSkinTone
