...
/** Mithril-lynx component for the OpenMoji "hand with index finger and thumb crossed: medium-dark skin tone" (color) [1FAF0-1F3FE]. */
const EmojiHandWithIndexFingerAndThumbCrossedMediumDarkSkinTone = lynxIcon(`
  <g id="color">
...
`, _attrs, 72)
export default EmojiHandWithIndexFingerAndThumbCrossedMediumDarkSkinTone
