...
/** Mithril-lynx component for the OpenMoji "shuffle tracks button" (black) [1F500]. */
const EmojiShuffleTracksButtonBlack = lynxIcon(`
  <g id="line">
...
`, _attrs, 72)
export default EmojiShuffleTracksButtonBlack
