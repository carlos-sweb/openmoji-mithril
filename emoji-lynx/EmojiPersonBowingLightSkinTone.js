...
/** Mithril-lynx component for the OpenMoji "person bowing: light skin tone" (color) [1F647-1F3FB]. */
const EmojiPersonBowingLightSkinTone = lynxIcon(`
  <g id="color">
...
`, _attrs, 72)
export default EmojiPersonBowingLightSkinTone
