...
/** Mithril-lynx component for the OpenMoji "sound recording copyright" (black) [2117]. */
const EmojiSoundRecordingCopyrightBlack = lynxIcon(`
  <g id="line">
...
`, _attrs, 72)
export default EmojiSoundRecordingCopyrightBlack
