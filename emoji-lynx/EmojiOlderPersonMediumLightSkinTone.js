...
/** Mithril-lynx component for the OpenMoji "older person: medium-light skin tone" (color) [1F9D3-1F3FC]. */
const EmojiOlderPersonMediumLightSkinTone = lynxIcon(`
  <g id="color">
...
`, _attrs, 72)
export default EmojiOlderPersonMediumLightSkinTone
