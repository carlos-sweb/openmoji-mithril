...
/** Mithril-lynx component for the OpenMoji "rounded symbol for lu" (black) [1F261]. */
const EmojiRoundedSymbolForLuBlack = lynxIcon(`
  <g id="line">
...
`, _attrs, 72)
export default EmojiRoundedSymbolForLuBlack
