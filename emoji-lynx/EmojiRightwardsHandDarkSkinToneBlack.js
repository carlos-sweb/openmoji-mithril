...
/** Mithril-lynx component for the OpenMoji "rightwards hand: dark skin tone" (black) [1FAF1-1F3FF]. */
const EmojiRightwardsHandDarkSkinToneBlack = {
  view: (vnode) => m(
    'svg',
...
export default EmojiRightwardsHandDarkSkinToneBlack
