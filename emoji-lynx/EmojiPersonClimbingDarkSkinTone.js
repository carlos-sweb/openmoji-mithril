...
/** Mithril-lynx component for the OpenMoji "person climbing: dark skin tone" (color) [1F9D7-1F3FF]. */
const EmojiPersonClimbingDarkSkinTone = lynxIcon(`
  <g id="color">
...
`, _attrs, 72)
export default EmojiPersonClimbingDarkSkinTone
