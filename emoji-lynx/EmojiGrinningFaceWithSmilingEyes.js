...
/** Mithril-lynx component for the OpenMoji "grinning face with smiling eyes" (color) [1F604]. */
const EmojiGrinningFaceWithSmilingEyes = lynxIcon(`
  <g id="color">
...
`, _attrs, 72)
export default EmojiGrinningFaceWithSmilingEyes
