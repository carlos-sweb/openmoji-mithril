...
/** Mithril-lynx component for the OpenMoji "person with crown: light skin tone" (color) [1FAC5-1F3FB]. */
const EmojiPersonWithCrownLightSkinTone = lynxIcon(`
  <g id="color">
...
`, _attrs, 72)
export default EmojiPersonWithCrownLightSkinTone
