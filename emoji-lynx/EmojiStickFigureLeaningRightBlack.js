...
/** Mithril-lynx component for the OpenMoji "stick figure leaning right" (black) [1FBC8]. */
const EmojiStickFigureLeaningRightBlack = lynxIcon(`
  <g id="line">
...
`, _attrs, 72)
export default EmojiStickFigureLeaningRightBlack
