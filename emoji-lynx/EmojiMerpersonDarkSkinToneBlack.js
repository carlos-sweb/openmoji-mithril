...
/** Mithril-lynx component for the OpenMoji "merperson: dark skin tone" (black) [1F9DC-1F3FF]. */
const EmojiMerpersonDarkSkinToneBlack = lynxIcon(`
  <g id="line">
...
`, _attrs, 72)
export default EmojiMerpersonDarkSkinToneBlack
