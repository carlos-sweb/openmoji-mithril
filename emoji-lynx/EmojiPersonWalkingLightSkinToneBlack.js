...
/** Mithril-lynx component for the OpenMoji "person walking: light skin tone" (black) [1F6B6-1F3FB]. */
const EmojiPersonWalkingLightSkinToneBlack = lynxIcon(`
  <g id="line">
...
`, _attrs, 72)
export default EmojiPersonWalkingLightSkinToneBlack
