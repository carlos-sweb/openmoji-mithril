...
/** Mithril-lynx component for the OpenMoji "leftwards hand: medium-light skin tone" (black) [1FAF2-1F3FC]. */
const EmojiLeftwardsHandMediumLightSkinToneBlack = {
  view: (vnode) => m(
    'svg',
...
export default EmojiLeftwardsHandMediumLightSkinToneBlack
