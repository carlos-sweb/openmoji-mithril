...
/** Mithril-lynx component for the OpenMoji "counterclockwise arrows button" (black) [1F504]. */
const EmojiCounterclockwiseArrowsButtonBlack = lynxIcon(`
  <g id="line">
...
`, _attrs, 72)
export default EmojiCounterclockwiseArrowsButtonBlack
