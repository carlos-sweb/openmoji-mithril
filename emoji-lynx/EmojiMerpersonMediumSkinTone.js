...
/** Mithril-lynx component for the OpenMoji "merperson: medium skin tone" (color) [1F9DC-1F3FD]. */
const EmojiMerpersonMediumSkinTone = lynxIcon(`
  <g id="color">
...
`, _attrs, 72)
export default EmojiMerpersonMediumSkinTone
