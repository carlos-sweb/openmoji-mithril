...
/** Mithril-lynx component for the OpenMoji "woman: dark skin tone, white hair" (color) [1F469-1F3FF-200D-1F9B3]. */
const EmojiWomanDarkSkinToneWhiteHair = lynxIcon(`
  <g id="hair">
...
`, _attrs, 72)
export default EmojiWomanDarkSkinToneWhiteHair
