...
/** Mithril-lynx component for the OpenMoji "backhand index pointing up: dark skin tone" (color) [1F446-1F3FF]. */
const EmojiBackhandIndexPointingUpDarkSkinTone = lynxIcon(`
  <g id="color"/>
  <g id="hair"/>
  <g id="skin">
...
`, _attrs, 72)
export default EmojiBackhandIndexPointingUpDarkSkinTone
