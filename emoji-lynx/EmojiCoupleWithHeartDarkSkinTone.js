...
/** Mithril-lynx component for the OpenMoji "couple with heart: dark skin tone" (color) [1F491-1F3FF]. */
const EmojiCoupleWithHeartDarkSkinTone = lynxIcon(`
  <g id="color">
...
`, _attrs, 72)
export default EmojiCoupleWithHeartDarkSkinTone
