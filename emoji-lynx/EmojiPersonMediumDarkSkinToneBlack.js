...
/** Mithril-lynx component for the OpenMoji "person: medium-dark skin tone" (black) [1F9D1-1F3FE]. */
const EmojiPersonMediumDarkSkinToneBlack = lynxIcon(`
  <g id="line">
...
`, _attrs, 72)
export default EmojiPersonMediumDarkSkinToneBlack
