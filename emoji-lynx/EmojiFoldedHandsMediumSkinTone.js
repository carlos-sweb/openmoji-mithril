...
/** Mithril-lynx component for the OpenMoji "folded hands: medium skin tone" (color) [1F64F-1F3FD]. */
const EmojiFoldedHandsMediumSkinTone = lynxIcon(`
  <g id="color">
...
`, _attrs, 72)
export default EmojiFoldedHandsMediumSkinTone
