...
/** Mithril-lynx component for the OpenMoji "supervillain: medium-dark skin tone" (black) [1F9B9-1F3FE]. */
const EmojiSupervillainMediumDarkSkinToneBlack = lynxIcon(`
  <g id="line">
...
`, _attrs, 72)
export default EmojiSupervillainMediumDarkSkinToneBlack
