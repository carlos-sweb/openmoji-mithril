...
/** Mithril-lynx component for the OpenMoji "love-you gesture: medium-dark skin tone" (color) [1F91F-1F3FE]. */
const EmojiLoveYouGestureMediumDarkSkinTone = {
  view: (vnode) => m(
    'svg',
...
export default EmojiLoveYouGestureMediumDarkSkinTone
