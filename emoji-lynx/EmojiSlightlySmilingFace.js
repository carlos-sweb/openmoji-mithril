...
/** Mithril-lynx component for the OpenMoji "slightly smiling face" (color) [1F642]. */
const EmojiSlightlySmilingFace = lynxIcon(`
  <g id="color">
...
`, _attrs, 72)
export default EmojiSlightlySmilingFace
