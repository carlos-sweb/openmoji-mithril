...
/** Mithril-lynx component for the OpenMoji "flag: European Union" (color) [1F1EA-1F1FA]. */
const EmojiFlagEuropeanUnion = lynxIcon(`
  <g id="color">
...
`, _attrs, 72)
export default EmojiFlagEuropeanUnion
