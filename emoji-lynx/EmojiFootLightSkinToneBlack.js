...
/** Mithril-lynx component for the OpenMoji "foot: light skin tone" (black) [1F9B6-1F3FB]. */
const EmojiFootLightSkinToneBlack = lynxIcon(`
  <g id="line">
...
`, _attrs, 72)
export default EmojiFootLightSkinToneBlack
