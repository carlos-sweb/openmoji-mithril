...
/** Mithril-lynx component for the OpenMoji "black vertical ellipse" (color) [2B2E]. */
const EmojiBlackVerticalEllipse = lynxIcon(`
...
`, _attrs, 72)
export default EmojiBlackVerticalEllipse
