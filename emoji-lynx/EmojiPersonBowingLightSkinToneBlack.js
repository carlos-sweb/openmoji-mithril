...
/** Mithril-lynx component for the OpenMoji "person bowing: light skin tone" (black) [1F647-1F3FB]. */
const EmojiPersonBowingLightSkinToneBlack = lynxIcon(`
  <g id="line">
...
`, _attrs, 72)
export default EmojiPersonBowingLightSkinToneBlack
