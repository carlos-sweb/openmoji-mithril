...
/** Mithril-lynx component for the OpenMoji "person golfing: light skin tone" (black) [1F3CC-1F3FB]. */
const EmojiPersonGolfingLightSkinToneBlack = lynxIcon(`
  <g id="line">
...
`, _attrs, 72)
export default EmojiPersonGolfingLightSkinToneBlack
