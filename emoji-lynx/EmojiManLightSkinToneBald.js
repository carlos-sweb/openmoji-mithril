...
/** Mithril-lynx component for the OpenMoji "man: light skin tone, bald" (color) [1F468-1F3FB-200D-1F9B2]. */
const EmojiManLightSkinToneBald = lynxIcon(`
  <g id="skin">
...
`, _attrs, 72)
export default EmojiManLightSkinToneBald
