...
/** Mithril-lynx component for the OpenMoji "couple with heart: medium skin tone" (color) [1F491-1F3FD]. */
const EmojiCoupleWithHeartMediumSkinTone = lynxIcon(`
  <g id="color">
...
`, _attrs, 72)
export default EmojiCoupleWithHeartMediumSkinTone
