...
/** Mithril-lynx component for the OpenMoji "OK hand: medium-light skin tone" (color) [1F44C-1F3FC]. */
const EmojiOKHandMediumLightSkinTone = {
  view: (vnode) => m(
    'svg',
...
export default EmojiOKHandMediumLightSkinTone
