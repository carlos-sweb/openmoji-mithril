...
/** Mithril-lynx component for the OpenMoji "regional indicator K" (black) [1F1F0]. */
const EmojiRegionalIndicatorKBlack = lynxIcon(`
  <g id="line">
    <g id="line-2">
...
`, _attrs, 72)
export default EmojiRegionalIndicatorKBlack
