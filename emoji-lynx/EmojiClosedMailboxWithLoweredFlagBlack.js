...
/** Mithril-lynx component for the OpenMoji "closed mailbox with lowered flag" (black) [1F4EA]. */
const EmojiClosedMailboxWithLoweredFlagBlack = lynxIcon(`
  <g id="line">
...
`, _attrs, 72)
export default EmojiClosedMailboxWithLoweredFlagBlack
