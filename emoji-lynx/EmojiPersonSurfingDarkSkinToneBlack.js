...
/** Mithril-lynx component for the OpenMoji "person surfing: dark skin tone" (black) [1F3C4-1F3FF]. */
const EmojiPersonSurfingDarkSkinToneBlack = lynxIcon(`
  <g id="line">
...
`, _attrs, 72)
export default EmojiPersonSurfingDarkSkinToneBlack
