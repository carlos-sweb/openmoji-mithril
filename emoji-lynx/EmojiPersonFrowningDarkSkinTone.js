...
/** Mithril-lynx component for the OpenMoji "person frowning: dark skin tone" (color) [1F64D-1F3FF]. */
const EmojiPersonFrowningDarkSkinTone = lynxIcon(`
  <g id="color">
...
`, _attrs, 72)
export default EmojiPersonFrowningDarkSkinTone
