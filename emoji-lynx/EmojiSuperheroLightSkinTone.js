...
/** Mithril-lynx component for the OpenMoji "superhero: light skin tone" (color) [1F9B8-1F3FB]. */
const EmojiSuperheroLightSkinTone = lynxIcon(`
  <g id="hair">
...
`, _attrs, 72)
export default EmojiSuperheroLightSkinTone
