...
/** Mithril-lynx component for the OpenMoji "person shrugging: dark skin tone" (color) [1F937-1F3FF]. */
const EmojiPersonShruggingDarkSkinTone = lynxIcon(`
  <g id="color">
...
`, _attrs, 72)
export default EmojiPersonShruggingDarkSkinTone
