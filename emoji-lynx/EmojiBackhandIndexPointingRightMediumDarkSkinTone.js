...
/** Mithril-lynx component for the OpenMoji "backhand index pointing right: medium-dark skin tone" (color) [1F449-1F3FE]. */
const EmojiBackhandIndexPointingRightMediumDarkSkinTone = lynxIcon(`
  <g id="color"/>
  <g id="hair"/>
  <g id="skin">
...
`, _attrs, 72)
export default EmojiBackhandIndexPointingRightMediumDarkSkinTone
