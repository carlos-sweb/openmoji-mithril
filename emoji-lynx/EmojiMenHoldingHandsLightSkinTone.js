...
/** Mithril-lynx component for the OpenMoji "men holding hands: light skin tone" (color) [1F46C-1F3FB]. */
const EmojiMenHoldingHandsLightSkinTone = lynxIcon(`
  <g id="color"/>
  <g id="skin">
    <g id="skin-b">
...
`, _attrs, 72)
export default EmojiMenHoldingHandsLightSkinTone
