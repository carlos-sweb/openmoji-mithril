...
/** Mithril-lynx component for the OpenMoji "circled anticlockwise arrow" (black) [1F10E]. */
const EmojiCircledAnticlockwiseArrowBlack = lynxIcon(`
  <g id="line">
...
`, _attrs, 72)
export default EmojiCircledAnticlockwiseArrowBlack
