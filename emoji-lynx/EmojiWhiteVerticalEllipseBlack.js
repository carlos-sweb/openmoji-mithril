...
/** Mithril-lynx component for the OpenMoji "white vertical ellipse" (black) [2B2F]. */
const EmojiWhiteVerticalEllipseBlack = {
  view: (vnode) => m(
    'svg',
...
export default EmojiWhiteVerticalEllipseBlack
