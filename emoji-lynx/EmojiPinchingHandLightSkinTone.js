...
/** Mithril-lynx component for the OpenMoji "pinching hand: light skin tone" (color) [1F90F-1F3FB]. */
const EmojiPinchingHandLightSkinTone = lynxIcon(`
  <g id="color"/>
  <g id="skin">
    <g id="Pinching_Hand">
...
`, _attrs, 72)
export default EmojiPinchingHandLightSkinTone
