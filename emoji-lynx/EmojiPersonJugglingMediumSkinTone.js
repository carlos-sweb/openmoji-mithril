...
/** Mithril-lynx component for the OpenMoji "person juggling: medium skin tone" (color) [1F939-1F3FD]. */
const EmojiPersonJugglingMediumSkinTone = lynxIcon(`
  <g id="color">
...
`, _attrs, 72)
export default EmojiPersonJugglingMediumSkinTone
