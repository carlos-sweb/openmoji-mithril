...
/** Mithril-lynx component for the OpenMoji "person taking bath: medium skin tone" (color) [1F6C0-1F3FD]. */
const EmojiPersonTakingBathMediumSkinTone = lynxIcon(`
  <g id="color">
...
`, _attrs, 72)
export default EmojiPersonTakingBathMediumSkinTone
