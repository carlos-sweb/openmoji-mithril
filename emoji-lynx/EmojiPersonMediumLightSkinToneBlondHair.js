...
/** Mithril-lynx component for the OpenMoji "person: medium-light skin tone, blond hair" (color) [1F471-1F3FC]. */
const EmojiPersonMediumLightSkinToneBlondHair = lynxIcon(`
  <g id="color">
...
`, _attrs, 72)
export default EmojiPersonMediumLightSkinToneBlondHair
