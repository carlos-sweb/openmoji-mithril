...
/** Mithril-lynx component for the OpenMoji "person surfing: light skin tone" (black) [1F3C4-1F3FB]. */
const EmojiPersonSurfingLightSkinToneBlack = lynxIcon(`
  <g id="line">
...
`, _attrs, 72)
export default EmojiPersonSurfingLightSkinToneBlack
