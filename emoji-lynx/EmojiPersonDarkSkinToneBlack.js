...
/** Mithril-lynx component for the OpenMoji "person: dark skin tone" (black) [1F9D1-1F3FF]. */
const EmojiPersonDarkSkinToneBlack = lynxIcon(`
  <g id="line">
...
`, _attrs, 72)
export default EmojiPersonDarkSkinToneBlack
