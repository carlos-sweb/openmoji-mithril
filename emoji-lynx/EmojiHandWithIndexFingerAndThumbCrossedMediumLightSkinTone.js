...
/** Mithril-lynx component for the OpenMoji "hand with index finger and thumb crossed: medium-light skin tone" (color) [1FAF0-1F3FC]. */
const EmojiHandWithIndexFingerAndThumbCrossedMediumLightSkinTone = {
  view: (vnode) => m(
    'svg',
...
export default EmojiHandWithIndexFingerAndThumbCrossedMediumLightSkinTone
