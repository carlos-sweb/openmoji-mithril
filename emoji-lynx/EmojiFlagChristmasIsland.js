...
/** Mithril-lynx component for the OpenMoji "flag: Christmas Island" (color) [1F1E8-1F1FD]. */
const EmojiFlagChristmasIsland = lynxIcon(`
  <g id="color">
...
`, _attrs, 72)
export default EmojiFlagChristmasIsland
