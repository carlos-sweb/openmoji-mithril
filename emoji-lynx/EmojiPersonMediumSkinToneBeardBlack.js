...
/** Mithril-lynx component for the OpenMoji "person: medium skin tone, beard" (black) [1F9D4-1F3FD]. */
const EmojiPersonMediumSkinToneBeardBlack = lynxIcon(`
  <g id="line">
...
`, _attrs, 72)
export default EmojiPersonMediumSkinToneBeardBlack
