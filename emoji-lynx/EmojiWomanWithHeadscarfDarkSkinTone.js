...
/** Mithril-lynx component for the OpenMoji "woman with headscarf: dark skin tone" (color) [1F9D5-1F3FF]. */
const EmojiWomanWithHeadscarfDarkSkinTone = lynxIcon(`
  <g id="color">
...
`, _attrs, 72)
export default EmojiWomanWithHeadscarfDarkSkinTone
