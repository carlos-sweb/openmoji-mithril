...
/** Mithril-lynx component for the OpenMoji "hourglass not done" (black) [23F3]. */
const EmojiHourglassNotDoneBlack = lynxIcon(`
  <g id="line">
...
`, _attrs, 72)
export default EmojiHourglassNotDoneBlack
