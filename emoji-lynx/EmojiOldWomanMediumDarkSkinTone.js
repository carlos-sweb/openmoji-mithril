...
/** Mithril-lynx component for the OpenMoji "old woman: medium-dark skin tone" (color) [1F475-1F3FE]. */
const EmojiOldWomanMediumDarkSkinTone = lynxIcon(`
  <g id="color">
...
`, _attrs, 72)
export default EmojiOldWomanMediumDarkSkinTone
