...
/** Mithril-lynx component for the OpenMoji "person running: medium skin tone" (black) [1F3C3-1F3FD]. */
const EmojiPersonRunningMediumSkinToneBlack = lynxIcon(`
  <g id="line">
...
`, _attrs, 72)
export default EmojiPersonRunningMediumSkinToneBlack
