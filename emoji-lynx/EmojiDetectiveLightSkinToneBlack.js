...
/** Mithril-lynx component for the OpenMoji "detective: light skin tone" (black) [1F575-1F3FB]. */
const EmojiDetectiveLightSkinToneBlack = {
  view: (vnode) => m(
    'svg',
...
export default EmojiDetectiveLightSkinToneBlack
