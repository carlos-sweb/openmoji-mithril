...
/** Mithril-lynx component for the OpenMoji "person in bed: medium skin tone" (black) [1F6CC-1F3FD]. */
const EmojiPersonInBedMediumSkinToneBlack = lynxIcon(`
  <g id="line">
...
`, _attrs, 72)
export default EmojiPersonInBedMediumSkinToneBlack
