...
/** Mithril-lynx component for the OpenMoji "star with left half black" (black) [2BEA]. */
const EmojiStarWithLeftHalfBlackBlack = {
  view: (vnode) => m(
    'svg',
...
export default EmojiStarWithLeftHalfBlackBlack
