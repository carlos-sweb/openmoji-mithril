...
/** Mithril-lynx component for the OpenMoji "raised hand: light skin tone" (black) [270B-1F3FB]. */
const EmojiRaisedHandLightSkinToneBlack = {
  view: (vnode) => m(
    'svg',
...
export default EmojiRaisedHandLightSkinToneBlack
