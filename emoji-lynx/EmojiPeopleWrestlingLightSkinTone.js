...
/** Mithril-lynx component for the OpenMoji "people wrestling: light skin tone" (color) [1F93C-1F3FB]. */
const EmojiPeopleWrestlingLightSkinTone = lynxIcon(`
  <g id="skin">
...
`, _attrs, 72)
export default EmojiPeopleWrestlingLightSkinTone
