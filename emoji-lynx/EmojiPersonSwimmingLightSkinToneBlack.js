...
/** Mithril-lynx component for the OpenMoji "person swimming: light skin tone" (black) [1F3CA-1F3FB]. */
const EmojiPersonSwimmingLightSkinToneBlack = lynxIcon(`
  <g id="line">
...
`, _attrs, 72)
export default EmojiPersonSwimmingLightSkinToneBlack
