...
/** Mithril-lynx component for the OpenMoji "exhaust gases factory" (color) [E2CC]. */
const EmojiExhaustGasesFactory = lynxIcon(`
  <g id="color">
...
`, _attrs, 72)
export default EmojiExhaustGasesFactory
