...
/** Mithril-lynx component for the OpenMoji "person bowing: medium-dark skin tone" (color) [1F647-1F3FE]. */
const EmojiPersonBowingMediumDarkSkinTone = lynxIcon(`
  <g id="color">
...
`, _attrs, 72)
export default EmojiPersonBowingMediumDarkSkinTone
