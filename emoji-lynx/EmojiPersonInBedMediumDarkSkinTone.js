...
/** Mithril-lynx component for the OpenMoji "person in bed: medium-dark skin tone" (color) [1F6CC-1F3FE]. */
const EmojiPersonInBedMediumDarkSkinTone = lynxIcon(`
  <g id="color">
...
`, _attrs, 72)
export default EmojiPersonInBedMediumDarkSkinTone
