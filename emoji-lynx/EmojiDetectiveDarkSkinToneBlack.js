...
/** Mithril-lynx component for the OpenMoji "detective: dark skin tone" (black) [1F575-1F3FF]. */
const EmojiDetectiveDarkSkinToneBlack = {
  view: (vnode) => m(
    'svg',
...
export default EmojiDetectiveDarkSkinToneBlack
