...
/** Mithril-lynx component for the OpenMoji "backhand index pointing up: medium skin tone" (color) [1F446-1F3FD]. */
const EmojiBackhandIndexPointingUpMediumSkinTone = lynxIcon(`
  <g id="color"/>
  <g id="hair"/>
  <g id="skin">
...
`, _attrs, 72)
export default EmojiBackhandIndexPointingUpMediumSkinTone
