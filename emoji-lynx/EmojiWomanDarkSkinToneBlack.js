...
/** Mithril-lynx component for the OpenMoji "woman: dark skin tone" (black) [1F469-1F3FF]. */
const EmojiWomanDarkSkinToneBlack = lynxIcon(`
  <g id="line">
...
`, _attrs, 72)
export default EmojiWomanDarkSkinToneBlack
