...
/** Mithril-lynx component for the OpenMoji "exclamation question mark" (black) [2049]. */
const EmojiExclamationQuestionMarkBlack = {
  view: (vnode) => m(
    'svg',
...
export default EmojiExclamationQuestionMarkBlack
