...
/** Mithril-lynx component for the OpenMoji "teacup without handle" (color) [1F375]. */
const EmojiTeacupWithoutHandle = lynxIcon(`
  <g id="color">
    <path fill="#fff" d="m19.9055,55.7995h32.1874c10.7962-6.4914,15.9071-19.5078,15.9071-35.0476l-39.3658-.4358h-6.9242l-17.71.4358c0,15.5398,5.1109,28.5562,15.9055,35.0476Z"/>
    <rect x="18.3238" y="29.4186" width="14.019" height="17.5238" fill="#b1cc33"/>
    <polygon fill="#5c9e31" points="31 30 21 47 23 46.9424 32.3429 46.9424 32 30 31 30"/>
  </g>
  <g id="line">
