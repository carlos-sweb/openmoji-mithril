...
/** Mithril-lynx component for the OpenMoji "nuclear power plant ruin" (black) [E2D5]. */
const EmojiNuclearPowerPlantRuinBlack = lynxIcon(`
  <g id="line">
...
`, _attrs, 72)
export default EmojiNuclearPowerPlantRuinBlack
