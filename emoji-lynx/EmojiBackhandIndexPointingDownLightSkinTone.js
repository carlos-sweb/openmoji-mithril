...
/** Mithril-lynx component for the OpenMoji "backhand index pointing down: light skin tone" (color) [1F447-1F3FB]. */
const EmojiBackhandIndexPointingDownLightSkinTone = lynxIcon(`
  <g id="color"/>
  <g id="hair"/>
  <g id="skin">
...
`, _attrs, 72)
export default EmojiBackhandIndexPointingDownLightSkinTone
