...
/** Mithril-lynx component for the OpenMoji "old man: medium-light skin tone" (color) [1F474-1F3FC]. */
const EmojiOldManMediumLightSkinTone = lynxIcon(`
  <g id="color">
...
`, _attrs, 72)
export default EmojiOldManMediumLightSkinTone
