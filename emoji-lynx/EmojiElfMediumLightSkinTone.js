...
/** Mithril-lynx component for the OpenMoji "elf: medium-light skin tone" (color) [1F9DD-1F3FC]. */
const EmojiElfMediumLightSkinTone = lynxIcon(`
  <g id="color">
...
`, _attrs, 72)
export default EmojiElfMediumLightSkinTone
