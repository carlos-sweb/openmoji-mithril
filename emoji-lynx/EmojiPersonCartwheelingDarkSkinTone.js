...
/** Mithril-lynx component for the OpenMoji "person cartwheeling: dark skin tone" (color) [1F938-1F3FF]. */
const EmojiPersonCartwheelingDarkSkinTone = lynxIcon(`
  <g id="color"/>
  <g id="hair"/>
  <g id="skin">
...
`, _attrs, 72)
export default EmojiPersonCartwheelingDarkSkinTone
