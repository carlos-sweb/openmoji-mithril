...
/** Mithril-lynx component for the OpenMoji "kissing face with smiling eyes" (black) [1F619]. */
const EmojiKissingFaceWithSmilingEyesBlack = lynxIcon(`
  <g id="line">
...
`, _attrs, 72)
export default EmojiKissingFaceWithSmilingEyesBlack
