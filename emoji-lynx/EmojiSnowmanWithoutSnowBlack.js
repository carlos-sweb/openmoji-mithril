...
/** Mithril-lynx component for the OpenMoji "snowman without snow" (black) [26C4]. */
const EmojiSnowmanWithoutSnowBlack = lynxIcon(`
  <g id="line">
...
`, _attrs, 72)
export default EmojiSnowmanWithoutSnowBlack
