...
/** Mithril-lynx component for the OpenMoji "superhero: dark skin tone" (black) [1F9B8-1F3FF]. */
const EmojiSuperheroDarkSkinToneBlack = lynxIcon(`
  <g id="line">
...
`, _attrs, 72)
export default EmojiSuperheroDarkSkinToneBlack
