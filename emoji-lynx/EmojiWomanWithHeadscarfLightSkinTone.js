...
/** Mithril-lynx component for the OpenMoji "woman with headscarf: light skin tone" (color) [1F9D5-1F3FB]. */
const EmojiWomanWithHeadscarfLightSkinTone = lynxIcon(`
  <g id="color">
...
`, _attrs, 72)
export default EmojiWomanWithHeadscarfLightSkinTone
