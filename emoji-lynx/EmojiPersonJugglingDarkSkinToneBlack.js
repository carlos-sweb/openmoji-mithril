...
/** Mithril-lynx component for the OpenMoji "person juggling: dark skin tone" (black) [1F939-1F3FF]. */
const EmojiPersonJugglingDarkSkinToneBlack = lynxIcon(`
  <g id="line">
...
`, _attrs, 72)
export default EmojiPersonJugglingDarkSkinToneBlack
