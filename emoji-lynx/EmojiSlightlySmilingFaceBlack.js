...
/** Mithril-lynx component for the OpenMoji "slightly smiling face" (black) [1F642]. */
const EmojiSlightlySmilingFaceBlack = lynxIcon(`
  <g id="line">
...
`, _attrs, 72)
export default EmojiSlightlySmilingFaceBlack
