...
/** Mithril-lynx component for the OpenMoji "leftwards hand: dark skin tone" (black) [1FAF2-1F3FF]. */
const EmojiLeftwardsHandDarkSkinToneBlack = {
  view: (vnode) => m(
    'svg',
...
export default EmojiLeftwardsHandDarkSkinToneBlack
