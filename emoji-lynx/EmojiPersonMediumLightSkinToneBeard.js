...
/** Mithril-lynx component for the OpenMoji "person: medium-light skin tone, beard" (color) [1F9D4-1F3FC]. */
const EmojiPersonMediumLightSkinToneBeard = lynxIcon(`
  <g id="color">
...
`, _attrs, 72)
export default EmojiPersonMediumLightSkinToneBeard
