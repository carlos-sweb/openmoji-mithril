...
/** Mithril-lynx component for the OpenMoji "person: medium skin tone, blond hair" (color) [1F471-1F3FD]. */
const EmojiPersonMediumSkinToneBlondHair = lynxIcon(`
  <g id="color">
...
`, _attrs, 72)
export default EmojiPersonMediumSkinToneBlondHair
