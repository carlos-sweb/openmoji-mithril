...
/** Mithril-lynx component for the OpenMoji "smiling face with heart-eyes" (color) [1F60D]. */
const EmojiSmilingFaceWithHeartEyes = lynxIcon(`
  <g id="color">
...
`, _attrs, 72)
export default EmojiSmilingFaceWithHeartEyes
