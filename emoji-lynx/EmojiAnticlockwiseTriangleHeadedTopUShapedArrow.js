...
/** Mithril-lynx component for the OpenMoji "anticlockwise triangle-headed top u-shaped arrow" (color) [2B8F]. */
const EmojiAnticlockwiseTriangleHeadedTopUShapedArrow = {
  view: (vnode) => m(
    'svg',
