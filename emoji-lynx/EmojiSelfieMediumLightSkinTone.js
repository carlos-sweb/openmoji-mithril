...
/** Mithril-lynx component for the OpenMoji "selfie: medium-light skin tone" (color) [1F933-1F3FC]. */
const EmojiSelfieMediumLightSkinTone = lynxIcon(`
  <g id="color">
...
`, _attrs, 72)
export default EmojiSelfieMediumLightSkinTone
