...
/** Mithril-lynx component for the OpenMoji "person facepalming: light skin tone" (color) [1F926-1F3FB]. */
const EmojiPersonFacepalmingLightSkinTone = lynxIcon(`
  <g id="color">
...
`, _attrs, 72)
export default EmojiPersonFacepalmingLightSkinTone
