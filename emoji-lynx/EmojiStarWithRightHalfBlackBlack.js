...
/** Mithril-lynx component for the OpenMoji "star with right half black" (black) [2BEB]. */
const EmojiStarWithRightHalfBlackBlack = lynxIcon(`
...
`, _attrs, 72)
export default EmojiStarWithRightHalfBlackBlack
