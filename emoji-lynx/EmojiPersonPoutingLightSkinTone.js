...
/** Mithril-lynx component for the OpenMoji "person pouting: light skin tone" (color) [1F64E-1F3FB]. */
const EmojiPersonPoutingLightSkinTone = lynxIcon(`
  <g id="color">
...
`, _attrs, 72)
export default EmojiPersonPoutingLightSkinTone
