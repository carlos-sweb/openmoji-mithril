...
/** Mithril-lynx component for the OpenMoji "schwäbisch gmünd ratshaus" (color) [E209]. */
const EmojiSchwaBischGmuNdRatshaus = lynxIcon(`
  <g id="color">
...
`, _attrs, 72)
export default EmojiSchwaBischGmuNdRatshaus
