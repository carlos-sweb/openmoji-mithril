...
/** Mithril-lynx component for the OpenMoji "person cartwheeling: medium-dark skin tone" (color) [1F938-1F3FE]. */
const EmojiPersonCartwheelingMediumDarkSkinTone = {
  view: (vnode) => m(
    'svg',
...
export default EmojiPersonCartwheelingMediumDarkSkinTone
