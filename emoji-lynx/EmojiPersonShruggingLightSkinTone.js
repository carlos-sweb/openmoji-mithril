...
/** Mithril-lynx component for the OpenMoji "person shrugging: light skin tone" (color) [1F937-1F3FB]. */
const EmojiPersonShruggingLightSkinTone = lynxIcon(`
  <g id="color">
...
`, _attrs, 72)
export default EmojiPersonShruggingLightSkinTone
