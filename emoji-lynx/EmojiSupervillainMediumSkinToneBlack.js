...
/** Mithril-lynx component for the OpenMoji "supervillain: medium skin tone" (black) [1F9B9-1F3FD]. */
const EmojiSupervillainMediumSkinToneBlack = lynxIcon(`
  <g id="line">
...
`, _attrs, 72)
export default EmojiSupervillainMediumSkinToneBlack
