...
/** Mithril-lynx component for the OpenMoji "deaf person: light skin tone" (color) [1F9CF-1F3FB]. */
const EmojiDeafPersonLightSkinTone = lynxIcon(`
  <g id="color">
...
`, _attrs, 72)
export default EmojiDeafPersonLightSkinTone
