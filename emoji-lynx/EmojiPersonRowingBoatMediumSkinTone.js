...
/** Mithril-lynx component for the OpenMoji "person rowing boat: medium skin tone" (color) [1F6A3-1F3FD]. */
const EmojiPersonRowingBoatMediumSkinTone = lynxIcon(`
  <g id="color">
...
`, _attrs, 72)
export default EmojiPersonRowingBoatMediumSkinTone
