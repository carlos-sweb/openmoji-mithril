...
/** Mithril-lynx component for the OpenMoji "person walking: medium-light skin tone" (color) [1F6B6-1F3FC]. */
const EmojiPersonWalkingMediumLightSkinTone = lynxIcon(`
  <g id="color"/>
  <g id="hair"/>
  <g id="skin">
...
`, _attrs, 72)
export default EmojiPersonWalkingMediumLightSkinTone
