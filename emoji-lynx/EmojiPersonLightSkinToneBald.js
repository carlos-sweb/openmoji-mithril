...
/** Mithril-lynx component for the OpenMoji "person: light skin tone, bald" (color) [1F9D1-1F3FB-200D-1F9B2]. */
const EmojiPersonLightSkinToneBald = lynxIcon(`
  <g id="skin">
...
`, _attrs, 72)
export default EmojiPersonLightSkinToneBald
