...
/** Mithril-lynx component for the OpenMoji "child: dark skin tone" (black) [1F9D2-1F3FF]. */
const EmojiChildDarkSkinToneBlack = lynxIcon(`
  <g id="line">
...
`, _attrs, 72)
export default EmojiChildDarkSkinToneBlack
