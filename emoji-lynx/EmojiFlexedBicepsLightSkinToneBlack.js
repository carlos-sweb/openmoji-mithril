...
/** Mithril-lynx component for the OpenMoji "flexed biceps: light skin tone" (black) [1F4AA-1F3FB]. */
const EmojiFlexedBicepsLightSkinToneBlack = lynxIcon(`
  <g id="line">
...
`, _attrs, 72)
export default EmojiFlexedBicepsLightSkinToneBlack
