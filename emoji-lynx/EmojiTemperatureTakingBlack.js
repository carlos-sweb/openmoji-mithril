...
/** Mithril-lynx component for the OpenMoji "temperature taking" (black) [E0B3]. */
const EmojiTemperatureTakingBlack = lynxIcon(`
  <g id="line">
    <g id="line-2">
...
`, _attrs, 72)
export default EmojiTemperatureTakingBlack
