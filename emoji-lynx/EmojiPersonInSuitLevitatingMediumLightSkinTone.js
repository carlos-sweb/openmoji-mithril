...
/** Mithril-lynx component for the OpenMoji "person in suit levitating: medium-light skin tone" (color) [1F574-1F3FC]. */
const EmojiPersonInSuitLevitatingMediumLightSkinTone = lynxIcon(`
  <g id="color"/>
  <g id="skin">
...
`, _attrs, 72)
export default EmojiPersonInSuitLevitatingMediumLightSkinTone
