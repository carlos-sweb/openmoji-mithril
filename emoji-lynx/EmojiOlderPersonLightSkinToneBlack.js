...
/** Mithril-lynx component for the OpenMoji "older person: light skin tone" (black) [1F9D3-1F3FB]. */
const EmojiOlderPersonLightSkinToneBlack = lynxIcon(`
  <g id="line">
...
`, _attrs, 72)
export default EmojiOlderPersonLightSkinToneBlack
