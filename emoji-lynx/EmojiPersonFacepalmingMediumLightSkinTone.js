...
/** Mithril-lynx component for the OpenMoji "person facepalming: medium-light skin tone" (color) [1F926-1F3FC]. */
const EmojiPersonFacepalmingMediumLightSkinTone = lynxIcon(`
  <g id="color">
...
`, _attrs, 72)
export default EmojiPersonFacepalmingMediumLightSkinTone
