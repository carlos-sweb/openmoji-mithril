...
/** Mithril-lynx component for the OpenMoji "deaf person: dark skin tone" (black) [1F9CF-1F3FF]. */
const EmojiDeafPersonDarkSkinToneBlack = lynxIcon(`
  <g id="line">
...
`, _attrs, 72)
export default EmojiDeafPersonDarkSkinToneBlack
