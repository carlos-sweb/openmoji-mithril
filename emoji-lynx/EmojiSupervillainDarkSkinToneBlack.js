...
/** Mithril-lynx component for the OpenMoji "supervillain: dark skin tone" (black) [1F9B9-1F3FF]. */
const EmojiSupervillainDarkSkinToneBlack = lynxIcon(`
  <g id="line">
...
`, _attrs, 72)
export default EmojiSupervillainDarkSkinToneBlack
