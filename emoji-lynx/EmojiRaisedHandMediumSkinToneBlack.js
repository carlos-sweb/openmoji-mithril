...
/** Mithril-lynx component for the OpenMoji "raised hand: medium skin tone" (black) [270B-1F3FD]. */
const EmojiRaisedHandMediumSkinToneBlack = {
  view: (vnode) => m(
    'svg',
...
export default EmojiRaisedHandMediumSkinToneBlack
