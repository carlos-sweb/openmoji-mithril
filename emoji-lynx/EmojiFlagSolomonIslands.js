...
/** Mithril-lynx component for the OpenMoji "flag: Solomon Islands" (color) [1F1F8-1F1E7]. */
const EmojiFlagSolomonIslands = lynxIcon(`
  <g id="color">
...
`, _attrs, 72)
export default EmojiFlagSolomonIslands
