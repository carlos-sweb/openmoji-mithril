...
/** Mithril-lynx component for the OpenMoji "supervillain: light skin tone" (color) [1F9B9-1F3FB]. */
const EmojiSupervillainLightSkinTone = lynxIcon(`
  <g id="hair">
...
`, _attrs, 72)
export default EmojiSupervillainLightSkinTone
