...
/** Mithril-lynx component for the OpenMoji "merperson: light skin tone" (color) [1F9DC-1F3FB]. */
const EmojiMerpersonLightSkinTone = lynxIcon(`
  <g id="color">
...
`, _attrs, 72)
export default EmojiMerpersonLightSkinTone
