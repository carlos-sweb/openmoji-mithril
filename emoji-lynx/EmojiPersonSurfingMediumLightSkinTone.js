...
/** Mithril-lynx component for the OpenMoji "person surfing: medium-light skin tone" (color) [1F3C4-1F3FC]. */
const EmojiPersonSurfingMediumLightSkinTone = lynxIcon(`
  <g id="color">
...
`, _attrs, 72)
export default EmojiPersonSurfingMediumLightSkinTone
