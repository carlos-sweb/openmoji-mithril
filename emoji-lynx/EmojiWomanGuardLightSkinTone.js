...
/** Mithril-lynx component for the OpenMoji "woman guard: light skin tone" (color) [1F482-1F3FB-200D-2640-FE0F]. */
const EmojiWomanGuardLightSkinTone = {
  view: (vnode) => m(
    'svg',
...
export default EmojiWomanGuardLightSkinTone
