...
/** Mithril-lynx component for the OpenMoji "foot: medium skin tone" (color) [1F9B6-1F3FD]. */
const EmojiFootMediumSkinTone = lynxIcon(`
  <g id="color"/>
  <g id="skin">
...
`, _attrs, 72)
export default EmojiFootMediumSkinTone
