...
/** Mithril-lynx component for the OpenMoji "person swimming: dark skin tone" (color) [1F3CA-1F3FF]. */
const EmojiPersonSwimmingDarkSkinTone = lynxIcon(`
  <g id="color">
...
`, _attrs, 72)
export default EmojiPersonSwimmingDarkSkinTone
