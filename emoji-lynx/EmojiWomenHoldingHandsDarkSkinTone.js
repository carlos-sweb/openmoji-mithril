...
/** Mithril-lynx component for the OpenMoji "women holding hands: dark skin tone" (color) [1F46D-1F3FF]. */
const EmojiWomenHoldingHandsDarkSkinTone = lynxIcon(`
  <g id="color"/>
  <g id="skin">
    <g id="skin-b">
...
`, _attrs, 72)
export default EmojiWomenHoldingHandsDarkSkinTone
