...
/** Mithril-lynx component for the OpenMoji "hand with fingers splayed" (black) [1F590]. */
const EmojiHandWithFingersSplayedBlack = {
  view: (vnode) => m(
    'svg',
...
export default EmojiHandWithFingersSplayedBlack
