...
/** Mithril-lynx component for the OpenMoji "person surfing: medium skin tone" (color) [1F3C4-1F3FD]. */
const EmojiPersonSurfingMediumSkinTone = lynxIcon(`
  <g id="color">
...
`, _attrs, 72)
export default EmojiPersonSurfingMediumSkinTone
