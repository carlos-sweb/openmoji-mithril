...
/** Mithril-lynx component for the OpenMoji "superhero: medium-dark skin tone" (color) [1F9B8-1F3FE]. */
const EmojiSuperheroMediumDarkSkinTone = lynxIcon(`
  <g id="hair">
...
`, _attrs, 72)
export default EmojiSuperheroMediumDarkSkinTone
