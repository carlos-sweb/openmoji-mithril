...
/** Mithril-lynx component for the OpenMoji "oncoming fist: dark skin tone" (color) [1F44A-1F3FF]. */
const EmojiOncomingFistDarkSkinTone = {
  view: (vnode) => m(
    'svg',
...
export default EmojiOncomingFistDarkSkinTone
