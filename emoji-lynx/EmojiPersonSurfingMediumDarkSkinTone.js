...
/** Mithril-lynx component for the OpenMoji "person surfing: medium-dark skin tone" (color) [1F3C4-1F3FE]. */
const EmojiPersonSurfingMediumDarkSkinTone = lynxIcon(`
  <g id="color">
...
`, _attrs, 72)
export default EmojiPersonSurfingMediumDarkSkinTone
