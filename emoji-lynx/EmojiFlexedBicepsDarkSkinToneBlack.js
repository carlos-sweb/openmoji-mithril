...
/** Mithril-lynx component for the OpenMoji "flexed biceps: dark skin tone" (black) [1F4AA-1F3FF]. */
const EmojiFlexedBicepsDarkSkinToneBlack = lynxIcon(`
  <g id="line">
...
`, _attrs, 72)
export default EmojiFlexedBicepsDarkSkinToneBlack
