...
/** Mithril-lynx component for the OpenMoji "vertical traffic light" (black) [1F6A6]. */
const EmojiVerticalTrafficLightBlack = lynxIcon(`
  <g id="line">
...
`, _attrs, 72)
export default EmojiVerticalTrafficLightBlack
