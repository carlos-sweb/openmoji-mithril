...
/** Mithril-lynx component for the OpenMoji "person: dark skin tone, beard" (black) [1F9D4-1F3FF]. */
const EmojiPersonDarkSkinToneBeardBlack = lynxIcon(`
  <g id="line">
...
`, _attrs, 72)
export default EmojiPersonDarkSkinToneBeardBlack
