...
/** Mithril-lynx component for the OpenMoji "snowboarder: medium skin tone" (color) [1F3C2-1F3FD]. */
const EmojiSnowboarderMediumSkinTone = {
  view: (vnode) => m(
    'svg',
...
export default EmojiSnowboarderMediumSkinTone
