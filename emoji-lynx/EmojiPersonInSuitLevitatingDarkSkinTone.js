...
/** Mithril-lynx component for the OpenMoji "person in suit levitating: dark skin tone" (color) [1F574-1F3FF]. */
const EmojiPersonInSuitLevitatingDarkSkinTone = lynxIcon(`
  <g id="color"/>
  <g id="skin">
...
`, _attrs, 72)
export default EmojiPersonInSuitLevitatingDarkSkinTone
