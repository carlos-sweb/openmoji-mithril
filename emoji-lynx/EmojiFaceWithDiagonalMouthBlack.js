...
/** Mithril-lynx component for the OpenMoji "face with diagonal mouth" (black) [1FAE4]. */
const EmojiFaceWithDiagonalMouthBlack = lynxIcon(`
  <g id="line">
...
`, _attrs, 72)
export default EmojiFaceWithDiagonalMouthBlack
