...
/** Mithril-lynx component for the OpenMoji "Mrs. Claus: dark skin tone" (black) [1F936-1F3FF]. */
const EmojiMrsClausDarkSkinToneBlack = lynxIcon(`
  <g id="line">
...
`, _attrs, 72)
export default EmojiMrsClausDarkSkinToneBlack
