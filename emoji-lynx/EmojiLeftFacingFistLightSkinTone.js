...
/** Mithril-lynx component for the OpenMoji "left-facing fist: light skin tone" (color) [1F91B-1F3FB]. */
const EmojiLeftFacingFistLightSkinTone = lynxIcon(`
  <g id="color"/>
  <g id="hair"/>
...
`, _attrs, 72)
export default EmojiLeftFacingFistLightSkinTone
