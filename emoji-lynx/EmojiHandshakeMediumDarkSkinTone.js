...
/** Mithril-lynx component for the OpenMoji "handshake: medium-dark skin tone" (color) [1F91D-1F3FE]. */
const EmojiHandshakeMediumDarkSkinTone = lynxIcon(`
  <g id="color"/>
  <g id="skin">
    <g id="skin-a">
...
`, _attrs, 72)
export default EmojiHandshakeMediumDarkSkinTone
