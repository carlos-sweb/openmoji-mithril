...
/** Mithril-lynx component for the OpenMoji "person getting massage" (color) [1F486]. */
const EmojiPersonGettingMassage = lynxIcon(`
  <g id="color">
...
`, _attrs, 72)
export default EmojiPersonGettingMassage
