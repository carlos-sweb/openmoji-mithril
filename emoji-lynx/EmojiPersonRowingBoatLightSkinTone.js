...
/** Mithril-lynx component for the OpenMoji "person rowing boat: light skin tone" (color) [1F6A3-1F3FB]. */
const EmojiPersonRowingBoatLightSkinTone = lynxIcon(`
  <g id="color">
...
`, _attrs, 72)
export default EmojiPersonRowingBoatLightSkinTone
