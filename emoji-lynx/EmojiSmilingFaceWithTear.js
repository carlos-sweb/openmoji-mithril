...
/** Mithril-lynx component for the OpenMoji "smiling face with tear" (color) [1F972]. */
const EmojiSmilingFaceWithTear = lynxIcon(`
  <g id="color">
    <g id="color-2">
...
`, _attrs, 72)
export default EmojiSmilingFaceWithTear
