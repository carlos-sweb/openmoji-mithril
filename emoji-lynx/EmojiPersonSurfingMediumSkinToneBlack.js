...
/** Mithril-lynx component for the OpenMoji "person surfing: medium skin tone" (black) [1F3C4-1F3FD]. */
const EmojiPersonSurfingMediumSkinToneBlack = lynxIcon(`
  <g id="line">
...
`, _attrs, 72)
export default EmojiPersonSurfingMediumSkinToneBlack
