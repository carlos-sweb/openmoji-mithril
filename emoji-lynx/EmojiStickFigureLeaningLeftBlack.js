...
/** Mithril-lynx component for the OpenMoji "stick figure leaning left" (black) [1FBC7]. */
const EmojiStickFigureLeaningLeftBlack = {
  view: (vnode) => m(
    'svg',
...
export default EmojiStickFigureLeaningLeftBlack
