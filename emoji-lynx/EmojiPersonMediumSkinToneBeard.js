...
/** Mithril-lynx component for the OpenMoji "person: medium skin tone, beard" (color) [1F9D4-1F3FD]. */
const EmojiPersonMediumSkinToneBeard = lynxIcon(`
  <g id="color">
...
`, _attrs, 72)
export default EmojiPersonMediumSkinToneBeard
