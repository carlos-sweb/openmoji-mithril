...
/** Mithril-lynx component for the OpenMoji "leg: medium-dark skin tone" (color) [1F9B5-1F3FE]. */
const EmojiLegMediumDarkSkinTone = {
  view: (vnode) => m(
    'svg',
...
export default EmojiLegMediumDarkSkinTone
