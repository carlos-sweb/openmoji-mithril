...
/** Mithril-lynx component for the OpenMoji "person golfing: dark skin tone" (color) [1F3CC-1F3FF]. */
const EmojiPersonGolfingDarkSkinTone = lynxIcon(`
  <g id="color">
...
`, _attrs, 72)
export default EmojiPersonGolfingDarkSkinTone
