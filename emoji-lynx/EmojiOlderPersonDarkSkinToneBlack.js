...
/** Mithril-lynx component for the OpenMoji "older person: dark skin tone" (black) [1F9D3-1F3FF]. */
const EmojiOlderPersonDarkSkinToneBlack = lynxIcon(`
  <g id="line">
...
`, _attrs, 72)
export default EmojiOlderPersonDarkSkinToneBlack
