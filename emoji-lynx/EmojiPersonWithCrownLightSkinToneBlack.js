...
/** Mithril-lynx component for the OpenMoji "person with crown: light skin tone" (black) [1FAC5-1F3FB]. */
const EmojiPersonWithCrownLightSkinToneBlack = lynxIcon(`
  <g id="line">
...
`, _attrs, 72)
export default EmojiPersonWithCrownLightSkinToneBlack
