...
/** Mithril-lynx component for the OpenMoji "person climbing: light skin tone" (black) [1F9D7-1F3FB]. */
const EmojiPersonClimbingLightSkinToneBlack = lynxIcon(`
  <g id="line">
...
`, _attrs, 72)
export default EmojiPersonClimbingLightSkinToneBlack
