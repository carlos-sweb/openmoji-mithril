...
/** Mithril-lynx component for the OpenMoji "person kneeling: medium-dark skin tone" (black) [1F9CE-1F3FE]. */
const EmojiPersonKneelingMediumDarkSkinToneBlack = lynxIcon(`
  <g id="line">
    <g id="Kneeing_Woman">
...
`, _attrs, 72)
export default EmojiPersonKneelingMediumDarkSkinToneBlack
