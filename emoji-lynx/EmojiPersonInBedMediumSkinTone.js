...
/** Mithril-lynx component for the OpenMoji "person in bed: medium skin tone" (color) [1F6CC-1F3FD]. */
const EmojiPersonInBedMediumSkinTone = lynxIcon(`
  <g id="color">
...
`, _attrs, 72)
export default EmojiPersonInBedMediumSkinTone
