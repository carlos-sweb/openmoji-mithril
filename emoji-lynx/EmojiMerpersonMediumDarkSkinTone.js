...
/** Mithril-lynx component for the OpenMoji "merperson: medium-dark skin tone" (color) [1F9DC-1F3FE]. */
const EmojiMerpersonMediumDarkSkinTone = lynxIcon(`
  <g id="color">
...
`, _attrs, 72)
export default EmojiMerpersonMediumDarkSkinTone
