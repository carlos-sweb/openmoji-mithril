...
/** Mithril-lynx component for the OpenMoji "person pouting: medium-light skin tone" (color) [1F64E-1F3FC]. */
const EmojiPersonPoutingMediumLightSkinTone = lynxIcon(`
  <g id="color">
...
`, _attrs, 72)
export default EmojiPersonPoutingMediumLightSkinTone
