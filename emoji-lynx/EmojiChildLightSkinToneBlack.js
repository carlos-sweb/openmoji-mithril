...
/** Mithril-lynx component for the OpenMoji "child: light skin tone" (black) [1F9D2-1F3FB]. */
const EmojiChildLightSkinToneBlack = lynxIcon(`
  <g id="line">
...
`, _attrs, 72)
export default EmojiChildLightSkinToneBlack
