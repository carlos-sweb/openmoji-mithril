...
/** Mithril-lynx component for the OpenMoji "victory hand: light skin tone" (black) [270C-1F3FB]. */
const EmojiVictoryHandLightSkinToneBlack = lynxIcon(`
  <g id="line">
...
`, _attrs, 72)
export default EmojiVictoryHandLightSkinToneBlack
