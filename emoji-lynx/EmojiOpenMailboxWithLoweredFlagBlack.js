...
/** Mithril-lynx component for the OpenMoji "open mailbox with lowered flag" (black) [1F4ED]. */
const EmojiOpenMailboxWithLoweredFlagBlack = lynxIcon(`
  <g id="line">
...
`, _attrs, 72)
export default EmojiOpenMailboxWithLoweredFlagBlack
