...
/** Mithril-lynx component for the OpenMoji "person in bed: light skin tone" (black) [1F6CC-1F3FB]. */
const EmojiPersonInBedLightSkinToneBlack = lynxIcon(`
  <g id="line">
...
`, _attrs, 72)
export default EmojiPersonInBedLightSkinToneBlack
