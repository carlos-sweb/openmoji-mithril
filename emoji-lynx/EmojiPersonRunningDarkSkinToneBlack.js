...
/** Mithril-lynx component for the OpenMoji "person running: dark skin tone" (black) [1F3C3-1F3FF]. */
const EmojiPersonRunningDarkSkinToneBlack = lynxIcon(`
  <g id="line">
...
`, _attrs, 72)
export default EmojiPersonRunningDarkSkinToneBlack
