...
/** Mithril-lynx component for the OpenMoji "person kneeling: light skin tone" (black) [1F9CE-1F3FB]. */
const EmojiPersonKneelingLightSkinToneBlack = lynxIcon(`
  <g id="line">
    <g id="Kneeing_Woman">
...
`, _attrs, 72)
export default EmojiPersonKneelingLightSkinToneBlack
