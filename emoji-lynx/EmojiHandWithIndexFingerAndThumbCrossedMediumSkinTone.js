...
/** Mithril-lynx component for the OpenMoji "hand with index finger and thumb crossed: medium skin tone" (color) [1FAF0-1F3FD]. */
const EmojiHandWithIndexFingerAndThumbCrossedMediumSkinTone = lynxIcon(`
  <g id="color">
...
`, _attrs, 72)
export default EmojiHandWithIndexFingerAndThumbCrossedMediumSkinTone
