...
/** Mithril-lynx component for the OpenMoji "person gesturing NO: medium skin tone" (color) [1F645-1F3FD]. */
const EmojiPersonGesturingNOMediumSkinTone = lynxIcon(`
  <g id="color">
...
`, _attrs, 72)
export default EmojiPersonGesturingNOMediumSkinTone
