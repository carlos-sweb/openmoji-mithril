...
/** Mithril-lynx component for the OpenMoji "flag: Northern Mariana Islands" (color) [1F1F2-1F1F5]. */
const EmojiFlagNorthernMarianaIslands = lynxIcon(`
  <g id="color">
...
`, _attrs, 72)
export default EmojiFlagNorthernMarianaIslands
