...
/** Mithril-lynx component for the OpenMoji "person rowing boat: medium-dark skin tone" (color) [1F6A3-1F3FE]. */
const EmojiPersonRowingBoatMediumDarkSkinTone = lynxIcon(`
  <g id="color">
...
`, _attrs, 72)
export default EmojiPersonRowingBoatMediumDarkSkinTone
