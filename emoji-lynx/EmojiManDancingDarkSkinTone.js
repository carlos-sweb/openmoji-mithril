...
/** Mithril-lynx component for the OpenMoji "man dancing: dark skin tone" (color) [1F57A-1F3FF]. */
const EmojiManDancingDarkSkinTone = {
  view: (vnode) => m(
    'svg',
...
export default EmojiManDancingDarkSkinTone
