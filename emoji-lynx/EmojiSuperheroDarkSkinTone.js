...
/** Mithril-lynx component for the OpenMoji "superhero: dark skin tone" (color) [1F9B8-1F3FF]. */
const EmojiSuperheroDarkSkinTone = lynxIcon(`
  <g id="hair">
...
`, _attrs, 72)
export default EmojiSuperheroDarkSkinTone
