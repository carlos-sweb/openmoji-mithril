...
/** Mithril-lynx component for the OpenMoji "flag: Norfolk Island" (color) [1F1F3-1F1EB]. */
const EmojiFlagNorfolkIsland = lynxIcon(`
  <g id="color">
...
`, _attrs, 72)
export default EmojiFlagNorfolkIsland
