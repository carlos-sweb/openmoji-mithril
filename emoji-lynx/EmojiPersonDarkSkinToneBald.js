...
/** Mithril-lynx component for the OpenMoji "person: dark skin tone, bald" (color) [1F9D1-1F3FF-200D-1F9B2]. */
const EmojiPersonDarkSkinToneBald = lynxIcon(`
  <g id="skin">
...
`, _attrs, 72)
export default EmojiPersonDarkSkinToneBald
