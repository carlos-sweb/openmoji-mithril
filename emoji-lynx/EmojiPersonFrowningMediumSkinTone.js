...
/** Mithril-lynx component for the OpenMoji "person frowning: medium skin tone" (color) [1F64D-1F3FD]. */
const EmojiPersonFrowningMediumSkinTone = lynxIcon(`
  <g id="color">
...
`, _attrs, 72)
export default EmojiPersonFrowningMediumSkinTone
