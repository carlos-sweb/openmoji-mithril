...
/** Mithril-lynx component for the OpenMoji "face with open mouth" (black) [1F62E]. */
const EmojiFaceWithOpenMouthBlack = lynxIcon(`
  <g id="line">
...
`, _attrs, 72)
export default EmojiFaceWithOpenMouthBlack
