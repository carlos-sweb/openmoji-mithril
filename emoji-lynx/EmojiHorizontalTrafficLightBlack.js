...
/** Mithril-lynx component for the OpenMoji "horizontal traffic light" (black) [1F6A5]. */
const EmojiHorizontalTrafficLightBlack = lynxIcon(`
  <g id="line">
...
`, _attrs, 72)
export default EmojiHorizontalTrafficLightBlack
