...
/** Mithril-lynx component for the OpenMoji "person climbing: dark skin tone" (black) [1F9D7-1F3FF]. */
const EmojiPersonClimbingDarkSkinToneBlack = lynxIcon(`
  <g id="line">
...
`, _attrs, 72)
export default EmojiPersonClimbingDarkSkinToneBlack
