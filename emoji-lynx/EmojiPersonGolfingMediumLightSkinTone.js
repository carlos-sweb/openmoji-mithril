...
/** Mithril-lynx component for the OpenMoji "person golfing: medium-light skin tone" (color) [1F3CC-1F3FC]. */
const EmojiPersonGolfingMediumLightSkinTone = lynxIcon(`
  <g id="color">
...
`, _attrs, 72)
export default EmojiPersonGolfingMediumLightSkinTone
