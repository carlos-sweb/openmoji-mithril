...
/** Mithril-lynx component for the OpenMoji "person biking: dark skin tone" (color) [1F6B4-1F3FF]. */
const EmojiPersonBikingDarkSkinTone = lynxIcon(`
  <g id="color"/>
  <g id="hair"/>
  <g id="skin">
...
`, _attrs, 72)
export default EmojiPersonBikingDarkSkinTone
