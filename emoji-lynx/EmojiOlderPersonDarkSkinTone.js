...
/** Mithril-lynx component for the OpenMoji "older person: dark skin tone" (color) [1F9D3-1F3FF]. */
const EmojiOlderPersonDarkSkinTone = lynxIcon(`
  <g id="color">
...
`, _attrs, 72)
export default EmojiOlderPersonDarkSkinTone
