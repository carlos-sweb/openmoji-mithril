...
/** Mithril-lynx component for the OpenMoji "person juggling: light skin tone" (black) [1F939-1F3FB]. */
const EmojiPersonJugglingLightSkinToneBlack = lynxIcon(`
  <g id="line">
...
`, _attrs, 72)
export default EmojiPersonJugglingLightSkinToneBlack
