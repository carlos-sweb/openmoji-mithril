...
/** Mithril-lynx component for the OpenMoji "person: medium skin tone, bald" (color) [1F9D1-1F3FD-200D-1F9B2]. */
const EmojiPersonMediumSkinToneBald = lynxIcon(`
  <g id="skin">
...
`, _attrs, 72)
export default EmojiPersonMediumSkinToneBald
