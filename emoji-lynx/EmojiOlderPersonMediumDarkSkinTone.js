...
/** Mithril-lynx component for the OpenMoji "older person: medium-dark skin tone" (color) [1F9D3-1F3FE]. */
const EmojiOlderPersonMediumDarkSkinTone = lynxIcon(`
  <g id="color">
...
`, _attrs, 72)
export default EmojiOlderPersonMediumDarkSkinTone
