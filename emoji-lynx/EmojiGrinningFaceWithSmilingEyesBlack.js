...
/** Mithril-lynx component for the OpenMoji "grinning face with smiling eyes" (black) [1F604]. */
const EmojiGrinningFaceWithSmilingEyesBlack = lynxIcon(`
  <g id="line">
...
`, _attrs, 72)
export default EmojiGrinningFaceWithSmilingEyesBlack
