...
/** Mithril-lynx component for the OpenMoji "woman: dark skin tone" (color) [1F469-1F3FF]. */
const EmojiWomanDarkSkinTone = lynxIcon(`
  <g id="color">
...
`, _attrs, 72)
export default EmojiWomanDarkSkinTone
