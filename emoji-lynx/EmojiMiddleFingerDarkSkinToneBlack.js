...
/** Mithril-lynx component for the OpenMoji "middle finger: dark skin tone" (black) [1F595-1F3FF]. */
const EmojiMiddleFingerDarkSkinToneBlack = lynxIcon(`
  <g id="line">
...
`, _attrs, 72)
export default EmojiMiddleFingerDarkSkinToneBlack
