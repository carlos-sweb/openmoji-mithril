...
/** Mithril-lynx component for the OpenMoji "vampire: medium-light skin tone" (black) [1F9DB-1F3FC]. */
const EmojiVampireMediumLightSkinToneBlack = lynxIcon(`
  <g id="line">
...
`, _attrs, 72)
export default EmojiVampireMediumLightSkinToneBlack
