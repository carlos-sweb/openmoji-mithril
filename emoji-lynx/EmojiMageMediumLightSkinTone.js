...
/** Mithril-lynx component for the OpenMoji "mage: medium-light skin tone" (color) [1F9D9-1F3FC]. */
const EmojiMageMediumLightSkinTone = {
  view: (vnode) => m(
    'svg',
...
export default EmojiMageMediumLightSkinTone
