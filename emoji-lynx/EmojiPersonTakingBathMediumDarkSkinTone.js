...
/** Mithril-lynx component for the OpenMoji "person taking bath: medium-dark skin tone" (color) [1F6C0-1F3FE]. */
const EmojiPersonTakingBathMediumDarkSkinTone = lynxIcon(`
  <g id="color">
...
`, _attrs, 72)
export default EmojiPersonTakingBathMediumDarkSkinTone
