...
/** Mithril-lynx component for the OpenMoji "incoming envelope" (black) [1F4E8]. */
const EmojiIncomingEnvelopeBlack = lynxIcon(`
  <g id="line">
...
`, _attrs, 72)
export default EmojiIncomingEnvelopeBlack
