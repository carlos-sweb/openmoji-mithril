...
/** Mithril-lynx component for the OpenMoji "palm up hand: light skin tone" (black) [1FAF4-1F3FB]. */
const EmojiPalmUpHandLightSkinToneBlack = lynxIcon(`
  <g id="line">
...
`, _attrs, 72)
export default EmojiPalmUpHandLightSkinToneBlack
