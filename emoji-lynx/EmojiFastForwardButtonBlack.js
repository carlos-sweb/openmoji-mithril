...
/** Mithril-lynx component for the OpenMoji "fast-forward button" (black) [23E9]. */
const EmojiFastForwardButtonBlack = lynxIcon(`
  <g id="line">
...
`, _attrs, 72)
export default EmojiFastForwardButtonBlack
