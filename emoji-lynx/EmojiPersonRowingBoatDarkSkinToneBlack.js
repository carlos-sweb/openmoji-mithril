...
/** Mithril-lynx component for the OpenMoji "person rowing boat: dark skin tone" (black) [1F6A3-1F3FF]. */
const EmojiPersonRowingBoatDarkSkinToneBlack = lynxIcon(`
  <g id="line">
...
`, _attrs, 72)
export default EmojiPersonRowingBoatDarkSkinToneBlack
