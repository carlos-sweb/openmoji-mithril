...
/** Mithril-lynx component for the OpenMoji "person getting haircut: dark skin tone" (color) [1F487-1F3FF]. */
const EmojiPersonGettingHaircutDarkSkinTone = lynxIcon(`
  <g id="color">
...
`, _attrs, 72)
export default EmojiPersonGettingHaircutDarkSkinTone
