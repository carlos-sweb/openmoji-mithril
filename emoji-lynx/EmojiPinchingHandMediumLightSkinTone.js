...
/** Mithril-lynx component for the OpenMoji "pinching hand: medium-light skin tone" (color) [1F90F-1F3FC]. */
const EmojiPinchingHandMediumLightSkinTone = lynxIcon(`
  <g id="color"/>
  <g id="skin">
    <g id="Pinching_Hand">
...
`, _attrs, 72)
export default EmojiPinchingHandMediumLightSkinTone
