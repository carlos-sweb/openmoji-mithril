...
/** Mithril-lynx component for the OpenMoji "fairy: light skin tone" (black) [1F9DA-1F3FB]. */
const EmojiFairyLightSkinToneBlack = lynxIcon(`
  <g id="line">
...
`, _attrs, 72)
export default EmojiFairyLightSkinToneBlack
