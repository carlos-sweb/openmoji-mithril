...
/** Mithril-lynx component for the OpenMoji "person pouting: light skin tone" (black) [1F64E-1F3FB]. */
const EmojiPersonPoutingLightSkinToneBlack = lynxIcon(`
  <g id="line">
...
`, _attrs, 72)
export default EmojiPersonPoutingLightSkinToneBlack
