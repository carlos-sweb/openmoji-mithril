...
/** Mithril-lynx component for the OpenMoji "glass bottle" (color) [E0CB]. */
const EmojiGlassBottle = lynxIcon(`
  <g id="color">
    <path fill="#92d3f5" d="m33 5.5v12l-4.406 13.5 0.6289 4 0.2773 2-1.5 5v25h16v-25l-1.5-5 0.2773-2 0.6289-4-4.406-13.5v-12z"/>
...
`, _attrs, 72)
export default EmojiGlassBottle
