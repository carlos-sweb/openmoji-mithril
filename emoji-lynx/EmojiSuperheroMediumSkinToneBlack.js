...
/** Mithril-lynx component for the OpenMoji "superhero: medium skin tone" (black) [1F9B8-1F3FD]. */
const EmojiSuperheroMediumSkinToneBlack = lynxIcon(`
  <g id="line">
...
`, _attrs, 72)
export default EmojiSuperheroMediumSkinToneBlack
