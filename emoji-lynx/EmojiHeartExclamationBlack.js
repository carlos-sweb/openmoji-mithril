...
/** Mithril-lynx component for the OpenMoji "heart exclamation" (black) [2763]. */
const EmojiHeartExclamationBlack = lynxIcon(`
  <g id="line">
...
`, _attrs, 72)
export default EmojiHeartExclamationBlack
