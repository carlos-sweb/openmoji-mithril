...
/** Mithril-lynx component for the OpenMoji "woman: medium-dark skin tone" (black) [1F469-1F3FE]. */
const EmojiWomanMediumDarkSkinToneBlack = lynxIcon(`
  <g id="line">
...
`, _attrs, 72)
export default EmojiWomanMediumDarkSkinToneBlack
