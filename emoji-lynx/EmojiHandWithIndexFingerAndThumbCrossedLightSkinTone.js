...
/** Mithril-lynx component for the OpenMoji "hand with index finger and thumb crossed: light skin tone" (color) [1FAF0-1F3FB]. */
const EmojiHandWithIndexFingerAndThumbCrossedLightSkinTone = lynxIcon(`
  <g id="color">
...
`, _attrs, 72)
export default EmojiHandWithIndexFingerAndThumbCrossedLightSkinTone
