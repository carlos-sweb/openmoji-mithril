...
/** Mithril-lynx component for the OpenMoji "flag: French Southern Territories" (color) [1F1F9-1F1EB]. */
const EmojiFlagFrenchSouthernTerritories = lynxIcon(`
  <g id="color">
...
`, _attrs, 72)
export default EmojiFlagFrenchSouthernTerritories
