...
/** Mithril-lynx component for the OpenMoji "person gesturing NO: light skin tone" (color) [1F645-1F3FB]. */
const EmojiPersonGesturingNOLightSkinTone = lynxIcon(`
  <g id="color">
...
`, _attrs, 72)
export default EmojiPersonGesturingNOLightSkinTone
