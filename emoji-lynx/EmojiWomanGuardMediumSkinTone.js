...
/** Mithril-lynx component for the OpenMoji "woman guard: medium skin tone" (color) [1F482-1F3FD-200D-2640-FE0F]. */
const EmojiWomanGuardMediumSkinTone = {
  view: (vnode) => m(
    'svg',
...
export default EmojiWomanGuardMediumSkinTone
