...
/** Mithril-lynx component for the OpenMoji "backhand index pointing right" (color) [1F449]. */
const EmojiBackhandIndexPointingRight = lynxIcon(`
  <g id="color"/>
  <g id="hair"/>
  <g id="skin">
...
`, _attrs, 72)
export default EmojiBackhandIndexPointingRight
