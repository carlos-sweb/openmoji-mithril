...
/** Mithril-lynx component for the OpenMoji "person pouting: dark skin tone" (color) [1F64E-1F3FF]. */
const EmojiPersonPoutingDarkSkinTone = lynxIcon(`
  <g id="color">
...
`, _attrs, 72)
export default EmojiPersonPoutingDarkSkinTone
