...
/** Mithril-lynx component for the OpenMoji "raised back of hand: dark skin tone" (black) [1F91A-1F3FF]. */
const EmojiRaisedBackOfHandDarkSkinToneBlack = {
  view: (vnode) => m(
    'svg',
...
export default EmojiRaisedBackOfHandDarkSkinToneBlack
