...
/** Mithril-lynx component for the OpenMoji "person surfing: light skin tone" (color) [1F3C4-1F3FB]. */
const EmojiPersonSurfingLightSkinTone = lynxIcon(`
  <g id="color">
...
`, _attrs, 72)
export default EmojiPersonSurfingLightSkinTone
