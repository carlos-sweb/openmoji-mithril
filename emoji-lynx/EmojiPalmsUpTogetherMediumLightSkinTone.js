...
/** Mithril-lynx component for the OpenMoji "palms up together: medium-light skin tone" (color) [1F932-1F3FC]. */
const EmojiPalmsUpTogetherMediumLightSkinTone = lynxIcon(`
  <g id="color">
...
`, _attrs, 72)
export default EmojiPalmsUpTogetherMediumLightSkinTone
