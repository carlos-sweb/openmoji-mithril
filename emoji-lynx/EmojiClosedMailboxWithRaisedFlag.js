...
/** Mithril-lynx component for the OpenMoji "closed mailbox with raised flag" (color) [1F4EB]. */
const EmojiClosedMailboxWithRaisedFlag = lynxIcon(`
  <g id="color">
...
`, _attrs, 72)
export default EmojiClosedMailboxWithRaisedFlag
