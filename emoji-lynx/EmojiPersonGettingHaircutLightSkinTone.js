...
/** Mithril-lynx component for the OpenMoji "person getting haircut: light skin tone" (color) [1F487-1F3FB]. */
const EmojiPersonGettingHaircutLightSkinTone = lynxIcon(`
  <g id="color">
...
`, _attrs, 72)
export default EmojiPersonGettingHaircutLightSkinTone
