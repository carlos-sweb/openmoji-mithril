...
/** Mithril-lynx component for the OpenMoji "flag: Central African Republic" (color) [1F1E8-1F1EB]. */
const EmojiFlagCentralAfricanRepublic = lynxIcon(`
  <g id="color">
...
`, _attrs, 72)
export default EmojiFlagCentralAfricanRepublic
