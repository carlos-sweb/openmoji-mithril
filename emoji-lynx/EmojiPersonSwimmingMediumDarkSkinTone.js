...
/** Mithril-lynx component for the OpenMoji "person swimming: medium-dark skin tone" (color) [1F3CA-1F3FE]. */
const EmojiPersonSwimmingMediumDarkSkinTone = lynxIcon(`
  <g id="color">
...
`, _attrs, 72)
export default EmojiPersonSwimmingMediumDarkSkinTone
