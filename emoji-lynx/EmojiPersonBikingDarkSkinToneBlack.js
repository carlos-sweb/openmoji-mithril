...
/** Mithril-lynx component for the OpenMoji "person biking: dark skin tone" (black) [1F6B4-1F3FF]. */
const EmojiPersonBikingDarkSkinToneBlack = lynxIcon(`
  <g id="line">
...
`, _attrs, 72)
export default EmojiPersonBikingDarkSkinToneBlack
