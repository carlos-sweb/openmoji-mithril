...
/** Mithril-lynx component for the OpenMoji "rightwards hand: medium skin tone" (black) [1FAF1-1F3FD]. */
const EmojiRightwardsHandMediumSkinToneBlack = {
  view: (vnode) => m(
    'svg',
...
export default EmojiRightwardsHandMediumSkinToneBlack
