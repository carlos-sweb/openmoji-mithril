...
/** Mithril-lynx component for the OpenMoji "person pouting: medium skin tone" (color) [1F64E-1F3FD]. */
const EmojiPersonPoutingMediumSkinTone = lynxIcon(`
  <g id="color">
...
`, _attrs, 72)
export default EmojiPersonPoutingMediumSkinTone
