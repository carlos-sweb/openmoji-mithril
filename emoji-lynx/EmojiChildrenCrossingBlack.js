...
/** Mithril-lynx component for the OpenMoji "children crossing" (black) [1F6B8]. */
const EmojiChildrenCrossingBlack = lynxIcon(`
  <g id="line">
...
`, _attrs, 72)
export default EmojiChildrenCrossingBlack
