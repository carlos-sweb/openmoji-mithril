...
/** Mithril-lynx component for the OpenMoji "health worker: dark skin tone" (color) [1F9D1-1F3FF-200D-2695-FE0F]. */
const EmojiHealthWorkerDarkSkinTone = lynxIcon(`
  <g id="color">
...
`, _attrs, 72)
export default EmojiHealthWorkerDarkSkinTone
