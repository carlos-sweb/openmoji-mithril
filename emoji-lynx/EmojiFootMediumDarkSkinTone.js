...
/** Mithril-lynx component for the OpenMoji "foot: medium-dark skin tone" (color) [1F9B6-1F3FE]. */
const EmojiFootMediumDarkSkinTone = lynxIcon(`
  <g id="color"/>
  <g id="skin">
...
`, _attrs, 72)
export default EmojiFootMediumDarkSkinTone
