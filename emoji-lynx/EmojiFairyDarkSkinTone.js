...
/** Mithril-lynx component for the OpenMoji "fairy: dark skin tone" (color) [1F9DA-1F3FF]. */
const EmojiFairyDarkSkinTone = lynxIcon(`
  <g id="hair">
...
`, _attrs, 72)
export default EmojiFairyDarkSkinTone
