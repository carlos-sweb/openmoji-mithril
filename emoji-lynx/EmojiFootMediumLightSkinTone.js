...
/** Mithril-lynx component for the OpenMoji "foot: medium-light skin tone" (color) [1F9B6-1F3FC]. */
const EmojiFootMediumLightSkinTone = lynxIcon(`
  <g id="color"/>
  <g id="skin">
...
`, _attrs, 72)
export default EmojiFootMediumLightSkinTone
