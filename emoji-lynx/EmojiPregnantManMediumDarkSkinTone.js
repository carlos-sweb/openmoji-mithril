...
/** Mithril-lynx component for the OpenMoji "pregnant man: medium-dark skin tone" (color) [1FAC3-1F3FE]. */
const EmojiPregnantManMediumDarkSkinTone = {
  view: (vnode) => m(
    'svg',
...
export default EmojiPregnantManMediumDarkSkinTone
