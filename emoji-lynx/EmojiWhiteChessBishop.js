...
/** Mithril-lynx component for the OpenMoji "white chess bishop" (color) [2657]. */
const EmojiWhiteChessBishop = lynxIcon(`
  <g id="color" transform="matrix(.8974 0 0 .8974 3.693 6.164)">
    <polygon fill="#fff" stroke="#fff" points="30.8 35.36 41.15 37.08 44.99 48.08 53.53 60.1 16.93 60.1 27.58 48.16"/>
    <polyline fill="#d0cfce" points="43.53 45.45 53.53 60.1 40.59 60.1"/>
    <rect x="20.66" y="29.34" width="32.26" height="3.726" fill="#fff" stroke="#fff"/>
    <circle cx="36" cy="17" r="10" fill="#fff" stroke="#fff"/>
    <path fill="#d0cfce" d="m41.38 8.58a9.989 9.989 0 0 1-13.8 13.8 9.994 9.994 0 1 0 13.8-13.8z"/>
    <path fill="#fff" stroke="#fff" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="m30.8 35.65v-2.434l10.49 0.1249-0.04286 3.56 0.0517 8.549-9.288-4.328z"/>
    <ellipse cx="36" cy="4.5" rx="2.5" ry="2.5" fill="#fff"/>
  </g>
...
`, _attrs, 72)
export default EmojiWhiteChessBishop
