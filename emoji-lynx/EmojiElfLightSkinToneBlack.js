...
/** Mithril-lynx component for the OpenMoji "elf: light skin tone" (black) [1F9DD-1F3FB]. */
const EmojiElfLightSkinToneBlack = lynxIcon(`
  <g id="line">
...
`, _attrs, 72)
export default EmojiElfLightSkinToneBlack
