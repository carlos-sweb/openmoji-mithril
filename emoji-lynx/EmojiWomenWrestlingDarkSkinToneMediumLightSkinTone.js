...
/** Mithril-lynx component for the OpenMoji "women wrestling: dark skin tone, medium-light skin tone" (color) [1F469-1F3FF-200D-1FAEF-200D-1F469-1F3FC]. */
const EmojiWomenWrestlingDarkSkinToneMediumLightSkinTone = lynxIcon(`
  <g id="color"/>
  <g id="skin">
    <g id="skin-a">
      <circle cx="27.5654" cy="15.4607" r="3.8131" fill="#6a462f"/>
      <path fill="#6a462f" d="M24.0383,27.0907,19.0813,32.62l3.8131,11.4393-.7626,13.3458H18.986l-.7626-12.3925-2.9552-5.72L9.4533,34.5262V30.7131L18.128,21.18A13.3425,13.3425,0,0,1,20.54,18.1949c1.4035-.5458,2.0481-1.0561,3.4443-.8366.7626.286,3.2,3.3454,3.2,5.6333a4.2756,4.2756,0,0,1-.4766,1.8112c0,.0953,2.86,2.0972,4.099,1.1439,1.7159-1.3345,3.4318-5.3383,4.5757-5.3383,1.3346,0-.9532,5.72-2.86,7.2449-3.05,2.3831-7.2448-.7626-7.7215-.1907"/>
      <path fill="#6a462f" d="M10.4065,35.4794v9.5328L8.5,55.4981h2.86l2.86-9.5327.9533-5.72"/>
    </g>
    <g id="skin-b">
...
`, _attrs, 72)
export default EmojiWomenWrestlingDarkSkinToneMediumLightSkinTone
