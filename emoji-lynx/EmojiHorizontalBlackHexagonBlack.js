...
/** Mithril-lynx component for the OpenMoji "horizontal black hexagon " (black) [2B23]. */
const EmojiHorizontalBlackHexagonBlack = {
  view: (vnode) => m(
    'svg',
...
export default EmojiHorizontalBlackHexagonBlack
