...
/** Mithril-lynx component for the OpenMoji "person: medium-light skin tone" (color) [1F9D1-1F3FC]. */
const EmojiPersonMediumLightSkinTone = lynxIcon(`
  <g id="color">
...
`, _attrs, 72)
export default EmojiPersonMediumLightSkinTone
