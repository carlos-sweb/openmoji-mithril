...
/** Mithril-lynx component for the OpenMoji "magnifying glass tilted left" (color) [1F50D]. */
const EmojiMagnifyingGlassTiltedLeft = lynxIcon(`
  <g id="color">
...
`, _attrs, 72)
export default EmojiMagnifyingGlassTiltedLeft
