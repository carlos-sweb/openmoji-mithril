...
/** Mithril-lynx component for the OpenMoji "person: light skin tone" (black) [1F9D1-1F3FB]. */
const EmojiPersonLightSkinToneBlack = lynxIcon(`
  <g id="line">
...
`, _attrs, 72)
export default EmojiPersonLightSkinToneBlack
