...
/** Mithril-lynx component for the OpenMoji "person bouncing ball: dark skin tone" (color) [26F9-1F3FF]. */
const EmojiPersonBouncingBallDarkSkinTone = lynxIcon(`
  <g id="color">
...
`, _attrs, 72)
export default EmojiPersonBouncingBallDarkSkinTone
