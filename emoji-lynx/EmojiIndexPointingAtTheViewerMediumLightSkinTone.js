...
/** Mithril-lynx component for the OpenMoji "index pointing at the viewer: medium-light skin tone" (color) [1FAF5-1F3FC]. */
const EmojiIndexPointingAtTheViewerMediumLightSkinTone = lynxIcon(`
  <g id="color"/>
  <g id="skin">
...
`, _attrs, 72)
export default EmojiIndexPointingAtTheViewerMediumLightSkinTone
