...
/** Mithril-lynx component for the OpenMoji "woman: medium-dark skin tone" (color) [1F469-1F3FE]. */
const EmojiWomanMediumDarkSkinTone = lynxIcon(`
  <g id="color">
...
`, _attrs, 72)
export default EmojiWomanMediumDarkSkinTone
