...
/** Mithril-lynx component for the OpenMoji "left-facing fist: medium-dark skin tone" (color) [1F91B-1F3FE]. */
const EmojiLeftFacingFistMediumDarkSkinTone = lynxIcon(`
  <g id="color"/>
  <g id="hair"/>
...
`, _attrs, 72)
export default EmojiLeftFacingFistMediumDarkSkinTone
