...
/** Mithril-lynx component for the OpenMoji "person biking: light skin tone" (black) [1F6B4-1F3FB]. */
const EmojiPersonBikingLightSkinToneBlack = lynxIcon(`
  <g id="line">
...
`, _attrs, 72)
export default EmojiPersonBikingLightSkinToneBlack
