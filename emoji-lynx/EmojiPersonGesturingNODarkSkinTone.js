...
/** Mithril-lynx component for the OpenMoji "person gesturing NO: dark skin tone" (color) [1F645-1F3FF]. */
const EmojiPersonGesturingNODarkSkinTone = lynxIcon(`
  <g id="color">
...
`, _attrs, 72)
export default EmojiPersonGesturingNODarkSkinTone
