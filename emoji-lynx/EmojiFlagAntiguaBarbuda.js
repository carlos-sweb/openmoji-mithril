...
/** Mithril-lynx component for the OpenMoji "flag: Antigua & Barbuda" (color) [1F1E6-1F1EC]. */
const EmojiFlagAntiguaBarbuda = lynxIcon(`
  <g id="color">
...
`, _attrs, 72)
export default EmojiFlagAntiguaBarbuda
