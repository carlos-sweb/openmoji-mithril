...
/** Mithril-lynx component for the OpenMoji "person mountain biking: medium-light skin tone" (color) [1F6B5-1F3FC]. */
const EmojiPersonMountainBikingMediumLightSkinTone = lynxIcon(`
  <g id="color">
...
`, _attrs, 72)
export default EmojiPersonMountainBikingMediumLightSkinTone
