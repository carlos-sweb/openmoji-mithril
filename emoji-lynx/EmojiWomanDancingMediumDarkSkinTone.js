...
/** Mithril-lynx component for the OpenMoji "woman dancing: medium-dark skin tone" (color) [1F483-1F3FE]. */
const EmojiWomanDancingMediumDarkSkinTone = lynxIcon(`
  <g id="color"/>
  <g id="skin">
...
`, _attrs, 72)
export default EmojiWomanDancingMediumDarkSkinTone
