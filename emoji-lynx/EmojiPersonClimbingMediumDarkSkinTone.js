...
/** Mithril-lynx component for the OpenMoji "person climbing: medium-dark skin tone" (color) [1F9D7-1F3FE]. */
const EmojiPersonClimbingMediumDarkSkinTone = lynxIcon(`
  <g id="color">
...
`, _attrs, 72)
export default EmojiPersonClimbingMediumDarkSkinTone
