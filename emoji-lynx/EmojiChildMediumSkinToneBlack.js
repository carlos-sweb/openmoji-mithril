...
/** Mithril-lynx component for the OpenMoji "child: medium skin tone" (black) [1F9D2-1F3FD]. */
const EmojiChildMediumSkinToneBlack = lynxIcon(`
  <g id="line">
...
`, _attrs, 72)
export default EmojiChildMediumSkinToneBlack
