...
/** Mithril-lynx component for the OpenMoji "person lifting weights: medium-light skin tone" (color) [1F3CB-1F3FC]. */
const EmojiPersonLiftingWeightsMediumLightSkinTone = lynxIcon(`
  <g id="color">
...
`, _attrs, 72)
export default EmojiPersonLiftingWeightsMediumLightSkinTone
