...
/** Mithril-lynx component for the OpenMoji "raising hands: dark skin tone" (black) [1F64C-1F3FF]. */
const EmojiRaisingHandsDarkSkinToneBlack = lynxIcon(`
  <g id="line">
...
`, _attrs, 72)
export default EmojiRaisingHandsDarkSkinToneBlack
