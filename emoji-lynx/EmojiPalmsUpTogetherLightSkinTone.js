...
/** Mithril-lynx component for the OpenMoji "palms up together: light skin tone" (color) [1F932-1F3FB]. */
const EmojiPalmsUpTogetherLightSkinTone = lynxIcon(`
  <g id="color">
...
`, _attrs, 72)
export default EmojiPalmsUpTogetherLightSkinTone
