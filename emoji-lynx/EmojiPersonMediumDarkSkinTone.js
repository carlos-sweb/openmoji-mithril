...
/** Mithril-lynx component for the OpenMoji "person: medium-dark skin tone" (color) [1F9D1-1F3FE]. */
const EmojiPersonMediumDarkSkinTone = lynxIcon(`
  <g id="color">
...
`, _attrs, 72)
export default EmojiPersonMediumDarkSkinTone
