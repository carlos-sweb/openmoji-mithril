...
/** Mithril-lynx component for the OpenMoji "fairy: dark skin tone" (black) [1F9DA-1F3FF]. */
const EmojiFairyDarkSkinToneBlack = lynxIcon(`
  <g id="line">
...
`, _attrs, 72)
export default EmojiFairyDarkSkinToneBlack
