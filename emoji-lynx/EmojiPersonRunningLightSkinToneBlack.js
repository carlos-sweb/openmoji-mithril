...
/** Mithril-lynx component for the OpenMoji "person running: light skin tone" (black) [1F3C3-1F3FB]. */
const EmojiPersonRunningLightSkinToneBlack = lynxIcon(`
  <g id="line">
...
`, _attrs, 72)
export default EmojiPersonRunningLightSkinToneBlack
