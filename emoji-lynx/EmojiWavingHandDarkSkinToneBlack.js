...
/** Mithril-lynx component for the OpenMoji "waving hand: dark skin tone" (black) [1F44B-1F3FF]. */
const EmojiWavingHandDarkSkinToneBlack = lynxIcon(`
  <g id="line">
...
`, _attrs, 72)
export default EmojiWavingHandDarkSkinToneBlack
