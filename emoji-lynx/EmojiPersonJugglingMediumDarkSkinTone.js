...
/** Mithril-lynx component for the OpenMoji "person juggling: medium-dark skin tone" (color) [1F939-1F3FE]. */
const EmojiPersonJugglingMediumDarkSkinTone = lynxIcon(`
  <g id="color">
...
`, _attrs, 72)
export default EmojiPersonJugglingMediumDarkSkinTone
