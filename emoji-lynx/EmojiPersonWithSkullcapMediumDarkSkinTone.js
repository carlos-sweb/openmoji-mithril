...
/** Mithril-lynx component for the OpenMoji "person with skullcap: medium-dark skin tone" (color) [1F472-1F3FE]. */
const EmojiPersonWithSkullcapMediumDarkSkinTone = lynxIcon(`
  <g id="color">
...
`, _attrs, 72)
export default EmojiPersonWithSkullcapMediumDarkSkinTone
