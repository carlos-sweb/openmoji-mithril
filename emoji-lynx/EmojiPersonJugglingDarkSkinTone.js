...
/** Mithril-lynx component for the OpenMoji "person juggling: dark skin tone" (color) [1F939-1F3FF]. */
const EmojiPersonJugglingDarkSkinTone = lynxIcon(`
  <g id="color">
...
`, _attrs, 72)
export default EmojiPersonJugglingDarkSkinTone
