...
/** Mithril-lynx component for the OpenMoji "backhand index pointing left: medium-dark skin tone" (color) [1F448-1F3FE]. */
const EmojiBackhandIndexPointingLeftMediumDarkSkinTone = lynxIcon(`
  <g id="color"/>
  <g id="hair"/>
  <g id="skin">
...
`, _attrs, 72)
export default EmojiBackhandIndexPointingLeftMediumDarkSkinTone
