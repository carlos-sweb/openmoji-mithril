...
/** Mithril-lynx component for the OpenMoji "man cartwheeling: dark skin tone" (color) [1F938-1F3FF-200D-2642-FE0F]. */
const EmojiManCartwheelingDarkSkinTone = {
  view: (vnode) => m(
    'svg',
...
export default EmojiManCartwheelingDarkSkinTone
