...
/** Mithril-lynx component for the OpenMoji "person lifting weights: light skin tone" (color) [1F3CB-1F3FB]. */
const EmojiPersonLiftingWeightsLightSkinTone = lynxIcon(`
  <g id="color">
...
`, _attrs, 72)
export default EmojiPersonLiftingWeightsLightSkinTone
