...
/** Mithril-lynx component for the OpenMoji "horse racing: medium skin tone" (color) [1F3C7-1F3FD]. */
const EmojiHorseRacingMediumSkinTone = lynxIcon(`
  <g id="color">
...
`, _attrs, 72)
export default EmojiHorseRacingMediumSkinTone
