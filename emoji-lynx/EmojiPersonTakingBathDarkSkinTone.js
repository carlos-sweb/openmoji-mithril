...
/** Mithril-lynx component for the OpenMoji "person taking bath: dark skin tone" (color) [1F6C0-1F3FF]. */
const EmojiPersonTakingBathDarkSkinTone = lynxIcon(`
  <g id="color">
...
`, _attrs, 72)
export default EmojiPersonTakingBathDarkSkinTone
