...
/** Mithril-lynx component for the OpenMoji "old woman: medium-light skin tone" (color) [1F475-1F3FC]. */
const EmojiOldWomanMediumLightSkinTone = lynxIcon(`
  <g id="color">
...
`, _attrs, 72)
export default EmojiOldWomanMediumLightSkinTone
