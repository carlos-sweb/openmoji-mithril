...
/** Mithril-lynx component for the OpenMoji "person running: medium-light skin tone" (color) [1F3C3-1F3FC]. */
const EmojiPersonRunningMediumLightSkinTone = lynxIcon(`
  <g id="color"/>
  <g id="skin">
...
`, _attrs, 72)
export default EmojiPersonRunningMediumLightSkinTone
