...
/** Mithril-lynx component for the OpenMoji "men with bunny ears: medium-dark skin tone, medium-light skin tone" (color) [1F468-1F3FE-200D-1F430-200D-1F468-1F3FC]. */
const EmojiMenWithBunnyEarsMediumDarkSkinToneMediumLightSkinTone = lynxIcon(`
  <g id="color">
  ...
  <g id="skin">
    <g id="skin-b">
      <path fill="#debb90" d="M51.2773,27.0864l-.4606,6.248,1.4606,4.752,2,12,2.7,11h-3.3l-3.4-11-3-11h-1l-1.4,22h-3.3l-.3-23,1.3356-5.5752-.3356-5.4248s0-2-1,0l1,2v3l-3-3L38.11,26.7837l1.1677-2.6973,3-2,1-1h7l2,1,1.693,2.0459,1.0525,3.3408-2.7455,3.6133h-1"/>
      <circle cx="47.1621" cy="14.1802" r="3" fill="#debb90"/>
    </g>
    <g id="skin-a">
      <polyline points="54.193 12.086 53.193 8.086 50.193 8.086"/>
      <path fill="#a57939" d="M30.2275,27.0849l-.4606,6.2481,1.4606,4.7519,2,12,2.7,11h-3.3l-3.4-11-3-11h-1l-1.4,22h-3.3l-.3-23L21.5631,32.51l-.3356-5.4249s0-2-1,0l1,2v3l-3-3L17.06,26.7823l1.1677-2.6974,3-2,1-1h7l2,1,1.693,2.046,1.0525,3.3408-2.7455,3.6132h-1"/>
      <circle cx="26.1123" cy="14.1787" r="3" fill="#a57939"/>
    </g>
  </g>
  <g id="line">
...
`, _attrs, 72)
export default EmojiMenWithBunnyEarsMediumDarkSkinToneMediumLightSkinTone
