...
/** Mithril-lynx component for the OpenMoji "beach with umbrella" (black) [1F3D6]. */
const EmojiBeachWithUmbrellaBlack = lynxIcon(`
  <g id="line">
...
`, _attrs, 72)
export default EmojiBeachWithUmbrellaBlack
