...
/** Mithril-lynx component for the OpenMoji "person lifting weights: dark skin tone" (color) [1F3CB-1F3FF]. */
const EmojiPersonLiftingWeightsDarkSkinTone = lynxIcon(`
  <g id="color">
...
`, _attrs, 72)
export default EmojiPersonLiftingWeightsDarkSkinTone
