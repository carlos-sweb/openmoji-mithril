...
/** Mithril-lynx component for the OpenMoji "person bowing: dark skin tone" (color) [1F647-1F3FF]. */
const EmojiPersonBowingDarkSkinTone = lynxIcon(`
  <g id="color">
...
`, _attrs, 72)
export default EmojiPersonBowingDarkSkinTone
