...
/** Mithril-lynx component for the OpenMoji "raised hand: medium-dark skin tone" (black) [270B-1F3FE]. */
const EmojiRaisedHandMediumDarkSkinToneBlack = {
  view: (vnode) => m(
    'svg',
...
export default EmojiRaisedHandMediumDarkSkinToneBlack
