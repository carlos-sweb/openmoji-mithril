...
/** Mithril-lynx component for the OpenMoji "people wrestling: medium skin tone" (color) [1F93C-1F3FD]. */
const EmojiPeopleWrestlingMediumSkinTone = {
  view: (vnode) => m(
    'svg',
...
export default EmojiPeopleWrestlingMediumSkinTone
