...
/** Mithril-lynx component for the OpenMoji "face with open eyes and hand over mouth" (color) [1FAE2]. */
const EmojiFaceWithOpenEyesAndHandOverMouth = lynxIcon(`
  <g id="color">
...
`, _attrs, 72)
export default EmojiFaceWithOpenEyesAndHandOverMouth
