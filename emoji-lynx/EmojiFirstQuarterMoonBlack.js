...
/** Mithril-lynx component for the OpenMoji "first quarter moon" (black) [1F313]. */
const EmojiFirstQuarterMoonBlack = lynxIcon(`
...
`, _attrs, 72)
export default EmojiFirstQuarterMoonBlack
