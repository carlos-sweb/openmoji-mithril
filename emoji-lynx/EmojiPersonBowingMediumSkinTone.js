...
/** Mithril-lynx component for the OpenMoji "person bowing: medium skin tone" (color) [1F647-1F3FD]. */
const EmojiPersonBowingMediumSkinTone = lynxIcon(`
  <g id="color">
...
`, _attrs, 72)
export default EmojiPersonBowingMediumSkinTone
