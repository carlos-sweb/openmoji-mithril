...
/** Mithril-lynx component for the OpenMoji "person kneeling: dark skin tone" (black) [1F9CE-1F3FF]. */
const EmojiPersonKneelingDarkSkinToneBlack = lynxIcon(`
  <g id="line">
    <g id="Kneeing_Woman">
...
`, _attrs, 72)
export default EmojiPersonKneelingDarkSkinToneBlack
