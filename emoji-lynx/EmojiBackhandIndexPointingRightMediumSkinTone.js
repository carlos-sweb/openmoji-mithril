...
/** Mithril-lynx component for the OpenMoji "backhand index pointing right: medium skin tone" (color) [1F449-1F3FD]. */
const EmojiBackhandIndexPointingRightMediumSkinTone = lynxIcon(`
  <g id="color"/>
  <g id="hair"/>
  <g id="skin">
...
`, _attrs, 72)
export default EmojiBackhandIndexPointingRightMediumSkinTone
