...
/** Mithril-lynx component for the OpenMoji "flag: St. Pierre & Miquelon" (color) [1F1F5-1F1F2]. */
const EmojiFlagStPierreMiquelon = lynxIcon(`
  <g id="color">
    <g>
...
`, _attrs, 72)
export default EmojiFlagStPierreMiquelon
