...
/** Mithril-lynx component for the OpenMoji "older person: light skin tone" (color) [1F9D3-1F3FB]. */
const EmojiOlderPersonLightSkinTone = lynxIcon(`
  <g id="color">
...
`, _attrs, 72)
export default EmojiOlderPersonLightSkinTone
