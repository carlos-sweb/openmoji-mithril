...
/** Mithril-lynx component for the OpenMoji "notebook with decorative cover" (color) [1F4D4]. */
const EmojiNotebookWithDecorativeCover = lynxIcon(`
  <g id="color">
...
`, _attrs, 72)
export default EmojiNotebookWithDecorativeCover
