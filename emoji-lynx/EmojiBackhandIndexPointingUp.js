...
/** Mithril-lynx component for the OpenMoji "backhand index pointing up" (color) [1F446]. */
const EmojiBackhandIndexPointingUp = lynxIcon(`
  <g id="color"/>
  <g id="hair"/>
  <g id="skin">
...
`, _attrs, 72)
export default EmojiBackhandIndexPointingUp
