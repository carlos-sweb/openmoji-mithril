...
/** Mithril-lynx component for the OpenMoji "men holding hands: medium skin tone" (color) [1F46C-1F3FD]. */
const EmojiMenHoldingHandsMediumSkinTone = lynxIcon(`
  <g id="color"/>
  <g id="skin">
    <g id="skin-b">
...
`, _attrs, 72)
export default EmojiMenHoldingHandsMediumSkinTone
