...
/** Mithril-lynx component for the OpenMoji "person mountain biking: medium-dark skin tone" (color) [1F6B5-1F3FE]. */
const EmojiPersonMountainBikingMediumDarkSkinTone = lynxIcon(`
  <g id="color">
...
`, _attrs, 72)
export default EmojiPersonMountainBikingMediumDarkSkinTone
