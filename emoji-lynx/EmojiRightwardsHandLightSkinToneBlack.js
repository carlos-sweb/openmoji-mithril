...
/** Mithril-lynx component for the OpenMoji "rightwards hand: light skin tone" (black) [1FAF1-1F3FB]. */
const EmojiRightwardsHandLightSkinToneBlack = {
  view: (vnode) => m(
    'svg',
...
export default EmojiRightwardsHandLightSkinToneBlack
