...
/** Mithril-lynx component for the OpenMoji "woman pouting: light skin tone" (color) [1F64E-1F3FB-200D-2640-FE0F]. */
const EmojiWomanPoutingLightSkinTone = lynxIcon(`
  <g id="color">
...
`, _attrs, 72)
export default EmojiWomanPoutingLightSkinTone
