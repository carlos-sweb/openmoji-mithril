...
/** Mithril-lynx component for the OpenMoji "woman dancing: medium skin tone" (color) [1F483-1F3FD]. */
const EmojiWomanDancingMediumSkinTone = lynxIcon(`
  <g id="color"/>
  <g id="skin">
...
`, _attrs, 72)
export default EmojiWomanDancingMediumSkinTone
