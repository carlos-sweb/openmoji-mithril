...
/** Mithril-lynx component for the OpenMoji "person surfing: dark skin tone" (color) [1F3C4-1F3FF]. */
const EmojiPersonSurfingDarkSkinTone = lynxIcon(`
  <g id="color">
...
`, _attrs, 72)
export default EmojiPersonSurfingDarkSkinTone
