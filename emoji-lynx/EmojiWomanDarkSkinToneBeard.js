...
/** Mithril-lynx component for the OpenMoji "woman: dark skin tone, beard" (color) [1F9D4-1F3FF-200D-2640-FE0F]. */
const EmojiWomanDarkSkinToneBeard = lynxIcon(`
  <g id="color">
...
`, _attrs, 72)
export default EmojiWomanDarkSkinToneBeard
