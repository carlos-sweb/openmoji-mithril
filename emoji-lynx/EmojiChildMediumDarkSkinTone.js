...
/** Mithril-lynx component for the OpenMoji "child: medium-dark skin tone" (color) [1F9D2-1F3FE]. */
const EmojiChildMediumDarkSkinTone = lynxIcon(`
  <g id="color">
...
`, _attrs, 72)
export default EmojiChildMediumDarkSkinTone
