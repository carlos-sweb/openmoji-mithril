...
/** Mithril-lynx component for the OpenMoji "woman construction worker: medium-dark skin tone" (color) [1F477-1F3FE-200D-2640-FE0F]. */
const EmojiWomanConstructionWorkerMediumDarkSkinTone = {
  view: (vnode) => m(
    'svg',
