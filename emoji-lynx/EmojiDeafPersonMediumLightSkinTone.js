...
/** Mithril-lynx component for the OpenMoji "deaf person: medium-light skin tone" (color) [1F9CF-1F3FC]. */
const EmojiDeafPersonMediumLightSkinTone = lynxIcon(`
  <g id="color">
...
`, _attrs, 72)
export default EmojiDeafPersonMediumLightSkinTone
