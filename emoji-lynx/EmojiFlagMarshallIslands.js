...
/** Mithril-lynx component for the OpenMoji "flag: Marshall Islands" (color) [1F1F2-1F1ED]. */
const EmojiFlagMarshallIslands = lynxIcon(`
  <g id="color">
...
`, _attrs, 72)
export default EmojiFlagMarshallIslands
