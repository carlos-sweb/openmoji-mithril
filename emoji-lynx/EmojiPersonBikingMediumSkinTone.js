...
/** Mithril-lynx component for the OpenMoji "person biking: medium skin tone" (color) [1F6B4-1F3FD]. */
const EmojiPersonBikingMediumSkinTone = lynxIcon(`
  <g id="color"/>
  <g id="hair"/>
  <g id="skin">
...
`, _attrs, 72)
export default EmojiPersonBikingMediumSkinTone
