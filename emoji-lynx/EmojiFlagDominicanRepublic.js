...
/** Mithril-lynx component for the OpenMoji "flag: Dominican Republic" (color) [1F1E9-1F1F4]. */
const EmojiFlagDominicanRepublic = lynxIcon(`
  <g id="color">
...
`, _attrs, 72)
export default EmojiFlagDominicanRepublic
