...
/** Mithril-lynx component for the OpenMoji "fairy: medium-dark skin tone" (color) [1F9DA-1F3FE]. */
const EmojiFairyMediumDarkSkinTone = lynxIcon(`
  <g id="hair">
...
`, _attrs, 72)
export default EmojiFairyMediumDarkSkinTone
