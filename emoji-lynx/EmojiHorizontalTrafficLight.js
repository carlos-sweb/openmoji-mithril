...
/** Mithril-lynx component for the OpenMoji "horizontal traffic light" (color) [1F6A5]. */
const EmojiHorizontalTrafficLight = lynxIcon(`
  <g id="color">
...
`, _attrs, 72)
export default EmojiHorizontalTrafficLight
