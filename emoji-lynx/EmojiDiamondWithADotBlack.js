...
/** Mithril-lynx component for the OpenMoji "diamond with a dot" (black) [1F4A0]. */
const EmojiDiamondWithADotBlack = lynxIcon(`
  <g id="line">
...
`, _attrs, 72)
export default EmojiDiamondWithADotBlack
