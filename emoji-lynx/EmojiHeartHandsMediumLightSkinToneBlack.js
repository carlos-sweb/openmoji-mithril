...
/** Mithril-lynx component for the OpenMoji "heart hands: medium-light skin tone" (black) [1FAF6-1F3FC]. */
const EmojiHeartHandsMediumLightSkinToneBlack = {
  view: (vnode) => m(
    'svg',
...
export default EmojiHeartHandsMediumLightSkinToneBlack
