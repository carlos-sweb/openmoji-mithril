...
/** Mithril-lynx component for the OpenMoji "woman with headscarf: medium-dark skin tone" (color) [1F9D5-1F3FE]. */
const EmojiWomanWithHeadscarfMediumDarkSkinTone = lynxIcon(`
  <g id="color">
...
`, _attrs, 72)
export default EmojiWomanWithHeadscarfMediumDarkSkinTone
