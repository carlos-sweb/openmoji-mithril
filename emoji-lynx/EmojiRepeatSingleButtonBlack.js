...
/** Mithril-lynx component for the OpenMoji "repeat single button" (black) [1F502]. */
const EmojiRepeatSingleButtonBlack = lynxIcon(`
  <g id="line">
...
`, _attrs, 72)
export default EmojiRepeatSingleButtonBlack
