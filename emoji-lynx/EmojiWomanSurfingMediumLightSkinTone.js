...
/** Mithril-lynx component for the OpenMoji "woman surfing: medium-light skin tone" (color) [1F3C4-1F3FC-200D-2640-FE0F]. */
const EmojiWomanSurfingMediumLightSkinTone = {
  view: (vnode) => m(
    'svg',
...
export default EmojiWomanSurfingMediumLightSkinTone
