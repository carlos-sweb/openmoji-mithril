...
/** Mithril-lynx component for the OpenMoji "mage: medium-light skin tone" (black) [1F9D9-1F3FC]. */
const EmojiMageMediumLightSkinToneBlack = lynxIcon(`
  <g id="line">
...
`, _attrs, 72)
export default EmojiMageMediumLightSkinToneBlack
