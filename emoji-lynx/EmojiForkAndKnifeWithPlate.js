...
/** Mithril-lynx component for the OpenMoji "fork and knife with plate" (color) [1F37D]. */
const EmojiForkAndKnifeWithPlate = lynxIcon(`
  <g id="color">
...
`, _attrs, 72)
export default EmojiForkAndKnifeWithPlate
