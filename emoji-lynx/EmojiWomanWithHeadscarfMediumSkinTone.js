...
/** Mithril-lynx component for the OpenMoji "woman with headscarf: medium skin tone" (color) [1F9D5-1F3FD]. */
const EmojiWomanWithHeadscarfMediumSkinTone = lynxIcon(`
  <g id="color">
...
`, _attrs, 72)
export default EmojiWomanWithHeadscarfMediumSkinTone
