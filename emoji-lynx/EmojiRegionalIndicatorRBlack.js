...
/** Mithril-lynx component for the OpenMoji "regional indicator R" (black) [1F1F7]. */
const EmojiRegionalIndicatorRBlack = lynxIcon(`
  <g id="line">
    <g id="line-2">
...
`, _attrs, 72)
export default EmojiRegionalIndicatorRBlack
