...
/** Mithril-lynx component for the OpenMoji "white vertical ellipse" (color) [2B2F]. */
const EmojiWhiteVerticalEllipse = lynxIcon(`
  <g id="color">
...
`, _attrs, 72)
export default EmojiWhiteVerticalEllipse
