...
/** Mithril-lynx component for the OpenMoji "person: light skin tone, blond hair" (color) [1F471-1F3FB]. */
const EmojiPersonLightSkinToneBlondHair = lynxIcon(`
  <g id="color">
...
`, _attrs, 72)
export default EmojiPersonLightSkinToneBlondHair
