...
/** Mithril-lynx component for the OpenMoji "closed mailbox with raised flag" (black) [1F4EB]. */
const EmojiClosedMailboxWithRaisedFlagBlack = lynxIcon(`
  <g id="line">
...
`, _attrs, 72)
export default EmojiClosedMailboxWithRaisedFlagBlack
