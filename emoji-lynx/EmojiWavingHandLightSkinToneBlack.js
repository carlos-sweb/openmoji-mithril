...
/** Mithril-lynx component for the OpenMoji "waving hand: light skin tone" (black) [1F44B-1F3FB]. */
const EmojiWavingHandLightSkinToneBlack = lynxIcon(`
  <g id="line">
...
`, _attrs, 72)
export default EmojiWavingHandLightSkinToneBlack
