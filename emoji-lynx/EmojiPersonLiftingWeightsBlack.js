...
/** Mithril-lynx component for the OpenMoji "person lifting weights" (black) [1F3CB]. */
const EmojiPersonLiftingWeightsBlack = lynxIcon(`
  <g id="line">
...
`, _attrs, 72)
export default EmojiPersonLiftingWeightsBlack
