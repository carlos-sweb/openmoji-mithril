...
/** Mithril-lynx component for the OpenMoji "flag: Equatorial Guinea" (color) [1F1EC-1F1F6]. */
const EmojiFlagEquatorialGuinea = lynxIcon(`
  <g id="color">
...
`, _attrs, 72)
export default EmojiFlagEquatorialGuinea
