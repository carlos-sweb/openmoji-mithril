...
/** Mithril-lynx component for the OpenMoji "woman and man holding hands: dark skin tone" (color) [1F46B-1F3FF]. */
const EmojiWomanAndManHoldingHandsDarkSkinTone = lynxIcon(`
  <g id="color"/>
  <g id="skin">
    <g id="skin-b">
...
`, _attrs, 72)
export default EmojiWomanAndManHoldingHandsDarkSkinTone
