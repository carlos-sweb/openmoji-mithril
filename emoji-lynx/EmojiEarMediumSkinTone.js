...
/** Mithril-lynx component for the OpenMoji "ear: medium skin tone" (color) [1F442-1F3FD]. */
const EmojiEarMediumSkinTone = lynxIcon(`
  <g id="color"/>
  <g id="hair"/>
  <g id="skin">
...
`, _attrs, 72)
export default EmojiEarMediumSkinTone
