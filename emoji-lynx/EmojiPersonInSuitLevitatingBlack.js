...
/** Mithril-lynx component for the OpenMoji "person in suit levitating" (black) [1F574]. */
const EmojiPersonInSuitLevitatingBlack = lynxIcon(`
  <g id="line">
...
`, _attrs, 72)
export default EmojiPersonInSuitLevitatingBlack
