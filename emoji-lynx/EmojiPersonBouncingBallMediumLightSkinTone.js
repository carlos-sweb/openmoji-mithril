...
/** Mithril-lynx component for the OpenMoji "person bouncing ball: medium-light skin tone" (color) [26F9-1F3FC]. */
const EmojiPersonBouncingBallMediumLightSkinTone = lynxIcon(`
  <g id="color">
...
`, _attrs, 72)
export default EmojiPersonBouncingBallMediumLightSkinTone
