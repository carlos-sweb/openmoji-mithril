...
/** Mithril-lynx component for the OpenMoji "flexed biceps: medium-dark skin tone" (color) [1F4AA-1F3FE]. */
const EmojiFlexedBicepsMediumDarkSkinTone = lynxIcon(`
  <g id="color"/>
  <g id="hair"/>
  <g id="skin">
...
`, _attrs, 72)
export default EmojiFlexedBicepsMediumDarkSkinTone
