...
/** Mithril-lynx component for the OpenMoji "person climbing: light skin tone" (color) [1F9D7-1F3FB]. */
const EmojiPersonClimbingLightSkinTone = lynxIcon(`
  <g id="color">
...
`, _attrs, 72)
export default EmojiPersonClimbingLightSkinTone
