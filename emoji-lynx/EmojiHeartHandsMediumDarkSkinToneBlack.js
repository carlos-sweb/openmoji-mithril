...
/** Mithril-lynx component for the OpenMoji "heart hands: medium-dark skin tone" (black) [1FAF6-1F3FE]. */
const EmojiHeartHandsMediumDarkSkinToneBlack = {
  view: (vnode) => m(
    'svg',
...
export default EmojiHeartHandsMediumDarkSkinToneBlack
