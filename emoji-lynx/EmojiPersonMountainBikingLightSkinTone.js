...
/** Mithril-lynx component for the OpenMoji "person mountain biking: light skin tone" (color) [1F6B5-1F3FB]. */
const EmojiPersonMountainBikingLightSkinTone = lynxIcon(`
  <g id="color">
...
`, _attrs, 72)
export default EmojiPersonMountainBikingLightSkinTone
