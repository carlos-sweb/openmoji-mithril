...
/** Mithril-lynx component for the OpenMoji "beaming face with smiling eyes" (black) [1F601]. */
const EmojiBeamingFaceWithSmilingEyesBlack = lynxIcon(`
  <g id="line">
...
`, _attrs, 72)
export default EmojiBeamingFaceWithSmilingEyesBlack
