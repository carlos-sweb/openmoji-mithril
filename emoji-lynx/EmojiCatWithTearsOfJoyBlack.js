...
/** Mithril-lynx component for the OpenMoji "cat with tears of joy" (black) [1F639]. */
const EmojiCatWithTearsOfJoyBlack = lynxIcon(`
  <g id="line">
...
`, _attrs, 72)
export default EmojiCatWithTearsOfJoyBlack
