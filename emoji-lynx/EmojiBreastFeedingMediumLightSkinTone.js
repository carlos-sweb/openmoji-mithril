...
/** Mithril-lynx component for the OpenMoji "breast-feeding: medium-light skin tone" (color) [1F931-1F3FC]. */
const EmojiBreastFeedingMediumLightSkinTone = lynxIcon(`
  <g id="color">
...
`, _attrs, 72)
export default EmojiBreastFeedingMediumLightSkinTone
