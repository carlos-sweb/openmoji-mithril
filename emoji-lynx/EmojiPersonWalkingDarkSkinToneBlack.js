...
/** Mithril-lynx component for the OpenMoji "person walking: dark skin tone" (black) [1F6B6-1F3FF]. */
const EmojiPersonWalkingDarkSkinToneBlack = lynxIcon(`
  <g id="line">
...
`, _attrs, 72)
export default EmojiPersonWalkingDarkSkinToneBlack
