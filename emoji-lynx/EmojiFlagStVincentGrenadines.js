...
/** Mithril-lynx component for the OpenMoji "flag: St. Vincent & Grenadines" (color) [1F1FB-1F1E8]. */
const EmojiFlagStVincentGrenadines = lynxIcon(`
  <g id="color">
...
`, _attrs, 72)
export default EmojiFlagStVincentGrenadines
