...
/** Mithril-lynx component for the OpenMoji "index pointing at the viewer: medium skin tone" (color) [1FAF5-1F3FD]. */
const EmojiIndexPointingAtTheViewerMediumSkinTone = lynxIcon(`
  <g id="color"/>
  <g id="skin">
...
`, _attrs, 72)
export default EmojiIndexPointingAtTheViewerMediumSkinTone
