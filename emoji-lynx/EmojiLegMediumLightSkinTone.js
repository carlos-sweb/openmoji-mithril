...
/** Mithril-lynx component for the OpenMoji "leg: medium-light skin tone" (color) [1F9B5-1F3FC]. */
const EmojiLegMediumLightSkinTone = {
  view: (vnode) => m(
    'svg',
...
export default EmojiLegMediumLightSkinTone
