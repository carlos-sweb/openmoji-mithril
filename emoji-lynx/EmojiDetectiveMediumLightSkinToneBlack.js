...
/** Mithril-lynx component for the OpenMoji "detective: medium-light skin tone" (black) [1F575-1F3FC]. */
const EmojiDetectiveMediumLightSkinToneBlack = {
  view: (vnode) => m(
    'svg',
...
export default EmojiDetectiveMediumLightSkinToneBlack
