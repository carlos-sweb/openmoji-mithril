...
/** Mithril-lynx component for the OpenMoji "women holding hands: medium-dark skin tone" (color) [1F46D-1F3FE]. */
const EmojiWomenHoldingHandsMediumDarkSkinTone = lynxIcon(`
  <g id="color"/>
  <g id="skin">
    <g id="skin-b">
...
`, _attrs, 72)
export default EmojiWomenHoldingHandsMediumDarkSkinTone
