...
/** Mithril-lynx component for the OpenMoji "snowboarder: dark skin tone" (black) [1F3C2-1F3FF]. */
const EmojiSnowboarderDarkSkinToneBlack = lynxIcon(`
  <g id="line">
...
`, _attrs, 72)
export default EmojiSnowboarderDarkSkinToneBlack
