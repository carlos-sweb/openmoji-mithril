...
/** Mithril-lynx component for the OpenMoji "person running: medium-dark skin tone" (color) [1F3C3-1F3FE]. */
const EmojiPersonRunningMediumDarkSkinTone = lynxIcon(`
  <g id="color"/>
  <g id="skin">
...
`, _attrs, 72)
export default EmojiPersonRunningMediumDarkSkinTone
