...
/** Mithril-lynx component for the OpenMoji "person: light skin tone" (color) [1F9D1-1F3FB]. */
const EmojiPersonLightSkinTone = lynxIcon(`
  <g id="color">
...
`, _attrs, 72)
export default EmojiPersonLightSkinTone
