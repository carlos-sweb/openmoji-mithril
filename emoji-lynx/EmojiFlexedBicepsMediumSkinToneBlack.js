...
/** Mithril-lynx component for the OpenMoji "flexed biceps: medium skin tone" (black) [1F4AA-1F3FD]. */
const EmojiFlexedBicepsMediumSkinToneBlack = lynxIcon(`
  <g id="line">
...
`, _attrs, 72)
export default EmojiFlexedBicepsMediumSkinToneBlack
