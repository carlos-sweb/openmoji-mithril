...
/** Mithril-lynx component for the OpenMoji "slightly frowning face" (color) [1F641]. */
const EmojiSlightlyFrowningFace = lynxIcon(`
  <g id="color">
...
`, _attrs, 72)
export default EmojiSlightlyFrowningFace
