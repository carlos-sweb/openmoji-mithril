...
/** Mithril-lynx component for the OpenMoji "backhand index pointing up: light skin tone" (color) [1F446-1F3FB]. */
const EmojiBackhandIndexPointingUpLightSkinTone = lynxIcon(`
  <g id="color"/>
  <g id="hair"/>
  <g id="skin">
...
`, _attrs, 72)
export default EmojiBackhandIndexPointingUpLightSkinTone
