...
/** Mithril-lynx component for the OpenMoji "person mountain biking" (color) [1F6B5]. */
const EmojiPersonMountainBiking = lynxIcon(`
  <g id="color">
...
`, _attrs, 72)
export default EmojiPersonMountainBiking
