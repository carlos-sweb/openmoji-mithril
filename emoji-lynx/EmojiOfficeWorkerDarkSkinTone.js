...
/** Mithril-lynx component for the OpenMoji "office worker: dark skin tone" (color) [1F9D1-1F3FF-200D-1F4BC]. */
const EmojiOfficeWorkerDarkSkinTone = lynxIcon(`
  <g id="color">
...
`, _attrs, 72)
export default EmojiOfficeWorkerDarkSkinTone
