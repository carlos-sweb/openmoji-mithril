...
/** Mithril-lynx component for the OpenMoji "couple with heart: medium-light skin tone" (color) [1F491-1F3FC]. */
const EmojiCoupleWithHeartMediumLightSkinTone = {
  view: (vnode) => m(
    'svg',
...
export default EmojiCoupleWithHeartMediumLightSkinTone
