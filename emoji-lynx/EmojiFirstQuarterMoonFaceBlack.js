...
/** Mithril-lynx component for the OpenMoji "first quarter moon face" (black) [1F31B]. */
const EmojiFirstQuarterMoonFaceBlack = lynxIcon(`
  <g id="line">
...
`, _attrs, 72)
export default EmojiFirstQuarterMoonFaceBlack
