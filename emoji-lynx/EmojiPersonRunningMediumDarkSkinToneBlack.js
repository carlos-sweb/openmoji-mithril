...
/** Mithril-lynx component for the OpenMoji "person running: medium-dark skin tone" (black) [1F3C3-1F3FE]. */
const EmojiPersonRunningMediumDarkSkinToneBlack = lynxIcon(`
  <g id="line">
...
`, _attrs, 72)
export default EmojiPersonRunningMediumDarkSkinToneBlack
