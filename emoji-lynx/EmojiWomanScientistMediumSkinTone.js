...
/** Mithril-lynx component for the OpenMoji "woman scientist: medium skin tone" (color) [1F469-1F3FD-200D-1F52C]. */
const EmojiWomanScientistMediumSkinTone = {
  view: (vnode) => m(
    'svg',
...
export default EmojiWomanScientistMediumSkinTone
