...
/** Mithril-lynx component for the OpenMoji "person in bed: light skin tone" (color) [1F6CC-1F3FB]. */
const EmojiPersonInBedLightSkinTone = lynxIcon(`
  <g id="color">
...
`, _attrs, 72)
export default EmojiPersonInBedLightSkinTone
