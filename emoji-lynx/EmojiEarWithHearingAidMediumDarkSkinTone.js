...
/** Mithril-lynx component for the OpenMoji "ear with hearing aid: medium-dark skin tone" (color) [1F9BB-1F3FE]. */
const EmojiEarWithHearingAidMediumDarkSkinTone = lynxIcon(`
  <g id="color">
...
`, _attrs, 72)
export default EmojiEarWithHearingAidMediumDarkSkinTone
