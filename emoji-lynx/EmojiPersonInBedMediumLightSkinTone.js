...
/** Mithril-lynx component for the OpenMoji "person in bed: medium-light skin tone" (color) [1F6CC-1F3FC]. */
const EmojiPersonInBedMediumLightSkinTone = lynxIcon(`
  <g id="color">
...
`, _attrs, 72)
export default EmojiPersonInBedMediumLightSkinTone
