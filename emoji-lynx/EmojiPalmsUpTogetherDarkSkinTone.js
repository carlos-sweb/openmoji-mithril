...
/** Mithril-lynx component for the OpenMoji "palms up together: dark skin tone" (color) [1F932-1F3FF]. */
const EmojiPalmsUpTogetherDarkSkinTone = lynxIcon(`
  <g id="color">
...
`, _attrs, 72)
export default EmojiPalmsUpTogetherDarkSkinTone
