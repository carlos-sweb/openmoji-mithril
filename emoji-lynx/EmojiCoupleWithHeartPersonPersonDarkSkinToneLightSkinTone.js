...
/** Mithril-lynx component for the OpenMoji "couple with heart: person, person, dark skin tone, light skin tone" (color) [1F9D1-1F3FF-200D-2764-FE0F-200D-1F9D1-1F3FB]. */
const EmojiCoupleWithHeartPersonPersonDarkSkinToneLightSkinTone = lynxIcon(`
  <g id="color">
...
`, _attrs, 72)
export default EmojiCoupleWithHeartPersonPersonDarkSkinToneLightSkinTone
