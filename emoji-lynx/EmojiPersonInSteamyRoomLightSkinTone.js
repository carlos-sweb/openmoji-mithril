...
/** Mithril-lynx component for the OpenMoji "person in steamy room: light skin tone" (color) [1F9D6-1F3FB]. */
const EmojiPersonInSteamyRoomLightSkinTone = lynxIcon(`
  <g id="color">
...
`, _attrs, 72)
export default EmojiPersonInSteamyRoomLightSkinTone
