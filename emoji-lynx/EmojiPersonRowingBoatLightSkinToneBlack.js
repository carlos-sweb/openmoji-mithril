...
/** Mithril-lynx component for the OpenMoji "person rowing boat: light skin tone" (black) [1F6A3-1F3FB]. */
const EmojiPersonRowingBoatLightSkinToneBlack = lynxIcon(`
  <g id="line">
...
`, _attrs, 72)
export default EmojiPersonRowingBoatLightSkinToneBlack
