...
/** Mithril-lynx component for the OpenMoji "person bowing: dark skin tone" (black) [1F647-1F3FF]. */
const EmojiPersonBowingDarkSkinToneBlack = lynxIcon(`
  <g id="line">
...
`, _attrs, 72)
export default EmojiPersonBowingDarkSkinToneBlack
