...
/** Mithril-lynx component for the OpenMoji "person: dark skin tone, blond hair" (color) [1F471-1F3FF]. */
const EmojiPersonDarkSkinToneBlondHair = lynxIcon(`
  <g id="color">
...
`, _attrs, 72)
export default EmojiPersonDarkSkinToneBlondHair
