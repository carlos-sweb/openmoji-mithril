...
/** Mithril-lynx component for the OpenMoji "woman construction worker" (color) [1F477-200D-2640-FE0F]. */
const EmojiWomanConstructionWorker = {
  view: (vnode) => m(
    'svg',
...
export default EmojiWomanConstructionWorker
