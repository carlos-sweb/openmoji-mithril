...
/** Mithril-lynx component for the OpenMoji "superhero: medium skin tone" (color) [1F9B8-1F3FD]. */
const EmojiSuperheroMediumSkinTone = lynxIcon(`
  <g id="hair">
...
`, _attrs, 72)
export default EmojiSuperheroMediumSkinTone
