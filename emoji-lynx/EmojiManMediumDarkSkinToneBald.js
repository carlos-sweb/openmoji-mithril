...
/** Mithril-lynx component for the OpenMoji "man: medium-dark skin tone, bald" (color) [1F468-1F3FE-200D-1F9B2]. */
const EmojiManMediumDarkSkinToneBald = lynxIcon(`
  <g id="skin">
...
`, _attrs, 72)
export default EmojiManMediumDarkSkinToneBald
