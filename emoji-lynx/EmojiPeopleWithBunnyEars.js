...
/** Mithril-lynx component for the OpenMoji "people with bunny ears" (color) [1F46F]. */
const EmojiPeopleWithBunnyEars = lynxIcon(`
  <g id="color">
...
`, _attrs, 72)
export default EmojiPeopleWithBunnyEars
