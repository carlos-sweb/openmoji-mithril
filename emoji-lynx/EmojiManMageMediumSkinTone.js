...
/** Mithril-lynx component for the OpenMoji "man mage: medium skin tone" (color) [1F9D9-1F3FD-200D-2642-FE0F]. */
const EmojiManMageMediumSkinTone = lynxIcon(`
  <g id="color">
...
`, _attrs, 72)
export default EmojiManMageMediumSkinTone
