...
/** Mithril-lynx component for the OpenMoji "person with crown: medium-light skin tone" (color) [1FAC5-1F3FC]. */
const EmojiPersonWithCrownMediumLightSkinTone = lynxIcon(`
  <g id="color">
...
`, _attrs, 72)
export default EmojiPersonWithCrownMediumLightSkinTone
