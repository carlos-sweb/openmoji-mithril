...
/** Mithril-lynx component for the OpenMoji "right-facing fist: light skin tone" (color) [1F91C-1F3FB]. */
const EmojiRightFacingFistLightSkinTone = lynxIcon(`
  <g id="color"/>
  <g id="hair"/>
  <g id="skin">
...
`, _attrs, 72)
export default EmojiRightFacingFistLightSkinTone
