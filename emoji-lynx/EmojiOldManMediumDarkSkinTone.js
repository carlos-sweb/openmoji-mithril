...
/** Mithril-lynx component for the OpenMoji "old man: medium-dark skin tone" (color) [1F474-1F3FE]. */
const EmojiOldManMediumDarkSkinTone = lynxIcon(`
  <g id="color">
...
`, _attrs, 72)
export default EmojiOldManMediumDarkSkinTone
