...
/** Mithril-lynx component for the OpenMoji "ear with hearing aid: dark skin tone" (color) [1F9BB-1F3FF]. */
const EmojiEarWithHearingAidDarkSkinTone = lynxIcon(`
  <g id="color">
...
`, _attrs, 72)
export default EmojiEarWithHearingAidDarkSkinTone
