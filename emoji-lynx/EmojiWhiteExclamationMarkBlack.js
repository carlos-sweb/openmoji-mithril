...
/** Mithril-lynx component for the OpenMoji "white exclamation mark" (black) [2755]. */
const EmojiWhiteExclamationMarkBlack = lynxIcon(`
  <g id="line">
...
`, _attrs, 72)
export default EmojiWhiteExclamationMarkBlack
