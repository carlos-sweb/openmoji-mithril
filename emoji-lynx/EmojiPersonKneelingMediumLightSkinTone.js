...
/** Mithril-lynx component for the OpenMoji "person kneeling: medium-light skin tone" (color) [1F9CE-1F3FC]. */
const EmojiPersonKneelingMediumLightSkinTone = lynxIcon(`
  <g id="color"/>
  <g id="skin">
...
`, _attrs, 72)
export default EmojiPersonKneelingMediumLightSkinTone
