...
/** Mithril-lynx component for the OpenMoji "mage: light skin tone" (black) [1F9D9-1F3FB]. */
const EmojiMageLightSkinToneBlack = lynxIcon(`
  <g id="line">
...
`, _attrs, 72)
export default EmojiMageLightSkinToneBlack
