...
/** Mithril-lynx component for the OpenMoji "person in tuxedo: dark skin tone" (black) [1F935-1F3FF]. */
const EmojiPersonInTuxedoDarkSkinToneBlack = lynxIcon(`
  <g id="line">
...
`, _attrs, 72)
export default EmojiPersonInTuxedoDarkSkinToneBlack
