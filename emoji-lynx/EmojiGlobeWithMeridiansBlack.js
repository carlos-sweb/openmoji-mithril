...
/** Mithril-lynx component for the OpenMoji "globe with meridians" (black) [1F310]. */
const EmojiGlobeWithMeridiansBlack = lynxIcon(`
  <g id="line">
...
`, _attrs, 72)
export default EmojiGlobeWithMeridiansBlack
