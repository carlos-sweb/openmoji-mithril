...
/** Mithril-lynx component for the OpenMoji "woman with headscarf: medium-light skin tone" (color) [1F9D5-1F3FC]. */
const EmojiWomanWithHeadscarfMediumLightSkinTone = lynxIcon(`
  <g id="color">
...
`, _attrs, 72)
export default EmojiWomanWithHeadscarfMediumLightSkinTone
