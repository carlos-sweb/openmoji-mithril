...
/** Mithril-lynx component for the OpenMoji "rounded symbol for cai" (black) [1F265]. */
const EmojiRoundedSymbolForCaiBlack = lynxIcon(`
  <g id="line">
...
`, _attrs, 72)
export default EmojiRoundedSymbolForCaiBlack
