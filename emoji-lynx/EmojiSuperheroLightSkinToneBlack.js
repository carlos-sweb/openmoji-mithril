...
/** Mithril-lynx component for the OpenMoji "superhero: light skin tone" (black) [1F9B8-1F3FB]. */
const EmojiSuperheroLightSkinToneBlack = lynxIcon(`
  <g id="line">
...
`, _attrs, 72)
export default EmojiSuperheroLightSkinToneBlack
