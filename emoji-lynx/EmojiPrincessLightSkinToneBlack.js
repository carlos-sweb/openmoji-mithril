...
/** Mithril-lynx component for the OpenMoji "princess: light skin tone" (black) [1F478-1F3FB]. */
const EmojiPrincessLightSkinToneBlack = lynxIcon(`
  <g id="line">
...
`, _attrs, 72)
export default EmojiPrincessLightSkinToneBlack
