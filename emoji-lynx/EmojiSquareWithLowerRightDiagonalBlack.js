...
/** Mithril-lynx component for the OpenMoji "square with lower right diagonal black" (color) [25EA]. */
const EmojiSquareWithLowerRightDiagonalBlack = lynxIcon(`
...
`, _attrs, 72)
export default EmojiSquareWithLowerRightDiagonalBlack
