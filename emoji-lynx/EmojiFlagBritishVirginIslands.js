...
/** Mithril-lynx component for the OpenMoji "flag: British Virgin Islands" (color) [1F1FB-1F1EC]. */
const EmojiFlagBritishVirginIslands = lynxIcon(`
  <g id="color">
...
`, _attrs, 72)
export default EmojiFlagBritishVirginIslands
