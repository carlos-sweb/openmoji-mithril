...
/** Mithril-lynx component for the OpenMoji "person playing handball: medium-light skin tone" (color) [1F93E-1F3FC]. */
const EmojiPersonPlayingHandballMediumLightSkinTone = lynxIcon(`
  <g id="color">
...
`, _attrs, 72)
export default EmojiPersonPlayingHandballMediumLightSkinTone
