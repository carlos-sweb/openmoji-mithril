...
/** Mithril-lynx component for the OpenMoji "busts in silhouette" (black) [1F465]. */
const EmojiBustsInSilhouetteBlack = lynxIcon(`
  <g id="line">
...
`, _attrs, 72)
export default EmojiBustsInSilhouetteBlack
