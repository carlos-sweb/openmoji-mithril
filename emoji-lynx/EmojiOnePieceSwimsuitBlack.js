...
/** Mithril-lynx component for the OpenMoji "one-piece swimsuit" (black) [1FA71]. */
const EmojiOnePieceSwimsuitBlack = lynxIcon(`
  <g id="line">
...
`, _attrs, 72)
export default EmojiOnePieceSwimsuitBlack
