...
/** Mithril-lynx component for the OpenMoji "person with veil: dark skin tone" (black) [1F470-1F3FF]. */
const EmojiPersonWithVeilDarkSkinToneBlack = lynxIcon(`
  <g id="line">
...
`, _attrs, 72)
export default EmojiPersonWithVeilDarkSkinToneBlack
