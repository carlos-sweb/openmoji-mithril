...
/** Mithril-lynx component for the OpenMoji "person with skullcap: medium skin tone" (color) [1F472-1F3FD]. */
const EmojiPersonWithSkullcapMediumSkinTone = lynxIcon(`
  <g id="color">
...
`, _attrs, 72)
export default EmojiPersonWithSkullcapMediumSkinTone
