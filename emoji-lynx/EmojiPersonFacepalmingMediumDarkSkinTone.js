...
/** Mithril-lynx component for the OpenMoji "person facepalming: medium-dark skin tone" (color) [1F926-1F3FE]. */
const EmojiPersonFacepalmingMediumDarkSkinTone = lynxIcon(`
  <g id="color">
...
`, _attrs, 72)
export default EmojiPersonFacepalmingMediumDarkSkinTone
