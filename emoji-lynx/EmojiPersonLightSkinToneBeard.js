...
/** Mithril-lynx component for the OpenMoji "person: light skin tone, beard" (color) [1F9D4-1F3FB]. */
const EmojiPersonLightSkinToneBeard = lynxIcon(`
  <g id="color">
...
`, _attrs, 72)
export default EmojiPersonLightSkinToneBeard
