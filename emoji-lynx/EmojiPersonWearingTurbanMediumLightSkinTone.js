...
/** Mithril-lynx component for the OpenMoji "person wearing turban: medium-light skin tone" (color) [1F473-1F3FC]. */
const EmojiPersonWearingTurbanMediumLightSkinTone = lynxIcon(`
  <g id="color">
...
`, _attrs, 72)
export default EmojiPersonWearingTurbanMediumLightSkinTone
