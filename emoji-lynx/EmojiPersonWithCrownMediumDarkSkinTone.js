...
/** Mithril-lynx component for the OpenMoji "person with crown: medium-dark skin tone" (color) [1FAC5-1F3FE]. */
const EmojiPersonWithCrownMediumDarkSkinTone = lynxIcon(`
  <g id="color">
...
`, _attrs, 72)
export default EmojiPersonWithCrownMediumDarkSkinTone
