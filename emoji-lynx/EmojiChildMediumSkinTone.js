...
/** Mithril-lynx component for the OpenMoji "child: medium skin tone" (color) [1F9D2-1F3FD]. */
const EmojiChildMediumSkinTone = lynxIcon(`
  <g id="color">
...
`, _attrs, 72)
export default EmojiChildMediumSkinTone
