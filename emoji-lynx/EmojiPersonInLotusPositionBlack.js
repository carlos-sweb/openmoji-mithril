...
/** Mithril-lynx component for the OpenMoji "person in lotus position" (black) [1F9D8]. */
const EmojiPersonInLotusPositionBlack = lynxIcon(`
  <g id="line">
...
`, _attrs, 72)
export default EmojiPersonInLotusPositionBlack
