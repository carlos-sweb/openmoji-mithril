...
/** Mithril-lynx component for the OpenMoji "person standing: dark skin tone" (color) [1F9CD-1F3FF]. */
const EmojiPersonStandingDarkSkinTone = lynxIcon(`
  <g id="color"/>
  <g id="skin">
    <g id="color-2">
...
`, _attrs, 72)
export default EmojiPersonStandingDarkSkinTone
