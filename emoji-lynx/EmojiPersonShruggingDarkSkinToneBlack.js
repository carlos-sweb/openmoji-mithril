...
/** Mithril-lynx component for the OpenMoji "person shrugging: dark skin tone" (black) [1F937-1F3FF]. */
const EmojiPersonShruggingDarkSkinToneBlack = lynxIcon(`
  <g id="line">
...
`, _attrs, 72)
export default EmojiPersonShruggingDarkSkinToneBlack
