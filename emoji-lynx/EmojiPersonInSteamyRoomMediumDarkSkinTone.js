...
/** Mithril-lynx component for the OpenMoji "person in steamy room: medium-dark skin tone" (color) [1F9D6-1F3FE]. */
const EmojiPersonInSteamyRoomMediumDarkSkinTone = lynxIcon(`
  <g id="color">
...
`, _attrs, 72)
export default EmojiPersonInSteamyRoomMediumDarkSkinTone
