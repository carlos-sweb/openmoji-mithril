...
/** Mithril-lynx component for the OpenMoji "pinching hand: medium skin tone" (color) [1F90F-1F3FD]. */
const EmojiPinchingHandMediumSkinTone = lynxIcon(`
  <g id="color"/>
  <g id="skin">
    <g id="Pinching_Hand">
...
`, _attrs, 72)
export default EmojiPinchingHandMediumSkinTone
