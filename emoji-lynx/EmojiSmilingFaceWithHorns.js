...
/** Mithril-lynx component for the OpenMoji "smiling face with horns" (color) [1F608]. */
const EmojiSmilingFaceWithHorns = lynxIcon(`
  <g id="color">
...
`, _attrs, 72)
export default EmojiSmilingFaceWithHorns
