...
/** Mithril-lynx component for the OpenMoji "child: dark skin tone" (color) [1F9D2-1F3FF]. */
const EmojiChildDarkSkinTone = lynxIcon(`
  <g id="color">
...
`, _attrs, 72)
export default EmojiChildDarkSkinTone
