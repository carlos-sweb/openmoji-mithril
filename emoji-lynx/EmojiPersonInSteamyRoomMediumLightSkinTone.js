...
/** Mithril-lynx component for the OpenMoji "person in steamy room: medium-light skin tone" (color) [1F9D6-1F3FC]. */
const EmojiPersonInSteamyRoomMediumLightSkinTone = lynxIcon(`
  <g id="color">
...
`, _attrs, 72)
export default EmojiPersonInSteamyRoomMediumLightSkinTone
