...
/** Mithril-lynx component for the OpenMoji "child: medium-light skin tone" (black) [1F9D2-1F3FC]. */
const EmojiChildMediumLightSkinToneBlack = lynxIcon(`
  <g id="line">
...
`, _attrs, 72)
export default EmojiChildMediumLightSkinToneBlack
