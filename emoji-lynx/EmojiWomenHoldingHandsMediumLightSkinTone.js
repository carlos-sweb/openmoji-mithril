...
/** Mithril-lynx component for the OpenMoji "women holding hands: medium-light skin tone" (color) [1F46D-1F3FC]. */
const EmojiWomenHoldingHandsMediumLightSkinTone = lynxIcon(`
  <g id="color"/>
  <g id="skin">
    <g id="skin-b">
...
`, _attrs, 72)
export default EmojiWomenHoldingHandsMediumLightSkinTone
