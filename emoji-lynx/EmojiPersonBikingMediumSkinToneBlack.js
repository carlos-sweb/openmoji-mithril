...
/** Mithril-lynx component for the OpenMoji "person biking: medium skin tone" (black) [1F6B4-1F3FD]. */
const EmojiPersonBikingMediumSkinToneBlack = lynxIcon(`
  <g id="line">
...
`, _attrs, 72)
export default EmojiPersonBikingMediumSkinToneBlack
