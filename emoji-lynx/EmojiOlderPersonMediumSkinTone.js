...
/** Mithril-lynx component for the OpenMoji "older person: medium skin tone" (color) [1F9D3-1F3FD]. */
const EmojiOlderPersonMediumSkinTone = lynxIcon(`
  <g id="color">
...
`, _attrs, 72)
export default EmojiOlderPersonMediumSkinTone
