...
/** Mithril-lynx component for the OpenMoji "smiling face with open hands" (color) [1F917]. */
const EmojiSmilingFaceWithOpenHands = lynxIcon(`
  <g id="color">
...
`, _attrs, 72)
export default EmojiSmilingFaceWithOpenHands
