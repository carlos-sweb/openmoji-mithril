...
/** Mithril-lynx component for the OpenMoji "circled c with overlaid backslash" (black) [1F16E]. */
const EmojiCircledCWithOverlaidBackslashBlack = lynxIcon(`
  <g id="line">
...
`, _attrs, 72)
export default EmojiCircledCWithOverlaidBackslashBlack
