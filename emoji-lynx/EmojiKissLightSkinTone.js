...
/** Mithril-lynx component for the OpenMoji "kiss: light skin tone" (color) [1F48F-1F3FB]. */
const EmojiKissLightSkinTone = lynxIcon(`
  <g id="color">
...
`, _attrs, 72)
export default EmojiKissLightSkinTone
