...
/** Mithril-lynx component for the OpenMoji "leftwards hand: medium skin tone" (black) [1FAF2-1F3FD]. */
const EmojiLeftwardsHandMediumSkinToneBlack = {
  view: (vnode) => m(
    'svg',
...
export default EmojiLeftwardsHandMediumSkinToneBlack
