...
/** Mithril-lynx component for the OpenMoji "person running: medium skin tone" (color) [1F3C3-1F3FD]. */
const EmojiPersonRunningMediumSkinTone = lynxIcon(`
  <g id="color"/>
  <g id="skin">
...
`, _attrs, 72)
export default EmojiPersonRunningMediumSkinTone
