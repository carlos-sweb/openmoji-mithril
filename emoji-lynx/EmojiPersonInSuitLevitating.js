...
/** Mithril-lynx component for the OpenMoji "person in suit levitating" (color) [1F574]. */
const EmojiPersonInSuitLevitating = lynxIcon(`
  <g id="color"/>
  <g id="skin">
...
`, _attrs, 72)
export default EmojiPersonInSuitLevitating
