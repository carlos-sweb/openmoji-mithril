...
/** Mithril-lynx component for the OpenMoji "part alternation mark" (color) [303D]. */
const EmojiPartAlternationMark = lynxIcon(`
  <g id="color">
...
`, _attrs, 72)
export default EmojiPartAlternationMark
