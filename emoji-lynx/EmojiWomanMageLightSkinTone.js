...
/** Mithril-lynx component for the OpenMoji "woman mage: light skin tone" (color) [1F9D9-1F3FB-200D-2640-FE0F]. */
const EmojiWomanMageLightSkinTone = lynxIcon(`
  <g id="hair">
...
`, _attrs, 72)
export default EmojiWomanMageLightSkinTone
