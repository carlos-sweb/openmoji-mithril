...
/** Mithril-lynx component for the OpenMoji "person frowning: light skin tone" (color) [1F64D-1F3FB]. */
const EmojiPersonFrowningLightSkinTone = lynxIcon(`
  <g id="color">
...
`, _attrs, 72)
export default EmojiPersonFrowningLightSkinTone
