...
/** Mithril-lynx component for the OpenMoji "person with crown: medium skin tone" (color) [1FAC5-1F3FD]. */
const EmojiPersonWithCrownMediumSkinTone = lynxIcon(`
  <g id="color">
...
`, _attrs, 72)
export default EmojiPersonWithCrownMediumSkinTone
