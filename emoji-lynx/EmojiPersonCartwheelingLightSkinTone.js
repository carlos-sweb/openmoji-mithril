...
/** Mithril-lynx component for the OpenMoji "person cartwheeling: light skin tone" (color) [1F938-1F3FB]. */
const EmojiPersonCartwheelingLightSkinTone = {
  view: (vnode) => m(
    'svg',
...
export default EmojiPersonCartwheelingLightSkinTone
