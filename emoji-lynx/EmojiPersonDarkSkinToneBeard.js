...
/** Mithril-lynx component for the OpenMoji "person: dark skin tone, beard" (color) [1F9D4-1F3FF]. */
const EmojiPersonDarkSkinToneBeard = lynxIcon(`
  <g id="color">
...
`, _attrs, 72)
export default EmojiPersonDarkSkinToneBeard
