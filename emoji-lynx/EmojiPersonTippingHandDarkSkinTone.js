...
/** Mithril-lynx component for the OpenMoji "person tipping hand: dark skin tone" (color) [1F481-1F3FF]. */
const EmojiPersonTippingHandDarkSkinTone = lynxIcon(`
  <g id="color">
...
`, _attrs, 72)
export default EmojiPersonTippingHandDarkSkinTone
