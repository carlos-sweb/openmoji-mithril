...
/** Mithril-lynx component for the OpenMoji "combining enclosing keycap" (color) [20E3]. */
const EmojiCombiningEnclosingKeycap = {
  view: (vnode) => m(
    'svg',
...
export default EmojiCombiningEnclosingKeycap
