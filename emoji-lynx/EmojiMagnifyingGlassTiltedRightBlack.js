...
/** Mithril-lynx component for the OpenMoji "magnifying glass tilted right" (black) [1F50E]. */
const EmojiMagnifyingGlassTiltedRightBlack = lynxIcon(`
  <g id="line">
...
`, _attrs, 72)
export default EmojiMagnifyingGlassTiltedRightBlack
