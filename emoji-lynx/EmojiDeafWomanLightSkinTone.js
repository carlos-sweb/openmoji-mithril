...
/** Mithril-lynx component for the OpenMoji "deaf woman: light skin tone" (color) [1F9CF-1F3FB-200D-2640-FE0F]. */
const EmojiDeafWomanLightSkinTone = {
  view: (vnode) => m(
    'svg',
...
export default EmojiDeafWomanLightSkinTone
