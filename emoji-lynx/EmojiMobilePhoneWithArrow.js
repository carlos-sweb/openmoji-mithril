...
/** Mithril-lynx component for the OpenMoji "mobile phone with arrow" (color) [1F4F2]. */
const EmojiMobilePhoneWithArrow = lynxIcon(`
  <g id="color">
...
`, _attrs, 72)
export default EmojiMobilePhoneWithArrow
