...
/** Mithril-lynx component for the OpenMoji "women wrestling: light skin tone" (color) [1F93C-1F3FB-200D-2640-FE0F]. */
const EmojiWomenWrestlingLightSkinTone = lynxIcon(`
  <g id="color"/>
  <g id="skin">
    <g id="skin-a">
...
`, _attrs, 72)
export default EmojiWomenWrestlingLightSkinTone
