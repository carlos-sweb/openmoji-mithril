...
/** Mithril-lynx component for the OpenMoji "men holding hands: dark skin tone" (color) [1F46C-1F3FF]. */
const EmojiMenHoldingHandsDarkSkinTone = lynxIcon(`
  <g id="color"/>
  <g id="skin">
    <g id="skin-b">
...
`, _attrs, 72)
export default EmojiMenHoldingHandsDarkSkinTone
