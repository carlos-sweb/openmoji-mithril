...
/** Mithril-lynx component for the OpenMoji "smiling face with horns" (black) [1F608]. */
const EmojiSmilingFaceWithHornsBlack = lynxIcon(`
  <g id="line">
...
`, _attrs, 72)
export default EmojiSmilingFaceWithHornsBlack
