...
/** Mithril-lynx component for the OpenMoji "anxious face with sweat" (color) [1F630]. */
const EmojiAnxiousFaceWithSweat = lynxIcon(`
  <g id="color">
...
`, _attrs, 72)
export default EmojiAnxiousFaceWithSweat
