...
/** Mithril-lynx component for the OpenMoji "person lifting weights: medium skin tone" (color) [1F3CB-1F3FD]. */
const EmojiPersonLiftingWeightsMediumSkinTone = lynxIcon(`
  <g id="color">
...
`, _attrs, 72)
export default EmojiPersonLiftingWeightsMediumSkinTone
