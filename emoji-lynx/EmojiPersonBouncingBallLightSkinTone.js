...
/** Mithril-lynx component for the OpenMoji "person bouncing ball: light skin tone" (color) [26F9-1F3FB]. */
const EmojiPersonBouncingBallLightSkinTone = lynxIcon(`
  <g id="color">
...
`, _attrs, 72)
export default EmojiPersonBouncingBallLightSkinTone
