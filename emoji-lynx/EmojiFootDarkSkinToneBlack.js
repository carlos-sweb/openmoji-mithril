...
/** Mithril-lynx component for the OpenMoji "foot: dark skin tone" (black) [1F9B6-1F3FF]. */
const EmojiFootDarkSkinToneBlack = lynxIcon(`
  <g id="line">
...
`, _attrs, 72)
export default EmojiFootDarkSkinToneBlack
