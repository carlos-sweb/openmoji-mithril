...
/** Mithril-lynx component for the OpenMoji "pregnant man: light skin tone" (color) [1FAC3-1F3FB]. */
const EmojiPregnantManLightSkinTone = {
  view: (vnode) => m(
    'svg',
...
export default EmojiPregnantManLightSkinTone
