...
/** Mithril-lynx component for the OpenMoji "elf: medium-dark skin tone" (color) [1F9DD-1F3FE]. */
const EmojiElfMediumDarkSkinTone = lynxIcon(`
  <g id="color">
...
`, _attrs, 72)
export default EmojiElfMediumDarkSkinTone
