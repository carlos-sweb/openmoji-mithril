...
/** Mithril-lynx component for the OpenMoji "selfie: light skin tone" (black) [1F933-1F3FB]. */
const EmojiSelfieLightSkinToneBlack = lynxIcon(`
  <g id="line">
...
`, _attrs, 72)
export default EmojiSelfieLightSkinToneBlack
