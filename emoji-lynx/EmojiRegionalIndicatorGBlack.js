...
/** Mithril-lynx component for the OpenMoji "regional indicator G" (black) [1F1EC]. */
const EmojiRegionalIndicatorGBlack = lynxIcon(`
  <g id="line">
    <g id="line-2">
...
`, _attrs, 72)
export default EmojiRegionalIndicatorGBlack
