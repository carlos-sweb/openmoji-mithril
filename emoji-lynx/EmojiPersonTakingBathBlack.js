...
/** Mithril-lynx component for the OpenMoji "person taking bath" (black) [1F6C0]. */
const EmojiPersonTakingBathBlack = lynxIcon(`
  <g id="line">
    <g>
...
`, _attrs, 72)
export default EmojiPersonTakingBathBlack
