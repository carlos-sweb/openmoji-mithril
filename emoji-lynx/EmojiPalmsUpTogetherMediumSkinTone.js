...
/** Mithril-lynx component for the OpenMoji "palms up together: medium skin tone" (color) [1F932-1F3FD]. */
const EmojiPalmsUpTogetherMediumSkinTone = lynxIcon(`
  <g id="color">
...
`, _attrs, 72)
export default EmojiPalmsUpTogetherMediumSkinTone
