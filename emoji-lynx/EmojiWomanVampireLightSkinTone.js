...
/** Mithril-lynx component for the OpenMoji "woman vampire: light skin tone" (color) [1F9DB-1F3FB-200D-2640-FE0F]. */
const EmojiWomanVampireLightSkinTone = lynxIcon(`
  <g id="hair">
...
`, _attrs, 72)
export default EmojiWomanVampireLightSkinTone
