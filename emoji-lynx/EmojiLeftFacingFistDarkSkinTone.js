...
/** Mithril-lynx component for the OpenMoji "left-facing fist: dark skin tone" (color) [1F91B-1F3FF]. */
const EmojiLeftFacingFistDarkSkinTone = lynxIcon(`
  <g id="color"/>
  <g id="hair"/>
...
`, _attrs, 72)
export default EmojiLeftFacingFistDarkSkinTone
