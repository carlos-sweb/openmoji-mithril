...
/** Mithril-lynx component for the OpenMoji "snowboarder: light skin tone" (black) [1F3C2-1F3FB]. */
const EmojiSnowboarderLightSkinToneBlack = lynxIcon(`
  <g id="line">
...
`, _attrs, 72)
export default EmojiSnowboarderLightSkinToneBlack
