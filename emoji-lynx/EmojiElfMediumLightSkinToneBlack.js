...
/** Mithril-lynx component for the OpenMoji "elf: medium-light skin tone" (black) [1F9DD-1F3FC]. */
const EmojiElfMediumLightSkinToneBlack = lynxIcon(`
  <g id="line">
...
`, _attrs, 72)
export default EmojiElfMediumLightSkinToneBlack
