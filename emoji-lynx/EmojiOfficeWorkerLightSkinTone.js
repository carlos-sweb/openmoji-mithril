...
/** Mithril-lynx component for the OpenMoji "office worker: light skin tone" (color) [1F9D1-1F3FB-200D-1F4BC]. */
const EmojiOfficeWorkerLightSkinTone = lynxIcon(`
  <g id="color">
...
`, _attrs, 72)
export default EmojiOfficeWorkerLightSkinTone
