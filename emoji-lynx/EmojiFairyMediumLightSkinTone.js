...
/** Mithril-lynx component for the OpenMoji "fairy: medium-light skin tone" (color) [1F9DA-1F3FC]. */
const EmojiFairyMediumLightSkinTone = lynxIcon(`
  <g id="hair">
...
`, _attrs, 72)
export default EmojiFairyMediumLightSkinTone
