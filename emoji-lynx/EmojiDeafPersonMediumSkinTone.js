...
/** Mithril-lynx component for the OpenMoji "deaf person: medium skin tone" (color) [1F9CF-1F3FD]. */
const EmojiDeafPersonMediumSkinTone = lynxIcon(`
  <g id="color">
...
`, _attrs, 72)
export default EmojiDeafPersonMediumSkinTone
