...
/** Mithril-lynx component for the OpenMoji "person: medium-light skin tone" (black) [1F9D1-1F3FC]. */
const EmojiPersonMediumLightSkinToneBlack = lynxIcon(`
  <g id="line">
...
`, _attrs, 72)
export default EmojiPersonMediumLightSkinToneBlack
