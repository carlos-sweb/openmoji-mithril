...
/** Mithril-lynx component for the OpenMoji "grinning face with big eyes" (black) [1F603]. */
const EmojiGrinningFaceWithBigEyesBlack = lynxIcon(`
  <g id="line">
...
`, _attrs, 72)
export default EmojiGrinningFaceWithBigEyesBlack
