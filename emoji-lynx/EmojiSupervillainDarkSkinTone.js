...
/** Mithril-lynx component for the OpenMoji "supervillain: dark skin tone" (color) [1F9B9-1F3FF]. */
const EmojiSupervillainDarkSkinTone = lynxIcon(`
  <g id="hair">
...
`, _attrs, 72)
export default EmojiSupervillainDarkSkinTone
