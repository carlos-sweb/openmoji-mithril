...
/** Mithril-lynx component for the OpenMoji "woman with headscarf" (black) [1F9D5]. */
const EmojiWomanWithHeadscarfBlack = lynxIcon(`
  <g id="line">
...
`, _attrs, 72)
export default EmojiWomanWithHeadscarfBlack
