...
/** Mithril-lynx component for the OpenMoji "flag: Heard & McDonald Islands" (color) [1F1ED-1F1F2]. */
const EmojiFlagHeardMcDonaldIslands = lynxIcon(`
  <g id="color">
...
`, _attrs, 72)
export default EmojiFlagHeardMcDonaldIslands
