...
/** Mithril-lynx component for the OpenMoji "raising hands: light skin tone" (color) [1F64C-1F3FB]. */
const EmojiRaisingHandsLightSkinTone = {
  view: (vnode) => m(
    'svg',
...
export default EmojiRaisingHandsLightSkinTone
