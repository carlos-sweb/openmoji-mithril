...
/** Mithril-lynx component for the OpenMoji "square with upper left diagonal black" (color) [25E9]. */
const EmojiSquareWithUpperLeftDiagonalBlack = lynxIcon(`
  <g id="color">
    <path fill="#fff" d="m60,12v48H12L60,12Z"/>
    <path fill="#3f3f3f" d="m12.9952,12.9336l44.8813-.0801L14.6953,59.0491l-1.9309-.0612.2309-46.0543Z"/>
  </g>
  <g id="line">
...
`, _attrs, 72)
export default EmojiSquareWithUpperLeftDiagonalBlack
