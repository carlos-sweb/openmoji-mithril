...
/** Mithril-lynx component for the OpenMoji "flag: Papua New Guinea" (color) [1F1F5-1F1EC]. */
const EmojiFlagPapuaNewGuinea = lynxIcon(`
  <g id="color">
...
`, _attrs, 72)
export default EmojiFlagPapuaNewGuinea
