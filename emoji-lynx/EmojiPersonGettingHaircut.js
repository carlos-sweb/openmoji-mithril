...
/** Mithril-lynx component for the OpenMoji "person getting haircut" (color) [1F487]. */
const EmojiPersonGettingHaircut = lynxIcon(`
  <g id="color">
...
`, _attrs, 72)
export default EmojiPersonGettingHaircut
