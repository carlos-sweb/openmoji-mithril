...
/** Mithril-lynx component for the OpenMoji "backhand index pointing down: medium skin tone" (color) [1F447-1F3FD]. */
const EmojiBackhandIndexPointingDownMediumSkinTone = lynxIcon(`
  <g id="color"/>
  <g id="hair"/>
  <g id="skin">
...
`, _attrs, 72)
export default EmojiBackhandIndexPointingDownMediumSkinTone
