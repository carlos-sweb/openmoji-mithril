...
/** Mithril-lynx component for the OpenMoji "raised hand: medium-light skin tone" (black) [270B-1F3FC]. */
const EmojiRaisedHandMediumLightSkinToneBlack = {
  view: (vnode) => m(
    'svg',
...
export default EmojiRaisedHandMediumLightSkinToneBlack
