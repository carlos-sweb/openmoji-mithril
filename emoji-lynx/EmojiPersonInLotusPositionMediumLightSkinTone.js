...
/** Mithril-lynx component for the OpenMoji "person in lotus position: medium-light skin tone" (color) [1F9D8-1F3FC]. */
const EmojiPersonInLotusPositionMediumLightSkinTone = lynxIcon(`
  <g id="color"/>
  <g id="hair"/>
  <g id="skin-shadow"/>
  <g id="skin">
...
`, _attrs, 72)
export default EmojiPersonInLotusPositionMediumLightSkinTone
