...
/** Mithril-lynx component for the OpenMoji "person taking bath: light skin tone" (color) [1F6C0-1F3FB]. */
const EmojiPersonTakingBathLightSkinTone = lynxIcon(`
  <g id="color">
...
`, _attrs, 72)
export default EmojiPersonTakingBathLightSkinTone
