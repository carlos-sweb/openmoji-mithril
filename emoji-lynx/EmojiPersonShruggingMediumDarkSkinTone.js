...
/** Mithril-lynx component for the OpenMoji "person shrugging: medium-dark skin tone" (color) [1F937-1F3FE]. */
const EmojiPersonShruggingMediumDarkSkinTone = lynxIcon(`
  <g id="color">
...
`, _attrs, 72)
export default EmojiPersonShruggingMediumDarkSkinTone
