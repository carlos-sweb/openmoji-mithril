...
/** Mithril-lynx component for the OpenMoji "supervillain: light skin tone" (black) [1F9B9-1F3FB]. */
const EmojiSupervillainLightSkinToneBlack = lynxIcon(`
  <g id="line">
...
`, _attrs, 72)
export default EmojiSupervillainLightSkinToneBlack
