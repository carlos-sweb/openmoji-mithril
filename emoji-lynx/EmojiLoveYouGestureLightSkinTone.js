...
/** Mithril-lynx component for the OpenMoji "love-you gesture: light skin tone" (color) [1F91F-1F3FB]. */
const EmojiLoveYouGestureLightSkinTone = {
  view: (vnode) => m(
    'svg',
...
export default EmojiLoveYouGestureLightSkinTone
