...
/** Mithril-lynx component for the OpenMoji "middle finger: dark skin tone" (color) [1F595-1F3FF]. */
const EmojiMiddleFingerDarkSkinTone = {
  view: (vnode) => m(
    'svg',
...
export default EmojiMiddleFingerDarkSkinTone
