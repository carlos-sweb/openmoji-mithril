...
/** Mithril-lynx component for the OpenMoji "supervillain: medium-light skin tone" (color) [1F9B9-1F3FC]. */
const EmojiSupervillainMediumLightSkinTone = lynxIcon(`
  <g id="hair">
...
`, _attrs, 72)
export default EmojiSupervillainMediumLightSkinTone
