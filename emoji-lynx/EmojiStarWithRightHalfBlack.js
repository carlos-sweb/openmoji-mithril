...
/** Mithril-lynx component for the OpenMoji "star with right half black" (color) [2BEB]. */
const EmojiStarWithRightHalfBlack = lynxIcon(`
...
`, _attrs, 72)
export default EmojiStarWithRightHalfBlack
