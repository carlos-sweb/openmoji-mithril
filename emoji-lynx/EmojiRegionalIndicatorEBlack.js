...
/** Mithril-lynx component for the OpenMoji "regional indicator E" (black) [1F1EA]. */
const EmojiRegionalIndicatorEBlack = lynxIcon(`
  <g id="line">
    <g id="line-2">
...
`, _attrs, 72)
export default EmojiRegionalIndicatorEBlack
