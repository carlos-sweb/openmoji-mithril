...
/** Mithril-lynx component for the OpenMoji "snowboarder: medium-dark skin tone" (color) [1F3C2-1F3FE]. */
const EmojiSnowboarderMediumDarkSkinTone = {
  view: (vnode) => m(
    'svg',
...
export default EmojiSnowboarderMediumDarkSkinTone
