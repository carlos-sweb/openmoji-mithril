...
/** Mithril-lynx component for the OpenMoji "grinning cat with smiling eyes" (color) [1F638]. */
const EmojiGrinningCatWithSmilingEyes = lynxIcon(`
  <g id="color">
...
`, _attrs, 72)
export default EmojiGrinningCatWithSmilingEyes
