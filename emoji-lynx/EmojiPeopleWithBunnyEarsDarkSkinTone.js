...
/** Mithril-lynx component for the OpenMoji "people with bunny ears: dark skin tone" (color) [1F46F-1F3FF]. */
const EmojiPeopleWithBunnyEarsDarkSkinTone = lynxIcon(`
  <g id="color">
  ...
  <g id="skin">
    <circle cx="25.6962" cy="14.1787" r="3" fill="#6a462f"/>
    <path fill="#6a462f" d="M29.7274,27.0849l-.6185,6,1.6185,5,2,12,2.7,11h-3.3l-3.4-11-3-11h-1l-1.4,22h-3.3l-.3-23,1.5006-5.8774-.5006-5.1226s0-2-1,0l1,2v3l-3-3v-5l3-2,1-1h7l2,1,1,2,1,3-2,4h-1"/>
    <path fill="#6a462f" d="M50.7274,27.0849l-.6026,6,1.6026,5,2,12,2.7,11h-3.3l-3.4-11-3-11h-1l-1.4,22h-3.3l-.3-23,1.66-5.9493-.66-5.0507s0-2-1,0l1,2v3l-3-3v-5l3-2,1-1h7l2,1,1,2,1,3-2,4h-1"/>
    <circle cx="46.6122" cy="14.1787" r="3" fill="#6a462f"/>
  </g>
  <g id="line">
...
`, _attrs, 72)
export default EmojiPeopleWithBunnyEarsDarkSkinTone
