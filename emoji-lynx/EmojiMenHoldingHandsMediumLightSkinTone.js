...
/** Mithril-lynx component for the OpenMoji "men holding hands: medium-light skin tone" (color) [1F46C-1F3FC]. */
const EmojiMenHoldingHandsMediumLightSkinTone = lynxIcon(`
  <g id="color"/>
  <g id="skin">
    <g id="skin-b">
...
`, _attrs, 72)
export default EmojiMenHoldingHandsMediumLightSkinTone
