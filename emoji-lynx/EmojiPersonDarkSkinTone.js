...
/** Mithril-lynx component for the OpenMoji "person: dark skin tone" (color) [1F9D1-1F3FF]. */
const EmojiPersonDarkSkinTone = lynxIcon(`
  <g id="color">
...
`, _attrs, 72)
export default EmojiPersonDarkSkinTone
