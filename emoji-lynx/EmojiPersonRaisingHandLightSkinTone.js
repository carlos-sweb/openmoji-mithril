...
/** Mithril-lynx component for the OpenMoji "person raising hand: light skin tone" (color) [1F64B-1F3FB]. */
const EmojiPersonRaisingHandLightSkinTone = lynxIcon(`
  <g id="color">
...
`, _attrs, 72)
export default EmojiPersonRaisingHandLightSkinTone
