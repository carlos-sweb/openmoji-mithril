...
/** Mithril-lynx component for the OpenMoji "people wrestling: dark skin tone" (black) [1F93C-1F3FF]. */
const EmojiPeopleWrestlingDarkSkinToneBlack = lynxIcon(`
  <g id="line">
...
`, _attrs, 72)
export default EmojiPeopleWrestlingDarkSkinToneBlack
