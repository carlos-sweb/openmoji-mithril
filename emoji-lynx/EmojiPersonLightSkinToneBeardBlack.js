...
/** Mithril-lynx component for the OpenMoji "person: light skin tone, beard" (black) [1F9D4-1F3FB]. */
const EmojiPersonLightSkinToneBeardBlack = lynxIcon(`
  <g id="line">
...
`, _attrs, 72)
export default EmojiPersonLightSkinToneBeardBlack
